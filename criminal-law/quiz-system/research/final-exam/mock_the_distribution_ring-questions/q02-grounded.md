...
<!-- grounding: GROUNDED — Dangerous Proximity Test vs. MPC Substantial Step Test, Ch 17, Refinement `actus-reus-substantial-step` and `actus-reus-proximity-test`. Rule paraphrased accurately. -->