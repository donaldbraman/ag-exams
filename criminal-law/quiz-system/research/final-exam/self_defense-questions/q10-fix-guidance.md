...
Recommended fix: In the explanation for (a), remove the word "wrongfully" (i.e., change "wrongfully creates the peril" to "creates the peril"). Because the prompt explicitly asks the student to assume the charge applies "whether or not the shooting was justified," relying on "wrongfully" in the explanation slightly contradicts the premise. A justified (lawful self-defense) shooting is not "wrongful," yet modern jurisdictions still impose a duty to act/rescue if the defendant created the peril, even innocently or justifiably.
-->
