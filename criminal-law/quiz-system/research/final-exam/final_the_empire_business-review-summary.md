# Review Summary — final_the_empire_business
...
| q02 | GROUNDED | SHOULD FIX | CLEAN | CLEAN | SHOULD FIX |
| q03 | GROUNDED | MUST FIX | MUST FIX | SHOULD FIX | SHOULD FIX |
| q04 | GROUNDED | SHOULD FIX | CLEAN | MUST FIX | SHOULD FIX |
| q05 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
| q06 | GROUNDED | SHOULD FIX | CLEAN | SHOULD FIX | CLEAN |
| q07 | GROUNDED-WITH-CAVEAT | MUST FIX | MUST FIX | MUST FIX | MUST FIX |
| q08 | GROUNDED | MUST FIX | CLEAN | CLEAN | SHOULD FIX |
| q09 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | CLEAN |
| q10 | GROUNDED | MUST FIX | CLEAN | CLEAN | CLEAN |
| q11 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
| q12 | GROUNDED | MUST FIX | CLEAN | MUST FIX | MUST FIX |
| q13 | GROUNDED | MUST FIX | CLEAN | CLEAN | SHOULD FIX |
| q14 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
| q15 | GROUNDED | SHOULD FIX | CLEAN | CLEAN | CLEAN |
