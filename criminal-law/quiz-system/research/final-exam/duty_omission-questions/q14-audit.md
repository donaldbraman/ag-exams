...
Check 2: pass
Check 3: pass
Check 4: MUST FIX - The question is missing its entire fact pattern. The stem only contains the final call-of-the-question, but none of the facts required to answer it (who Alba and Dane are, Alba's knowledge of the rescue, Alba's status as an invitee, Dane's rescue of Cody, etc.) are actually provided in the text.
Check 5: pass
Check 6: pass
Check 7: pass
Recommended fix: Prepend the missing fact pattern to the question stem so students have the details necessary to analyze the scenario.
-->