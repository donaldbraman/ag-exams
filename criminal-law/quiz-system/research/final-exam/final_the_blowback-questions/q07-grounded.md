...
<!-- GROUNDING-FAIL: Depraved heart murder / MPC extreme indifference is not in any chapter map. The closest taught doctrines are: None (the meta-map artifact and chapter map corpus are missing from the prompt context). Correct answer must rely on one of those instead. -->