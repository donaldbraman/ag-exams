...
<!-- grounding: GROUNDED — Actus reus tests for attempt (Proximity vs. Substantial Step), Ch 17, Refinement `actus-reus-proximity-test`, `actus-reus-substantial-step`. Rule paraphrased accurately. -->