...
<!-- GROUNDING-FAIL: Constructive possession is not in any chapter map. The closest taught doctrines are: none (meta-map missing). Correct answer must rely on one of those instead. -->