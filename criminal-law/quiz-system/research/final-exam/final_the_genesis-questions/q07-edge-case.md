...
1. Fact Pattern Booby Traps: The prompt explicitly calls it a "strict-liability felony statute." If the statute expressly declares itself to be strict liability, courts cannot use the *Staples* presumption to "read a mens rea requirement into" it, because explicit legislative text overrides the presumption. *Staples* and *Morissette* apply to statutes that are *silent* on mens rea. Calling it "strict-liability" in the prompt renders (c) technically incorrect.
2. Cross-Doctrine Clashes: pass
3. Cross-Question Spoilers: pass
Recommended fix: Change "the original strict-liability felony statute" in the prompt to "a state public welfare statute that is silent on mens rea but graded as a felony."
-->