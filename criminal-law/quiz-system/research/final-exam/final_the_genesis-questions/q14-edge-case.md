...
1. Fact Pattern Booby Traps: pass (the question expertly brackets the inquiry to "satisfy the actus reus," dodging any potential ambiguity regarding whether the Courier possessed the precise mens rea based solely on a text reading "5 kilos").
2. Cross-Doctrine Clashes: pass (the factual impossibility of completion due to the unrelated traffic warrant does not bar an attempt conviction under the MPC).
3. Cross-Question Spoilers: pass (testing the MPC standard here will not spoil Q15's inquiry into the common law proximity test on the same facts).
Recommended fix: N/A
-->