...
<!-- GROUNDING-FAIL: public welfare offenses / Morissette framework is not in any chapter map. The closest taught doctrines are: none (meta-map is missing from the prompt). Correct answer must rely on one of those instead. -->