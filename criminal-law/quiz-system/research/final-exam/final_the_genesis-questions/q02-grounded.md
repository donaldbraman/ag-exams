...
<!-- grounding: GROUNDED-WITH-CAVEAT — official statement exception, Ch 10, Refinement `mol-official-statement`. Caveat: The question premise states the statute requires proof that Brenda "knowingly" violated the law. If knowledge of illegality is explicitly required by the statute, then any genuine mistake of law directly negates the mens rea (MPC 2.04(1)(a)), meaning Brenda would not need to satisfy the narrow requirements of the official statement affirmative defense (MPC 2.04(3)) to be excused. To properly test the official statement exception as the required path to acquittal, the statute in the premise should be a standard statute that does not explicitly require knowledge of the legal violation. -->