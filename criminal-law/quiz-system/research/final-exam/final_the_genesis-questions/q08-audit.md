...
check 2: pass
check 3: pass
check 4: The stem fails to state Avon's position or authority in the company, but options (a) and (b) assume he is the CEO. Without establishing his role in the stem, students cannot definitively conclude he had the authority to prevent the violation (a requirement for guilt under the Park doctrine) and might validly object that the correct answer assumes facts not in evidence. 
check 5: pass
check 6: pass
check 7: pass
Recommended fix: Update the first sentence of the stem to state his role: "Avon, the CEO of a distribution company, is charged under the state's..."
-->