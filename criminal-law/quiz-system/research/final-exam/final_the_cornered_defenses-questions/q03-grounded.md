...
<!-- grounding: GROUNDED — Accomplice Mens Rea (Purpose), Ch 18, Refinement `mr-purpose-not-knowledge` (and Ch 19 `lauria-knowledge-vs-purpose`). Rule paraphrased accurately. -->