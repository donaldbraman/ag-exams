...
1. Fact Pattern Booby Traps: The "at fault / reckless placement" exception to duress. Because the facts explicitly establish Marcus as an "enforcer" for a criminal smuggling crew overseen by Vance, courts routinely hold that such voluntary gang/syndicate affiliation acts as a complete bar to a duress defense (as the defendant recklessly placed himself in a situation where coercion is probable). This makes (d) a highly viable legal outcome that overrides the structural availability of the defense intended in (a).
2. Cross-Doctrine Clashes: pass
3. Cross-Question Spoilers: pass
Recommended fix: Change option (d) to test a different, purely doctrinal distractor that doesn't trigger the very real gang-affiliation bar. For example: "(d) The defense is barred, because the minority exception applies only when the predicate felony is a strict liability offense." and update the explanation for (d) accordingly.
-->