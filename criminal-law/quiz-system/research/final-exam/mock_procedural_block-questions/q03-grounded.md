...
<!-- GROUNDING-FAIL: felony murder is not in any chapter map. The closest taught doctrines are: none (meta-map artifact missing). Correct answer must rely on one of those instead. -->