...
1. Fact Pattern Booby Traps: pass (the use of the word "unexpectedly" in the facts regarding Victor drawing a gun serves as a perfectly calibrated distracter for students who conflate subjective momentary surprise with objective legal foreseeability).
2. Cross-Doctrine Clashes: pass
3. Cross-Question Spoilers: pass (using the "whether or not Dominic is guilty" phrasing effectively isolates the Pinkerton analysis without explicitly spoiling the outcome of Q8 or Q10).
Recommended fix: n/a
-->