...
3. Cross-Question Spoilers: Q9's prompt explicitly mentions "(rather than felony murder)", which tips off the student that felony murder is the primary or expected charge for Victor's death, thereby acting as a direct spoiler for Q8.
Recommended fix: Remove the parenthetical "(rather than felony murder)" from the prompt so Q9 can isolate intentional murder and self-defense without giving away the core issue of Q8.
-->