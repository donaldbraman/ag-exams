...
2. Cross-Doctrine Clashes: pass (The question correctly heads off the "mere personal possession" trap by making the acquired drugs 500 grams, an undeniable trafficking quantity establishing an underlying drug trafficking crime, satisfying the predicate requirement for 924(c)).
3. Cross-Question Spoilers: pass (This pairs well with Q3, which will presumably test the Watson rule for Marcus receiving the firearms. The contrasting rules between Smith and Watson do not spoil each other).
Recommended fix: n/a
-->