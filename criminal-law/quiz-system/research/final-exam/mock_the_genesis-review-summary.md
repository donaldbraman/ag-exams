...
| q03 | GROUNDED | SHOULD FIX | CLEAN | SHOULD FIX | SHOULD FIX |
...
| q07 | GROUNDED | MUST FIX | MUST FIX | MUST FIX | MUST FIX |
| q08 | GROUNDED | MUST FIX | CLEAN | CLEAN | CLEAN |
| q09 | GROUNDED | CLEAN | SHOULD FIX | CLEAN | CLEAN |
...
| q14 | GROUNDED | MUST FIX | MUST FIX | SHOULD FIX | SHOULD FIX |
| q15 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
