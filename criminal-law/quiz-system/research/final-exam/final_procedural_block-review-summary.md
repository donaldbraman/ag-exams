...
| q02 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | CLEAN |
...
| q06 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
...
| q10 | GROUNDED | MUST FIX | SHOULD FIX | SHOULD FIX | SHOULD FIX |
| q11 | GROUNDING-FAIL | MUST FIX | CLEAN | SHOULD FIX | CLEAN |
| q12 | GROUNDED | MUST FIX | CLEAN | CLEAN | CLEAN |
| q13 | GROUNDED | MUST FIX | CLEAN | MUST FIX | CLEAN |
