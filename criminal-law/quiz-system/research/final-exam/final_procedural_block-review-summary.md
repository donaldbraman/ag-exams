...
| q02 | GROUNDED | MUST FIX | MUST FIX | SHOULD FIX | CLEAN |
| q03 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | CLEAN |
| q04 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
| q05 | GROUNDED | MUST FIX | MUST FIX | SHOULD FIX | SHOULD FIX |
| q06 | GROUNDED | SHOULD FIX | MUST FIX | CLEAN | CLEAN |
| q07 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
| q08 | GROUNDED | CLEAN | CLEAN | CLEAN | CLEAN |
| q09 | GROUNDED | MUST FIX | CLEAN | CLEAN | CLEAN |
| q10 | GROUNDED | MUST FIX | CLEAN | CLEAN | CLEAN |
| q11 | GROUNDING-FAIL | MUST FIX | SHOULD FIX | CLEAN | SHOULD FIX |
| q12 | GROUNDED | MUST FIX | MUST FIX | CLEAN | CLEAN |
| q13 | MISSING | MUST FIX | CLEAN | CLEAN | CLEAN |
| q14 | GROUNDED | CLEAN | CLEAN | SHOULD FIX | SHOULD FIX |
| q15 | GROUNDED | MUST FIX | CLEAN | CLEAN | SHOULD FIX |
