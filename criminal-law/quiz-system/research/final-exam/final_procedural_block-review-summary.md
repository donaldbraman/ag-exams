# Review Summary — final_procedural_block
...
|---|---|---|---|---|---|
| q01 | GROUNDING-FAIL | MUST FIX | CLEAN | CLEAN | CLEAN |
| q02 | GROUNDING-FAIL | MUST FIX | MUST FIX | MUST FIX | MUST FIX |
| q03 | GROUNDED-WITH-CAVEAT | MUST FIX | MUST FIX | CLEAN | CLEAN |
| q04 | GROUNDING-FAIL | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
| q05 | GROUNDING-FAIL | MUST FIX | CLEAN | CLEAN | CLEAN |
| q06 | GROUNDING-FAIL | MUST FIX | CLEAN | CLEAN | CLEAN |
| q07 | GROUNDING-FAIL | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
| q08 | GROUNDING-FAIL | MUST FIX | MUST FIX | SHOULD FIX | SHOULD FIX |
| q09 | GROUNDING-FAIL | SHOULD FIX | CLEAN | CLEAN | CLEAN |
| q10 | GROUNDED | MUST FIX | MUST FIX | CLEAN | CLEAN |
| q11 | GROUNDING-FAIL | MUST FIX | CLEAN | SHOULD FIX | CLEAN |
| q12 | GROUNDING-FAIL | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
| q13 | GROUNDING-FAIL | MUST FIX | CLEAN | SHOULD FIX | CLEAN |
