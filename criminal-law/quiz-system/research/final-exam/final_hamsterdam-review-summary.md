# Review Summary — final_hamsterdam
...
|---|---|---|---|---|---|
| q01 | GROUNDING-FAIL | MUST FIX | CLEAN | SHOULD FIX | CLEAN |
| q02 | GROUNDED | CLEAN | CLEAN | SHOULD FIX | SHOULD FIX |
| q03 | GROUNDED | MUST FIX | CLEAN | CLEAN | CLEAN |
| q04 | GROUNDED | MUST FIX | CLEAN | CLEAN | SHOULD FIX |
| q05 | GROUNDED | CLEAN | CLEAN | CLEAN | CLEAN |
| q06 | GROUNDED | MUST FIX | MUST FIX | SHOULD FIX | CLEAN |
| q07 | GROUNDING-FAIL | MUST FIX | CLEAN | CLEAN | CLEAN |
| q08 | GROUNDED | MUST FIX | CLEAN | CLEAN | CLEAN |
| q09 | GROUNDED | SHOULD FIX | SHOULD FIX | SHOULD FIX | SHOULD FIX |
| q10 | GROUNDED | CLEAN | CLEAN | SHOULD FIX | SHOULD FIX |
| q11 | GROUNDED | SHOULD FIX | CLEAN | CLEAN | SHOULD FIX |
| q12 | GROUNDED | SHOULD FIX | CLEAN | SHOULD FIX | SHOULD FIX |
| q13 | GROUNDED | MUST FIX | MUST FIX | CLEAN | CLEAN |
