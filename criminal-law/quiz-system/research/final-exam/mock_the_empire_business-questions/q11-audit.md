...
<!-- audit: MUST FIX
check 1: fail. The word "aborted" implies Locke voluntarily abandoned the crime. Under the MPC, voluntary and complete renunciation is an affirmative defense (`abandonment-mpc`), which would make Locke NOT guilty under the MPC, rendering (d) factually incorrect.
check 2: pass.
check 3: pass.
check 4: fail. The use of "aborted" is ambiguous and fails to specify whether the plan was voluntarily renounced or thwarted, depriving the student of the facts needed to dismiss the MPC abandonment defense.
check 5: pass.
check 6: pass.
check 7: pass.
check 8: pass.
Recommended fix: Change "The government uncovers Locke's aborted plan" to "The police thwart Locke's plan" or "The government uncovers Locke's detailed plan".
-->