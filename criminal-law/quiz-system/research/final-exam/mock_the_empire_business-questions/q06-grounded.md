...
<!-- grounding: GROUNDED — § 924(c) Use (trading drugs for gun), Ch 15, Refinement `use-924c-trading-drugs-for-gun`. Rule paraphrased accurately. Distractors effectively utilize related refinements `use-924c-trading-gun-for-drugs` and `use-ginsburg-weapon-only`. -->