...
<!-- GROUNDING-FAIL: Bribe vs. Gratuity (Snyder v. United States) is not in any chapter map. The closest taught doctrines are: Legality, Vagueness, Lenity, Equal protection, and Desuetude (Ch 5 Core elements). Correct answer must rely on one of those instead. -->