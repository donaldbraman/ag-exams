...
<!-- GROUNDING-FAIL: Bribe vs. gratuity distinction (Snyder v. United States) and honest services fraud are not in any chapter map. The closest taught doctrines are: Legality, Vagueness, Lenity, Equal protection, and Desuetude (Ch 5). Correct answer must rely on one of those instead. -->
