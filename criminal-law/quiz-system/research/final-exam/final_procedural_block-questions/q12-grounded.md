...
<!-- GROUNDING-FAIL: MPC substantial step framework is not in any chapter map. The closest taught doctrines are: N/A (meta-map and focus maps are missing from the prompt). Correct answer must rely on one of those instead. -->