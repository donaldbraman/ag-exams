...
<!-- grounding: GROUNDED-WITH-CAVEAT — dangerous items heuristic, Ch 11, Refinement `morissette-factor-2-dangerous-items`. Caveat: The explanation introduces a new fact ("minor penalty (30 days)") not present in the question stem, though the core doctrinal application regarding dangerous items is accurately grounded. -->