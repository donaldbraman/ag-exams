...
|---|---|---|---|---|---|
| q01 | GROUNDED | SHOULD FIX | CLEAN | CLEAN | CLEAN |
| q02 | GROUNDED | MUST FIX | CLEAN | CLEAN | CLEAN |
| q03 | GROUNDED | MUST FIX | MUST FIX | MUST FIX | MUST FIX |
| q04 | GROUNDED | MUST FIX | SHOULD FIX | SHOULD FIX | SHOULD FIX |
| q05 | GROUNDED | MUST FIX | MUST FIX | MUST FIX | MUST FIX |
| q06 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | CLEAN |
| q07 | GROUNDED | SHOULD FIX | SHOULD FIX | CLEAN | CLEAN |
| q08 | GROUNDED | MUST FIX | CLEAN | MUST FIX | SHOULD FIX |
