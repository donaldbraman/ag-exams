...
|---|---|---|---|---|---|
| q01 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | MUST FIX |
| q02 | GROUNDED | MUST FIX | MUST FIX | MUST FIX | CLEAN |
| q03 | MISSING | SHOULD FIX | MUST FIX | CLEAN | CLEAN |
| q04 | MISSING | MUST FIX | CLEAN | MUST FIX | SHOULD FIX |
| q05 | GROUNDED | MUST FIX | CLEAN | SHOULD FIX | SHOULD FIX |
| q06 | GROUNDED | MUST FIX | MUST FIX | SHOULD FIX | SHOULD FIX |
| q07 | GROUNDED | MUST FIX | CLEAN | MUST FIX | SHOULD FIX |
...
| q12 | MISSING | SHOULD FIX | CLEAN | SHOULD FIX | SHOULD FIX |
