...
<!-- audit: SHOULD FIX
check 1: pass (accurately states the legal standard for the abstract elements test)
check 2: pass (distractors reliably test adjacent but distinct doctrines like merger and facts-as-committed)
check 3: pass (explanation maps well to the legal distinction)
check 4: finding (Option (a) inexplicably introduces "Compound Y", which is never mentioned in the stem. The stem just generically refers to "drug distribution.")
check 5: pass (stem stipulates the jurisdictional approach)
check 6: pass
check 7: pass (inherently dangerous felony limitation / elements-vs-facts is firmly grounded in Ch 14)
Recommended fix: In option (a), change "distributing Compound Y" to "distributing the drug" to match the stem and remove the hallucinated variable.
-->