# Chapter Map: The Jury and Nullification

## Meta
- Chapter: 4
- Title: The Jury and Nullification
- Source file: criminal-law/chapters/04-jury.qmd
- Source hash: 7e48112aea2038cb4b29f378fe0b285172eea63640af6afdf24df7273fb2f587
- Generated at: 2026-04-15
- Model: claude-sonnet-4-6

## Slide Digest

Slide digest available: `criminal-law/quiz-system/research/chapter-maps/slide-digests/chapter-04-slides.md` (19 slides, Class 6).
...
The chapter is not organized around elements of a crime. It is organized around the constitutional and procedural doctrine governing the jury as an institution. The "prima facie" structure here maps to the threshold questions a student must answer in a jury-related legal analysis:

1. **Does the right to jury trial apply?** The Sixth Amendment guarantees jury trial for "serious" offenses — crimes carrying potential imprisonment of more than six months. The right was incorporated against the states in *Duncan v. Louisiana* (1968). Minor/petty offenses are excluded (*Baldwin v. New York*, 1970).

2. **Was the jury properly composed?** Equal Protection prohibits race-based exclusion from venires (*Strauder v. West Virginia*, 1880). *Batson v. Kentucky* (1986) governs discriminatory peremptory challenges via a three-step framework: prima facie showing → race-neutral explanation → judicial determination.

3. **Was the right properly waived (or not)?** A defendant may waive jury trial in writing with court approval, but federal procedure also requires government consent (*Singer v. United States*, 1965; Fed. R. Crim. P. 23(a)).

### Liability Extensions

*(Not applicable in the traditional sense — this chapter addresses constitutional procedure rather than elements of liability. The analogous "extension" here is the jury's power to nullify.)*

4. **Jury nullification power:** A jury may acquit despite proof beyond a reasonable doubt. This power is unreviewable under the Double Jeopardy Clause. It is a factual power, not a legal right — no constitutional entitlement to be informed of it.

### Liability Limits

5. **Petty offense exception:** No jury trial right for offenses with potential imprisonment of six months or less.

6. **Government consent requirement (federal):** A defendant cannot unilaterally elect a bench trial in federal court — the government must consent.

7. **Anti-nullification authority of courts:** Courts have a *duty* to forestall nullification — via instructions, admonition, or juror dismissal. No right to nullification instruction.

---

## Refinements

### Right to Jury Trial — Incorporation and Threshold
...
- **Practiced:** Slides 5, 9, 11 (*Duncan v. Louisiana* case briefing, holding, and incorporation definition)
...
- **Practiced:** Slides 9, 10 (*Duncan* holding discussion and explicit rule statement: "prison sentence of six months or more")
...
- **Practiced:** Slide 11 (incorporation defined; *Duncan* discussion framed around states' obligations post-incorporation)

### Jury Composition — Equal Protection and Batson
...
### Jury Nullification — Power vs. Right
...
- **Jurisdiction:** universal
- **Practiced:** Slide 13 (explicit rule statement: "Juries may acquit for any reason or no reason at all. But judges are under no obligation to inform them of that right.")
...
### Jury Nullification — Historical and Racial Dimensions
...
- **Practiced:** Slide 14 (Butler discussion presupposes historical context; students asked "Should jurors disregard the law? If so, why?")
...
- **Practiced:** Slide 14 (photo of Paul Butler; discussion questions: "Should jurors disregard the law? If so, why? If not, why not?")
...
- **Practiced:** Slide 14 (Butler-Kennedy debate framed by discussion question: "Should jurors disregard the law? If so, why? If not, why not?")
...
### Community Feedback Mechanisms and Reform
...
- **Practiced:** Slide 19 (discussion questions on jury polling; Braman proposal named; D.C. application question)
...
- **Practiced:** Slide 19 (Judge Gwin photo and name; discussion questions about empirical findings and reform implications)
...
### cluster-jury-right-threshold
- **Refinements:** sixth-amendment-incorporation, serious-offense-threshold, petty-offense-exception (see elements)
- **Why they cluster:** A student analyzing whether a defendant has a jury trial right must work through incorporation, the serious/petty threshold, and the practical application of the line.
- **Scenario hook:** A defendant is convicted of a municipal-code violation carrying a maximum of eight months' imprisonment in a state that historically tried such cases before a magistrate — did she have a jury trial right?

### cluster-batson-practical
- **Refinements:** batson-framework, batson-gap, gregory-racial-bias-amplification
- **Why they cluster:** *Batson*'s three-step framework, its empirical failure, and the *Gregory*/*McCleskey* split together reveal the gap between formal anti-discrimination doctrine and actual jury composition.
- **Scenario hook:** A capital defendant presents statistical evidence that Black jurors were struck at twice the rate of white jurors in his county over the past decade — what framework applies, what must be proven, and does it matter which constitution he invokes?

### cluster-nullification-power-limits
- **Refinements:** power-vs-right, anti-nullification-instruction-limits, dougherty-informal-governor
- **Why they cluster:** These three refinements form the doctrinal core of nullification — the unreviewable power, the permissible suppression mechanism, and its structural rationale.
- **Scenario hook:** A district court instructs the jury: "If you acquit contrary to the evidence, you will have broken your oath and may be held in contempt" — analyze whether this instruction is permissible and what remedy is available.

### cluster-nullification-normative
- **Refinements:** nullification-historical-roots, butler-race-conscious-nullification, kennedy-nullification-critique, bazelon-deliberate-candor
- **Why they cluster:** The normative debate over nullification requires confronting its dual legacy (Zenger vs. Jim Crow acquittals), Butler's democratic argument, Kennedy's intra-community critique, and Bazelon's candor argument.
- **Scenario hook:** A Black juror in a federal marijuana prosecution announces during deliberations that she will vote to acquit regardless of the evidence — analyze the legal consequences, the ethical arguments on both sides, and what the judge may do.

### cluster-feedback-mechanisms
- **Refinements:** jury-polling-braman, gwin-study-findings, deliberation-effect, bail-nullification, participatory-defense, grand-jury-reform, error-reporting-just-culture
- **Why they cluster:** All address the same structural problem — the criminal legal system suppresses citizen feedback — through different institutional mechanisms at different points in the process.
- **Scenario hook:** A city is designing a pilot program to increase community input in criminal prosecution decisions; evaluate which of the chapter's proposed mechanisms best serves the goals of voice, neutrality, respect, and trustworthiness from the procedural justice framework.

### cluster-bench-trial-waiver
- **Refinements:** bench-trial-consent, federalism-laboratory-dissent
- **Why they cluster:** Both involve the tension between defendant autonomy and institutional design — when can defendants opt out of juries, and when do federalism arguments counsel deference to state choices?
- **Scenario hook:** A federal defendant charged with a highly publicized offense wants a bench trial because she fears jury bias from media coverage — does she have the right to waive, and what must she show?
...
### Duncan v. Louisiana
- **Holding:** The Sixth Amendment jury trial right is incorporated against the states via the Fourteenth Amendment because jury trial is fundamental to the American scheme of justice, and applies to serious offenses carrying potential imprisonment of more than six months.
- **Reasoning:** The historical importance of jury trial as a safeguard against arbitrary government power and the nation's deep commitment to the right in serious criminal cases qualifies it for Fourteenth Amendment due process protection.
- **Facts:** Black teenager Gary Duncan was denied a jury trial in Louisiana for simple battery (touching a white teenager on the elbow during a racial desegregation incident) despite a potential two-year sentence.
- **Teaches:** sixth-amendment-incorporation, serious-offense-threshold, federalism-laboratory-dissent
- **Source type:** main case
- **Discussion questions:** yes

### State v. Gregory
- **Holding:** Washington's death penalty statute violates the Washington Constitution because it is administered in an arbitrary and racially biased manner, as demonstrated by statistical evidence that Black defendants were 4.5 times more likely to receive death sentences than similarly situated white defendants.
- **Reasoning:** The Washington Supreme Court accepted statistical evidence of racial disparity as sufficient to establish that the death penalty operates unconstitutionally, converting all death sentences to life imprisonment.
- **Facts:** Allen Eugene Gregory was sentenced to death and challenged his sentence with empirical evidence of racially disparate imposition of capital punishment in Washington State.
- **Teaches:** gregory-racial-bias-amplification, batson-gap
- **Source type:** note case
- **Discussion questions:** yes

### McCleskey v. Kemp
- **Holding:** Statistical evidence of racial disparity in capital sentencing does not establish an Equal Protection violation in a specific case; the defendant must show discriminatory intent in his individual prosecution.
- **Reasoning:** The Court required individualized proof of discriminatory purpose rather than accepting systemic statistical evidence, reasoning that statistical disparities alone do not prove intentional discrimination in a particular case.
- **Facts:** Black defendant McCleskey challenged his death sentence with the Baldus study showing that defendants in Georgia whose victims were white were significantly more likely to receive death sentences.
- **Teaches:** gregory-racial-bias-amplification, batson-gap
- **Source type:** note case
- **Discussion questions:** no

### United States v. Kleinman
- **Holding:** A court may instruct a jury that it cannot substitute its sense of justice for its duty to follow the law, but instructions implying jurors could be punished for nullification or that nullification is impossible are erroneous (though subject to harmless error review, not structural error).
- **Reasoning:** Courts have no duty to inform juries of their nullification power and may actively discourage it, but the outer limit is reached when instructions suggest punitive consequences — which threatens juror independence without legitimate justification.
- **Facts:** Noah Kleinman was convicted of marijuana distribution for operating medical marijuana collectives in California; the district court instructed the jury that "[t]here is no such thing as valid jury nullification" and that jurors "would violate your oath and the law" by acquitting contrary to the evidence.
- **Teaches:** power-vs-right, anti-nullification-instruction-limits
- **Source type:** main case
- **Discussion questions:** yes

### United States v. Dougherty
- **Holding:** While juries possess an "undoubted power" to nullify, they have no right to be informed of this power; courts may decline to give nullification instructions and may take steps to prevent nullification.
- **Reasoning:** Leventhal's majority treats non-disclosure as a deliberate "governor" — preserving nullification for exceptional cases while maintaining rule-of-law norms generally; Bazelon's dissent argues this constitutes deliberate deception that benefits informed jurors over uninformed ones.
- **Facts:** Anti-Vietnam War protesters who broke into Dow Chemical offices and destroyed property sought a nullification instruction to argue moral justification to the jury.
- **Teaches:** power-vs-right, dougherty-informal-governor, bazelon-deliberate-candor
- **Source type:** note case
- **Discussion questions:** yes

### Singer v. United States
- **Holding:** Federal Rule of Criminal Procedure 23(a)'s requirement that both the court and the government must consent to a defendant's waiver of jury trial is constitutional; a defendant has no right to a bench trial over the government's objection.
- **Reasoning:** The jury trial right serves a public function beyond individual defendant preference — protecting against both prejudiced acquittals and wrongful convictions — so the government retains an interest in jury proceedings.
- **Facts:** Singer sought to waive jury trial in federal court over the government's objection, arguing he had a constitutional right to choose between jury and bench trial.
- **Teaches:** bench-trial-consent
- **Source type:** note case
- **Discussion questions:** no

### Batson v. Kentucky
- **Holding:** The Equal Protection Clause forbids a prosecutor from using peremptory challenges to exclude jurors solely on account of race; defendants may challenge such strikes through a three-step burden-shifting framework.
- **Reasoning:** Racial discrimination in jury selection harms the excluded juror, the defendant, and public confidence in the justice system; the three-step framework provides a workable mechanism for courts to identify discriminatory strikes while preserving legitimate peremptory challenges.
- **Facts:** Black defendant Batson was convicted by an all-white jury after the prosecutor used peremptory challenges to remove all Black jurors from the venire.
- **Teaches:** batson-framework, batson-gap
- **Source type:** note case (discussed in doctrine summary callout)
- **Discussion questions:** no

### Strauder v. West Virginia
- **Holding:** Equal Protection prohibits the systematic exclusion of Black citizens from jury venires.
- **Reasoning:** Excluding Black citizens from juries denies them equal participation in civic life and deprives Black defendants of a jury composed without racial discrimination.
- **Facts:** Black defendant Strauder challenged his murder conviction before an all-white jury under a West Virginia statute that limited jury service to white male citizens.
- **Teaches:** batson-framework
- **Source type:** illustrative (cited in doctrine summary)
- **Discussion questions:** no

### Hurtado v. California
- **Holding:** The Fifth Amendment grand jury requirement was not incorporated against the states.
- **Reasoning:** The Fourteenth Amendment's due process clause does not require states to follow every specific procedural safeguard in the Bill of Rights; states may use alternative indictment procedures such as preliminary hearings.
- **Facts:** California used a prosecutor's information rather than grand jury indictment to charge Hurtado with murder.
- **Teaches:** grand-jury-reform
- **Source type:** illustrative (cited in doctrine summary)
- **Discussion questions:** no
...
|-----|---------|------------|-----------|
| sixth-amendment-incorporation | element | foundational | Slides 5, 9, 11 |
| serious-offense-threshold | element | foundational | Slides 9, 10 |
| federalism-laboratory-dissent | element | intermediate | Slide 11 |
| batson-framework | element | foundational | — |
| batson-gap | element | intermediate | — |
| bench-trial-consent | limit | intermediate | — |
| power-vs-right | extension | foundational | Slide 13 |
| anti-nullification-instruction-limits | limit | intermediate | — |
| dougherty-informal-governor | limit | intermediate | — |
| bazelon-deliberate-candor | limit | advanced | — |
| nullification-historical-roots | extension | foundational | Slide 14 |
| butler-race-conscious-nullification | extension | advanced | Slide 14 |
| kennedy-nullification-critique | extension | advanced | Slide 14 |
| gregory-racial-bias-amplification | element | intermediate | — |
| jury-polling-braman | extension | intermediate | Slide 19 |
| gwin-study-findings | extension | intermediate | Slide 19 |
| deliberation-effect | extension | advanced | — |
| bail-nullification | extension | intermediate | — |
| participatory-defense | extension | intermediate | — |
| grand-jury-reform | extension | advanced | — |
| error-reporting-just-culture | extension | advanced | — |
