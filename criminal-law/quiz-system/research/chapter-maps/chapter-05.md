# Chapter Map: Legislatures and Courts

## Meta
- Chapter: 5
- Title: Legislatures and Courts
- Source file: criminal-law/chapters/05-legislatures-courts.qmd
- Source hash: c3fe9061b0fe12bbd35c084d77c8d63d7c5b8789e289782b0cae6fdb2a44663b
...
This chapter is not about a substantive crime with elements to prove. It addresses **interpretive and constitutional doctrines** that courts use to constrain the reach of criminal statutes. On an exam, a student analyzing whether a statute can be applied to their client should work through:

1. **Legality** — Was the conduct clearly prohibited by a legislatively enacted statute at the time it occurred? Courts may not expand criminal statutes beyond their text.
2. **Vagueness** — Does the statute provide fair notice of prohibited conduct and adequate standards to prevent arbitrary enforcement? Statutes that fail either prong violate due process.
3. **Lenity** — Where statutory language is genuinely ambiguous, courts construe the statute in the defendant's favor.
4. **Equal protection** — Does the statute apply to all persons equally, or does it discriminate on a constitutionally impermissible basis?
5. **Desuetude** — Has the law gone so long unenforced that it should be treated as void?

### Liability Extensions

- **Asymmetric correction principle** — The theoretical justification for narrow interpretation: courts should read statutes narrowly because under-inclusive errors (harmful conduct escapes punishment) are politically easy for legislatures to correct, while over-inclusive errors (innocent conduct is punished) tend to persist uncorrected. This principle explains *why* courts use legality, vagueness, and lenity rather than just *what* those doctrines require.
- **Honest services fraud (§ 1346)** — After courts narrowed mail/wire fraud to exclude intangible rights, Congress enacted § 1346 to restore the honest services doctrine. The statute extends federal fraud liability to schemes depriving another of the intangible right to honest services—but only for bribery and kickback schemes after *Skilling*.

### Liability Limits

- **Subsumption** — An ancient common law offense may be unenforceable if modern statutes have fully subsumed its conduct, rendering it redundant and less precisely defined.
- **Cruel and unusual punishment** — A historical punishment so barbaric by contemporary standards that its unconstitutionality undermines enforcement of the underlying offense.
- **Legislative non-enactment** — Reception statutes that preserve common law crimes do not constitute legislative enactment of those crimes; the legality principle requires positive legislative action.
- **Bribe/gratuity distinction** — Federal § 666 prohibits bribes (payments *before* an official act to influence it) but not gratuities (payments *after* an official act as appreciation). This structural limit restricts the reach of federal anti-corruption law.
...
- **Practiced:** Slides 5, 6 (common scold image and limiting doctrines overview)
...
- **Practiced:** Slide 11 (Robertson — "Everyone knows upskirting is wrong; why not allow prosecution under the existing statute?")
...
- **Practiced:** Slides 6, 8 (limiting doctrines definitions including vagueness; arbitrary and capricious enforcement slide)
...
- **Jurisdiction:** universal
- **Practiced:** — (not directly addressed in slides)
...
- **Jurisdiction:** universal
- **Practiced:** Slides 5, 6 (common scold image prompts discussion of what citizens would need to know; limiting doctrines slide defines vagueness standard)
...
- **Practiced:** Slide 6 (limiting doctrines slide explicitly defines lenity: "Where ambiguity exists … courts should read the statute to support narrow enforcement")
...
- **Practiced:** Slides 11, 18 (Robertson — court refuses to expand statute to cover upskirting; McNally — "if Congress desires to go further, it must speak more clearly")
...
- **Practiced:** — (*Yates* not mentioned in slides)
...
- **Practiced:** — (common scold discussed in slides 5–6 but equal protection angle not explicitly raised)
...
- **Practiced:** Slides 5, 6, 9 (common scold ducking-stool image; limiting doctrines definition of desuetude; adultery laws slide prompts desuetude analysis)
...
- **Practiced:** Slide 7 (why limiting doctrines exist — legislative supremacy rationale directly addresses this structural constraint)

### Asymmetric Correction Principle
...
- **Practiced:** Slides 12, 13 (Bentham quote on asymmetry; asymmetric error correction slide with three bullet points)
...
- **Practiced:** Slide 12 (Bentham quote applied to asymmetric correction framing; implicit in slide 7's justifications discussion)
...
- **Practiced:** Slides 10, 14, 20, 21, 22 (political market failure slides; Skilling narrowing; Honest Services Restoration Act fails; table of cases with no congressional response)
...
- **Practiced:** Slides 15, 16 (legislatures offload reform to blue-ribbon commissions; D.C. Criminal Code Reform Commission blocked by Congress)
...
- **Jurisdiction:** federal
- **Practiced:** Slides 17, 18, 19 (federal corruption background; McNally holding quoted; Congress responded with § 1346)
...
- **Jurisdiction:** federal
- **Practiced:** Slide 20 (Skilling holding quoted: "§ 1346 criminalizes only the bribe-and-kickback core")
...
- **Practiced:** Slide 22 (table listing Snyder — "Post-action gratuities not covered—only pre-action bribes")
...
- **Jurisdiction:** federal
- **Practiced:** Slide 22 (table listing McDonnell — "Arranging meetings for benefactor not 'official acts'")
...
- **Jurisdiction:** federal
- **Practiced:** Slide 22 (table listing Kelly — "Bridgegate not fraud—no 'money or property' sought"; Ciminelli — "Rigged bidding info not 'property'")

### Bearden and Private Probation
...
- **Practiced:** Slide 24 (Bearden holding quoted: "court must consider alternate measures … if the probationer could not pay")
...
- **Practiced:** Slides 25, 26 (offender-funded probation — fees ≠ fines key legal move; 2012 statistics on scale of extraction)
...
- **Practiced:** Slides 27, 28 (HB 310 reforms listed; "Currently" slide repeats 2012 statistics showing persistence despite reform)
...
- **Jurisdiction:** universal (theoretical)
- **Practiced:** Slides 7, 11 (slide 7 introduces fair notice as a justification; slide 11 prompts students to question whether "everyone knows it's wrong" satisfies fair notice)
...
- **Jurisdiction:** universal (theoretical)
- **Practiced:** Slides 7, 8, 23 (slide 7 states legislative supremacy as a justification; slide 8 on arbitrary and capricious enforcement; slide 23 on Citizens United and corporate influence expanding prosecutorial/political discretion)

---

## Clusters

### common-scold-doctrines
- **Refinements:** legality-common-law-crimes, vagueness-two-prong-test, vagueness-cant-delegate-to-blackstone, equal-protection-gender-specific-offense, desuetude-prolonged-nonenforcement, lenity-genuine-ambiguity-required
- **Why they cluster:** The common scold hypothetical that opens the chapter is specifically designed to engage all doctrines limiting criminal law interpretation, requiring students to analyze which arguments are strongest and whether any is sufficient alone.
- **Scenario hook:** Defense counsel challenges a charge of "being a common scold" under a reception statute last enforced in 1829 against a woman whose neighbors allege her speech disturbed the neighborhood peace.

### federal-corruption-narrowing
- **Refinements:** lenity-harsher-reading-requires-clear-congress, honest-services-mcnally-narrowing, honest-services-skilling-bribery-kickback-only, corruption-bribe-vs-gratuity, corruption-official-acts-narrowing, corruption-fraud-property-requirement
- **Why they cluster:** Federal corruption prosecutions require analyzing the narrowed scope of honest services fraud, the bribe/gratuity distinction, and what constitutes an official act—all flowing from the same interpretive pattern of repeated judicial narrowing without legislative correction.
- **Scenario hook:** A mayor accepts $15,000 from a developer two weeks after voting to approve the developer's permit, and also arranged three meetings between the developer and city engineers before the vote.

### asymmetric-correction-analysis
- **Refinements:** asymmetric-correction-under-over-inclusive, asymmetric-correction-notice-liberty-instrumental, asymmetric-correction-model-failure, reform-commissions-mixed-results, notice-rationale-fiction, legislative-supremacy-overcrimination
- **Why they cluster:** Policy analysis questions about the court-legislature relationship require understanding both the asymmetric correction argument and its documented failures, and the critique of the standard justifications that the model purports to replace.
- **Scenario hook:** After a court reads a "harassment" statute narrowly to exclude online conduct, Congress considers but fails to pass a corrective bill; evaluate whether the asymmetric correction model predicts and justifies this outcome.

### bearden-circumvention
- **Refinements:** bearden-rule, bearden-circumvention-fees-not-fines, bearden-hb310-adaptation
- **Why they cluster:** Georgia private probation illustrates how a constitutional holding (Bearden) can be formally preserved while substantively evaded, and how legislative reform can itself be adapted around—requiring students to analyze compliance, circumvention, and adaptation as distinct phenomena.
- **Scenario hook:** A low-income defendant convicted of shoplifting is placed on private probation with $40 monthly supervision fees; after failing to pay, the company extends her supervision by adding a weekly check-in requirement.

### vagueness-lenity-overlap
- **Refinements:** vagueness-two-prong-test, vagueness-as-applied-vs-facial, lenity-genuine-ambiguity-required, lenity-fish-not-tangible-object
- **Why they cluster:** Vagueness and lenity often arise together—both respond to unclear statutory language—but the analysis differs: vagueness is a constitutional challenge to the statute itself while lenity is a canon of construction requiring the court to pick the narrower reading.
- **Scenario hook:** A defendant charged under a statute prohibiting "any dangerous item" in a school zone argues that her legally owned hunting rifle in a locked car doesn't qualify.
...
- **Holding:** The common scold offense can no longer be prosecuted because it is unconstitutionally vague, violates equal protection by applying only to women, has been subsumed by modern disorderly conduct statutes, and its traditional punishment is cruel and unusual.
- **Reasoning:** The offense has no legislative definition, is grammatically limited to women, and has been rendered redundant by more precise modern statutes—making continued enforcement constitutionally untenable on multiple independent grounds.
- **Facts:** Marion Palendrano was indicted in New Jersey in 1972 on three counts, including being a "common scold and disturber of the peace"; the court dismissed the common scold count.
- **Teaches:** legality-common-law-crimes, vagueness-two-prong-test, vagueness-cant-delegate-to-blackstone, equal-protection-gender-specific-offense
- **Source type:** note case (extensively discussed and quoted in text, but not presented as a formal excerpted main case)
- **Discussion questions:** no

### Commonwealth v. Robertson (2014)
- **Holding:** A woman in a skirt on public transit is not "partially nude" under Massachusetts's voyeurism statute, so secretly photographing under her skirt does not violate the statute as written.
- **Reasoning:** The statutory text of "partially nude" is defined by reference to exposed body parts; a clothed woman does not meet the definition regardless of what is underneath her clothing, and courts cannot expand a statute to cover harmful conduct the legislature did not expressly include.
- **Facts:** Defendant used a cell phone camera to photograph up skirts of clothed female passengers on the Boston subway; charged under M.G.L. c. 272, § 105(b).
- **Teaches:** legality-common-law-crimes, lenity-harsher-reading-requires-clear-congress, asymmetric-correction-under-over-inclusive
- **Source type:** main case
- **Discussion questions:** no (callout note, not discussion questions block)

### McNally v. United States (1987)
- **Holding:** The federal mail fraud statute protects only property rights, not the intangible right to honest government services; convictions based on honest services theory reversed.
- **Reasoning:** The phrase "scheme to defraud" historically referred to deprivation of property rights; absent clear congressional language, the Court will not extend criminal statutes to reach intangible rights.
- **Facts:** Former Kentucky official and co-defendant convicted of defrauding Kentucky citizens of their right to honest government through a kickback scheme involving insurance commissions.
- **Teaches:** honest-services-mcnally-narrowing, lenity-harsher-reading-requires-clear-congress, asymmetric-correction-under-over-inclusive
- **Source type:** main case
- **Discussion questions:** no

### Skilling v. United States (2010)
- **Holding:** Section 1346 (honest services fraud) criminalizes only bribery and kickback schemes; extending it to self-dealing by officials would be unconstitutionally vague.
- **Reasoning:** The honest services statute was enacted to restore the pre-*McNally* doctrine; construing it beyond the clear core of bribery and kickbacks would raise vagueness problems because the outer limits of "self-dealing" are undefined.
- **Facts:** Jeffrey Skilling, Enron's former CEO, was convicted of honest services fraud based on self-dealing and undisclosed conflicts of interest without a direct bribe or kickback.
- **Teaches:** honest-services-skilling-bribery-kickback-only, vagueness-two-prong-test, asymmetric-correction-model-failure
- **Source type:** main case
- **Discussion questions:** yes (discussion questions follow the full corruption case study, covering McNally through Snyder)

### Snyder v. United States (2024)
- **Holding:** Federal § 666 prohibits bribes (pre-act payments to influence official action) but not gratuities (post-act payments as appreciation); a mayor's receipt of $13,000 after awarding a truck contract is a non-criminal gratuity.
- **Reasoning:** The text and structure of § 666 parallel § 201(b)'s bribery statute rather than § 201(c)'s gratuities provision; interpreting § 666 as a gratuities statute would create federalism problems by subjecting 19 million state and local officials to federal criminal liability for commonplace gifts.
- **Facts:** Mayor of Portage, Indiana received $13,000 from Peterbilt after his city had purchased five trash trucks from the company; convicted under § 666, conviction reversed.
- **Teaches:** corruption-bribe-vs-gratuity, lenity-harsher-reading-requires-clear-congress, asymmetric-correction-model-failure
- **Source type:** main case
- **Discussion questions:** yes (discussion questions follow the full corruption case study, covering McNally through Snyder)

### Bearden v. Georgia (1983)
- **Holding:** The Fourteenth Amendment prohibits revoking an indigent defendant's probation for failure to pay a fine or restitution if the defendant made bona fide efforts to pay; courts must consider alternatives before imprisoning those who cannot pay despite efforts.
- **Reasoning:** Imprisoning someone solely because they lack the resources to pay a fine deprives them of conditional freedom not because of their conduct but because of their poverty, which is contrary to the fundamental fairness required by the Fourteenth Amendment.
- **Facts:** Petitioner pleaded guilty to burglary, was placed on probation conditioned on paying $750 in fines and restitution, lost his job before paying in full, and had his probation revoked and was imprisoned despite making bona fide efforts to pay.
- **Teaches:** bearden-rule, bearden-circumvention-fees-not-fines
- **Source type:** main case
- **Discussion questions:** yes (discussion questions block at lines 335–347)

### McDonnell v. United States (2016)
- **Holding:** Arranging meetings, hosting events, and making phone calls on behalf of a benefactor do not constitute "official acts" under the federal bribery statute, even when substantial gifts are received.
- **Reasoning:** An "official act" requires a formal decision, order, or action on a matter pending before the official's office; informal facilitating conduct falls outside the statute's scope.
- **Facts:** Governor Bob McDonnell received over $175,000 in gifts from a businessman while arranging meetings and making calls to promote the businessman's dietary supplement product to state officials.
- **Teaches:** corruption-official-acts-narrowing, asymmetric-correction-model-failure
- **Source type:** note case (discussed in text, not excerpted)
- **Discussion questions:** no

### Kelly v. United States (2020)
- **Holding:** The "Bridgegate" lane closures did not constitute wire fraud because the defendants' goal was political retaliation, not obtaining money or property.
- **Reasoning:** Federal fraud statutes require a scheme to "obtain money or property"; using government resources for improper political purposes is wrongdoing but not fraud if the object is not property.
- **Facts:** New Jersey officials ordered closure of bridge lanes as political retaliation; charged with wire fraud.
- **Teaches:** corruption-fraud-property-requirement, lenity-harsher-reading-requires-clear-congress
- **Source type:** note case (discussed in text, not excerpted)
- **Discussion questions:** no

### Ciminelli v. United States (2023)
- **Holding:** The "right to control" theory of fraud—depriving a victim of "potentially valuable economic information" about a rigged bidding process—does not constitute wire fraud.
- **Reasoning:** The fraud statutes protect money and property, not the right to make informed economic decisions; extending fraud to informational rights would have no limiting principle.
- **Facts:** Defendants charged with wire fraud for rigging a bidding process; prosecution argued victims were deprived of their "right to control" economic decisions by being denied potentially valuable economic information.
- **Teaches:** corruption-fraud-property-requirement
- **Source type:** note case (discussed in text, not excerpted)
- **Discussion questions:** no

### Johnson v. United States (2015)
- **Holding:** The ACCA's residual clause—covering offenses that present "serious potential risk of physical injury"—is unconstitutionally vague.
- **Reasoning:** The residual clause generated unpredictable and arbitrary results because courts could not apply it consistently.
- **Facts:** Defendant challenged sentence enhancement under the Armed Career Criminal Act's residual clause. (Chapter cites only the holding; full facts are not recited in text.)
- **Teaches:** vagueness-two-prong-test
- **Source type:** note case (cited in text, parenthetical only)
- **Discussion questions:** no

### Yates v. United States (2015)
- **Holding:** A fish is not a "tangible object" within the meaning of the Sarbanes-Oxley provision prohibiting destruction of evidence, because the provision was enacted to address financial fraud, not fish.
- **Reasoning:** Statutory words must be read in context; "tangible object" in a financial fraud statute refers to documents and records, not fish, despite the facial breadth of the language.
- **Facts:** A commercial fisherman was charged under Sarbanes-Oxley for throwing undersized fish overboard after being told to preserve them for inspection.
- **Teaches:** lenity-fish-not-tangible-object, lenity-genuine-ambiguity-required
- **Source type:** note case (cited in text)
- **Discussion questions:** no

### Commonwealth v. Stowell (1983)
- **Holding:** The Massachusetts court acknowledged that the adultery statute had fallen into "comprehensive desuetude" but declined to invalidate it on that ground alone, leaving repeal to the legislature.
- **Reasoning:** Courts lack authority to repeal statutes; separation of powers reserves that function for the legislature even when the legislature has failed to use it.
- **Facts:** Challenge to enforcement of a Massachusetts adultery statute rarely prosecuted.
- **Teaches:** desuetude-prolonged-nonenforcement, desuetude-separation-of-powers-limit
- **Source type:** note case (cited in text)
- **Discussion questions:** no
...
|-----|---------|------------|-----------|
| legality-common-law-crimes | element | foundational | Slides 5, 6 |
| legality-no-retroactivity | element | intermediate | Slide 11 |
| vagueness-two-prong-test | element | foundational | Slides 6, 8 |
| vagueness-as-applied-vs-facial | element | intermediate | — |
| vagueness-cant-delegate-to-blackstone | element | intermediate | Slides 5, 6 |
| lenity-genuine-ambiguity-required | element | intermediate | Slide 6 |
| lenity-harsher-reading-requires-clear-congress | element | intermediate | Slides 11, 18 |
| lenity-fish-not-tangible-object | element | advanced | — |
| equal-protection-gender-specific-offense | element | foundational | — |
| desuetude-prolonged-nonenforcement | limit | intermediate | Slides 5, 6, 9 |
| desuetude-separation-of-powers-limit | limit | advanced | Slide 7 |
| asymmetric-correction-under-over-inclusive | extension | intermediate | Slides 12, 13 |
| asymmetric-correction-notice-liberty-instrumental | extension | advanced | Slide 12 |
| asymmetric-correction-model-failure | extension | advanced | Slides 10, 14, 20, 21, 22 |
| reform-commissions-mixed-results | extension | intermediate | Slides 15, 16 |
| honest-services-mcnally-narrowing | extension | foundational | Slides 17, 18, 19 |
| honest-services-skilling-bribery-kickback-only | extension | intermediate | Slide 20 |
| corruption-bribe-vs-gratuity | limit | intermediate | Slide 22 |
| corruption-official-acts-narrowing | limit | intermediate | Slide 22 |
| corruption-fraud-property-requirement | limit | advanced | Slide 22 |
| bearden-rule | element | foundational | Slide 24 |
| bearden-circumvention-fees-not-fines | extension | advanced | Slides 25, 26 |
| bearden-hb310-adaptation | extension | advanced | Slides 27, 28 |
| notice-rationale-fiction | extension | intermediate | Slides 7, 11 |
| legislative-supremacy-overcrimination | extension | advanced | Slides 7, 8, 23 |
