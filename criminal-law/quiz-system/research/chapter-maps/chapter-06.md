# Chapter Map: Prosecutors

## Meta
- Chapter: 6
- Title: Prosecutors
- Source file: criminal-law/chapters/06-prosecutors.qmd
- Source hash: 7b1be436e1501d81d847b02e6ea14a9f1e08e4e75681fb96efca1ff321917ce3
...
This chapter does not address a criminal offense with elements to prove. Instead, it maps the structure of **prosecutorial power and its limits** — the doctrines, institutional forces, and reform frameworks that define what prosecutors can and cannot do. The "elements" here are the four engines that built prosecutorial dominance, plus the doctrines that insulate that power from review.

For exam purposes, the core analytical framework is:

1. **Prosecutorial discretion is presumptively valid** — courts will not second-guess charging decisions absent proof of discriminatory purpose and effect.
2. **Absolute immunity shields prosecutors** from civil liability for conduct "intimately associated with the judicial phase of the criminal process."
3. **The trial penalty is constitutional** — threatening enhanced charges to secure a guilty plea does not violate due process so long as probable cause supports the threatened charges.
4. **Selective prosecution doctrine** requires a defendant to prove both discriminatory effect and discriminatory purpose — a near-impossible standard after *Armstrong*.

### Liability Extensions

*(Not applicable — this chapter covers prosecutorial power structures, not criminal offenses. The functional equivalent of "extensions" are doctrines that amplify prosecutorial power beyond its base level.)*

- **Mandatory minimum stacking** — statutory schemes that compound consecutive sentences give prosecutors sentencing leverage that exceeds what any judge can mitigate.
- **Overlapping statutes** — prosecutorial power to choose among overlapping charges (*Batchelder*) functions as de facto sentencing discretion.
- **Pretextual stops as investigative tools** — *Whren* extends Fourth Amendment legitimacy to stops motivated by investigative purposes unrelated to traffic safety, feeding cases into the prosecutorial pipeline.

### Liability Limits

*(Functional equivalents — doctrines that constrain prosecutorial power or provide defendants with arguments to challenge it.)*

- **Brady obligations** — prosecutors must disclose material exculpatory evidence; failure can result in reversal (though remedy is post-conviction).
- **Selective prosecution doctrine** — *Yick Wo* / *Wayte* / *Armstrong* framework; available in theory, near-impossible in practice.
- **CVRA victim rights** — attach only after formal charges are filed; no constraint on pre-charge negotiations (*In re Wild*).
- **Berger standard** — aspirational ethics rule that prosecutors seek justice, not convictions; enforced through professional discipline and appellate reversal, not civil liability.
- **Legislative reform** — First Step Act elimination of § 924(c) stacking; charging guidelines; data transparency requirements.
...
- **Practiced:** Slides 2, 3, 4 (Berger minister-of-justice standard; Imbler & Price civil immunity scope)
...
- **Practiced:** Slides 2, 3, 4 (Berger standard introduced; Price/Imbler immunity applied even to egregious misconduct; legal vs. ethical accountability)
...
### Victims' Rights and Pre-Charge Discretion
...
- **Practiced:** Slides 5, 6, 7 (CVRA text introduced; Epstein NPA litigation — 11th Circuit ruling, pre-charge black hole, legal vs. political accountability)
...
- **Practiced:** Slides 6, 7 (11th Circuit ruling on pre-charge black hole; Acosta resignation distinguishing legal from political accountability; co-conspirator immunity; jurisdictional limits of NPA)

### Expansion of Prosecutorial Power: The Four Engines
...
- **Practiced:** Slide 8 (listed as first factor in "Prosecutors' Rise to Power" summary)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 8 (listed in "Prosecutors' Rise to Power" summary under expansion of criminal codes)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 8 (*Bordenkircher v. Hayes* listed in "Prosecutors' Rise to Power" summary under rise of plea bargaining)
...
- **Practiced:** Slide 8 (*US v. Angelos* listed in "Prosecutors' Rise to Power" summary under mandatory minimums)
...
#### selective-prosecution-standard: Selective Prosecution Requires Proof of Effect and Intent
- **Rule:** To succeed on a selective prosecution claim, a defendant must prove both (1) discriminatory effect — that similarly situated individuals of other groups were not prosecuted — and (2) discriminatory purpose — that the prosecutor acted "at least in part because of" the discriminatory effect.
- **Source:** *Wayte v. United States*, 470 U.S. 598 (1985); *Yick Wo v. Hopkins*, 118 U.S. 356 (1886)
- **Trap:** Students argue that statistical evidence of racial disparity in prosecutions satisfies the selective prosecution standard. *McCleskey* and *Armstrong* foreclose this: aggregate statistics prove neither discriminatory effect on the specific defendant nor discriminatory intent in the specific case.
- **Difficulty:** intermediate
- **Pivot fact:** If a defendant can obtain internal documents showing prosecutors explicitly considered race in deciding whom to charge — smoking-gun intent evidence — a selective prosecution claim becomes viable, but prosecutors rarely generate such records.
- **Jurisdiction:** universal (constitutional equal protection floor; state courts may apply broader standards)
- **Practiced:** Slide 8 (*Wayte v. US* and *McCleskey v. Kemp* listed in "Prosecutors' Rise to Power" summary — discriminatory effect ≠ discriminatory purpose)
...
- **Practiced:** Slide 8 (*US v. Armstrong* listed in "Prosecutors' Rise to Power" summary — discoverability of selective prosecution requires showing of intent first)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 8 (*McCleskey v Kemp* listed in "Prosecutors' Rise to Power" summary — impact ≠ intent)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 8 (implied — *Wayte*, *McCleskey*, and *Armstrong* collectively addressed in "Prosecutors' Rise to Power" summary as cases making prosecutors "largely immune from review")

### Pretextual Stops and the Volume Engine
...
- **Practiced:** Slides 10, 11 (case introduced with discussion questions; Fourth Amendment probable cause, pretextual stops, racial profiling)
...
- **Practiced:** Slides 10, 11 (Whren discussed; systemic impact of pretextual stops on minority communities; channeling racial challenges to equal protection)
...
- **Practiced:** Slide 11 (high stop volume, low yield, racial disparities in Ferguson; federal funding driving pretextual policing)
...
- **Practiced:** Slides 12, 13 (prosecution intake, escalating sanctions, repeat-offense disparity compounding across community)
...
- **Jurisdiction:** universal (policy analysis)
- **Practiced:** Slides 12, 13, 14, 15 (intake, escalating sanctions, simulation, and explicit statement of the paradox — neutral practice → unfair outcomes)
...
- **Jurisdiction:** universal
- **Practiced:** Slides 9, 14, 15 (upstream bias framing; simulation illustrating cumulative disparity; explicit articulation of paradox as neutral practice producing unfair outcomes)

### Prosecutorial Reform Frameworks
...
- **Practiced:** Slides 17, 18 (John Choi/Ramsey County introduced as reform case study; community-specific reform application)
...
- **Jurisdiction:** universal
- **Practiced:** Slides 16, 17, 18 (four-step cycle introduced; John Choi as case study; "one size doesn't fit all" — community-specific application)
...
- **Jurisdiction:** universal
- **Practiced:** Slides 17, 18 (Ramsey County reform framed as evidence-based; "come up with one that fits your community" implicitly distinguishing empirical from ideological reform)
...
### cluster-immunity-accountability
- **Refinements:** absolute-immunity-scope, ethics-law-gap, historical-foundations-critique, cvra-pre-charge-black-hole
- **Why they cluster:** All four examine domains where prosecutorial conduct is insulated from legal remedy — civil immunity, pre-charge discretion, and the gap between ethics and law.
- **Scenario hook:** A prosecutor in a high-profile case secretly negotiates a non-prosecution agreement, instructs a key witness to destroy court-ordered evidence, and argues that both actions are immune from challenge — forcing the court to analyze the scope and foundations of prosecutorial immunity.

### cluster-plea-bargaining-power
- **Refinements:** plea-bargaining-trial-penalty, mandatory-minimums-power-transfer, 924c-stacking, batchelder-overlapping-statutes
- **Why they cluster:** Together they describe how prosecutors convert nominal charging decisions into effective sentencing power through the combination of overlapping statutes, mandatory minimums, and plea-or-trial pressure.
- **Scenario hook:** A first-time defendant charged with a drug offense is offered a plea deal; the prosecutor threatens to add § 924(c) counts and invoke a habitual offender enhancement if the defendant goes to trial, converting a 3-year offer into a potential 30-year exposure.

### cluster-selective-prosecution-architecture
- **Refinements:** selective-prosecution-standard, armstrong-discovery-catch22, mccleskey-statistical-evidence, yick-wo-gap
- **Why they cluster:** These four refinements form the complete architecture of why selective prosecution claims fail: the standard requires intent and effect, discovery requires what it would provide, statistics don't prove individual intent, and the original promise of *Yick Wo* was systematically narrowed.
- **Scenario hook:** A defendant charged federally with crack distribution presents data showing all 30 defendants prosecuted in this district over three years were Black, requests discovery to identify similarly situated white defendants who were not prosecuted, and must navigate each doctrinal barrier in sequence.

### cluster-pretextual-stops-pipeline
- **Refinements:** whren-pretext-constitutional, whren-equal-protection-gap, volume-engine-low-yield, stop-to-spiral
- **Why they cluster:** These refinements trace the complete pathway from constitutional authorization of pretextual stops through their aggregate effects on the prosecutorial caseload, showing how the volume engine feeds disparity into the system.
- **Scenario hook:** A county's traffic enforcement data shows that 90% of equipment-violation stops target Black drivers, yield contraband less than 1% of the time, and regularly produce arrest warrants for unpaid fines — raising both Fourth Amendment, equal protection, and policy design questions.

### cluster-prosecutors-paradox
- **Refinements:** prosecutors-paradox, individual-vs-systemic-fairness, ramsey-county-declination-policy, nullification-vs-declination
- **Why they cluster:** These refinements establish the paradox (neutral inputs produce unequal outputs), articulate the two competing fairness frameworks, and present the reform response — creating a complete analytical arc from diagnosis to intervention.
- **Scenario hook:** A newly elected county attorney reviews her office's charging data and finds that despite applying identical policies regardless of race, Black defendants are charged with felonies at five times the rate of white defendants for similar underlying conduct — and must decide how to respond.

### cluster-reform-design
- **Refinements:** justice-design-cycle, constraining-discretion-limits, transparency-metrics, ramsey-county-declination-policy
- **Why they cluster:** These refinements describe the mechanics and limits of prosecutorial reform — what tools are available, which are durable, and how evidence-based methods differ from both status-quo enforcement and ideological reform.
- **Scenario hook:** A prosecutor's office adopts an internal guideline declining to prosecute marijuana possession cases, publishes outcome data showing racial disparities, and pilots a pre-arrest diversion program — testing whether each intervention produces measurable change.
...
- **Holding:** A prosecutor's inflammatory closing argument, personal attacks, and misstatements of evidence warranted a new trial, and prosecutors serve the sovereign's interest in justice rather than in winning cases.
- **Reasoning:** The government's obligation to govern impartially means a prosecutor must refrain from methods calculated to produce wrongful convictions, not just avoid outright fraud.
- **Facts:** Prosecutor in a counterfeiting conspiracy case made inflammatory personal attacks and unsupported accusations in closing argument.
- **Teaches:** ethics-law-gap, absolute-immunity-scope
- **Source type:** note case (quoted in callout)
- **Discussion questions:** no

### Price v. Montgomery County (Craycraft / Miller case)
- **Holding:** A prosecutor who advised a witness to destroy court-ordered exculpatory evidence is absolutely immune from § 1983 liability because the advice was given in connection with the judicial phase of the criminal process.
- **Reasoning:** What matters is the function performed (prosecutorial decision-making), not the manner of execution — and withholding evidence and advising its destruction are "two sides of the same coin."
- **Facts:** Prosecutor Craycraft told witness Martin to "get rid of" letters she had been court-ordered to produce, which she did; the defendant Miller spent two years in prison before charges were dropped.
- **Teaches:** absolute-immunity-scope, ethics-law-gap, historical-foundations-critique
- **Source type:** main case
- **Discussion questions:** yes

### Doe v. United States / In re Wild (Epstein NPA)
- **Holding:** The CVRA does not apply to pre-charge non-prosecution agreements; victim rights under the statute attach only after formal criminal proceedings are instituted.
- **Reasoning:** Extending judicial oversight to pre-charge negotiations would infringe on the Executive's exclusive power to decide whether to prosecute.
- **Facts:** Federal prosecutors secretly negotiated an NPA granting Jeffrey Epstein immunity from federal sex-trafficking charges without notifying victims and while actively misleading them about the status of the investigation.
- **Teaches:** cvra-pre-charge-black-hole, executive-discretion-vs-victim-rights
- **Source type:** main case (summarized with holding and reasoning presented directly)
- **Discussion questions:** yes

### United States v. Batchelder
- **Holding:** Prosecutorial discretion to choose among overlapping statutes carrying different penalties does not violate equal protection or due process.
- **Reasoning:** The broad discretion vested in prosecutors includes the power to be influenced by available penalties, and no constitutional provision limits this choice between statutes.
- **Facts:** Defendant convicted under a five-year maximum statute when an identical-conduct statute carried only a two-year maximum.
- **Teaches:** batchelder-overlapping-statutes, code-expansion-one-way-ratchet
- **Source type:** note case (cited and described in chapter text)
- **Discussion questions:** no

### Bordenkircher v. Hayes
- **Holding:** A prosecutor does not violate due process by threatening to seek a harsher charge (carrying mandatory life imprisonment) if the defendant refuses to plead guilty to the original charge, as long as probable cause supports the threatened charge.
- **Reasoning:** Plea bargaining involves the "mutuality of advantage" and the defendant was free to accept or reject the offer; presenting difficult choices is an inevitable attribute of any system that tolerates negotiated pleas.
- **Facts:** Hayes charged with uttering an $88 forged check (2–10 year range); prosecutor threatened habitual offender enhancement (mandatory life) if he declined plea; Hayes went to trial and received life.
- **Teaches:** plea-bargaining-trial-penalty, mandatory-minimums-power-transfer
- **Source type:** main case
- **Discussion questions:** yes

### United States v. Angelos
- **Holding:** The court was required to impose a 55-year mandatory sentence under § 924(c) stacking despite finding the sentence "unjust, cruel, and irrational" for a first-time offender whose underlying conduct was marijuana sales.
- **Reasoning:** The charging decisions of the Executive, combined with mandatory consecutive sentencing requirements, left the court without discretion regardless of the judge's view of proportionality.
- **Facts:** 24-year-old music producer with no prior record convicted of three § 924(c) counts (firearm during marijuana sales); prosecutors had offered a 15-year plea; Angelos went to trial; First Step Act later eliminated stacking.
- **Teaches:** mandatory-minimums-power-transfer, 924c-stacking, plea-bargaining-trial-penalty
- **Source type:** main case
- **Discussion questions:** yes

### Yick Wo v. Hopkins
- **Holding:** A facially neutral law administered "with an evil eye and an unequal hand" against a racial minority while not applied against whites in identical circumstances violates equal protection.
- **Reasoning:** The equal protection guarantee extends to the administration of laws, not just their text — discriminatory enforcement of neutral laws is unconstitutional.
- **Facts:** San Francisco laundry ordinance applied exclusively against Chinese operators while hundreds of white operators of identical establishments were granted permits.
- **Teaches:** yick-wo-gap, selective-prosecution-standard
- **Source type:** illustrative (cited and described)
- **Discussion questions:** no

### Wayte v. United States
- **Holding:** To succeed on a selective prosecution claim, a defendant must prove both discriminatory effect (similarly situated individuals were not prosecuted) and discriminatory purpose (the prosecutor acted because of the discriminatory effect).
- **Reasoning:** Institutional concerns about chilling law enforcement and revealing government policy counsel courts to require a high threshold before invalidating prosecutorial decisions.
- **Facts:** Defendant prosecuted for failing to register for the draft argued the government targeted vocal draft resisters while ignoring passive non-registrants.
- **Teaches:** selective-prosecution-standard, yick-wo-gap
- **Source type:** note case (cited and described)
- **Discussion questions:** no

### McCleskey v. Kemp
- **Holding:** Statistical evidence showing systemic racial disparity in capital sentencing (the Baldus study) is insufficient to establish an equal protection or Eighth Amendment violation; the defendant must prove discriminatory intent in his specific case.
- **Reasoning:** Because discretion is essential to the criminal justice process, the Court would demand "exceptionally clear proof" before inferring abuse — systemic patterns do not establish individual-case intent.
- **Facts:** Warren McCleskey, a Black defendant sentenced to death for killing a white police officer, presented sophisticated regression analysis showing defendants charged with killing white victims were 4.3 times more likely to receive death.
- **Teaches:** mccleskey-statistical-evidence, selective-prosecution-standard, armstrong-discovery-catch22
- **Source type:** note case (described in detail)
- **Discussion questions:** no

### United States v. Armstrong
- **Holding:** To obtain discovery for a selective prosecution claim, a defendant must first produce credible evidence that similarly situated defendants of other races could have been prosecuted but were not.
- **Reasoning:** The presumption of regularity that attaches to prosecutorial decisions means defendants must make a threshold showing before discovery disrupts government enforcement operations.
- **Facts:** Federal public defender presented data showing all 24 crack defendants in their office's docket over three years were Black; requested discovery on similarly situated white defendants not federally charged; denied.
- **Teaches:** armstrong-discovery-catch22, selective-prosecution-standard, mccleskey-statistical-evidence
- **Source type:** note case (described in detail)
- **Discussion questions:** no

### Whren v. United States
- **Holding:** A traffic stop is constitutional under the Fourth Amendment as long as officers have probable cause to believe a traffic violation occurred, regardless of the officers' actual subjective motivations.
- **Reasoning:** Subjective intent plays no role in ordinary Fourth Amendment probable-cause analysis; equal protection (not the Fourth Amendment) is the proper vehicle for racial discrimination claims.
- **Facts:** Plainclothes officers in an unmarked vehicle stopped defendants for a traffic violation in a "high drug area"; crack cocaine found in plain view; defendants argued the stop was a pretext for drug investigation.
- **Teaches:** whren-pretext-constitutional, whren-equal-protection-gap
- **Source type:** main case
- **Discussion questions:** yes
...
|-----|---------|------------|-----------|
| absolute-immunity-scope | limit | intermediate | Slides 2, 3, 4 |
| ethics-law-gap | limit | foundational | Slides 2, 3, 4 |
| historical-foundations-critique | limit | advanced | — |
| cvra-pre-charge-black-hole | limit | intermediate | Slides 5, 6, 7 |
| executive-discretion-vs-victim-rights | limit | intermediate | Slides 6, 7 |
| code-expansion-one-way-ratchet | element | foundational | Slide 8 |
| batchelder-overlapping-statutes | element | intermediate | Slide 8 |
| plea-bargaining-trial-penalty | element | intermediate | Slide 8 |
| mandatory-minimums-power-transfer | element | foundational | Slide 8 |
| 924c-stacking | element | intermediate | — |
| selective-prosecution-standard | limit | intermediate | Slide 8 |
| armstrong-discovery-catch22 | limit | advanced | Slide 8 |
| mccleskey-statistical-evidence | limit | advanced | Slide 8 |
| yick-wo-gap | limit | intermediate | Slide 8 |
| whren-pretext-constitutional | element | foundational | Slides 10, 11 |
| whren-equal-protection-gap | element | advanced | Slides 10, 11 |
| volume-engine-low-yield | element | intermediate | Slide 11 |
| stop-to-spiral | element | intermediate | Slides 12, 13 |
| prosecutors-paradox | element | intermediate | Slides 12, 13, 14, 15 |
| individual-vs-systemic-fairness | element | foundational | Slides 9, 14, 15 |
| ramsey-county-declination-policy | limit | intermediate | Slides 17, 18 |
| justice-design-cycle | limit | foundational | Slides 16, 17, 18 |
| nullification-vs-declination | limit | advanced | Slides 17, 18 |
| constraining-discretion-limits | limit | intermediate | — |
| transparency-metrics | limit | foundational | — |
