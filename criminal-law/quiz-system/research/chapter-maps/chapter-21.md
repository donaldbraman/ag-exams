# Chapter Map: Necessity and Duress

## Meta
- Chapter: 21
- Title: Necessity and Duress
- Source file: criminal-law/chapters/21-necessity-duress.qmd
- Source hash: 2282c06954c99207603bb8f2dc286dbed20abea81293a3f9563fe6df36b7dcc9
...
1. The defendant faced a genuine choice of evils and chose the lesser evil.
2. The harm avoided clearly outweighed (CL) or was greater than (MPC) the harm caused.
3. The threat was imminent (CL) or imminent enough to be relevant to reasonableness (MPC — no strict requirement).
4. The defendant had no reasonable legal alternative.
5. The defendant was not at fault in creating the emergency (CL) or the defendant's fault in creating the crisis was less culpable than the mental state required by the charged offense (MPC fault-calibration rule).

**Duress**

1. A threat of death or serious bodily injury (CL) or unlawful force (MPC) directed at the defendant, a close relation (CL), or any person (MPC).
2. The threat was imminent (CL), or sufficiently real and ongoing (MPC — no strict imminence requirement).
3. A reasonable person — or a person of reasonable firmness in the defendant's situation (MPC) — would have been unable to resist.
4. No reasonable legal alternative existed.

### Liability Extensions

*(Neither necessity nor duress has formal extensions analogous to Pinkerton. This section is not applicable to this chapter.)*

### Liability Limits

1. **Homicide bar** — Necessity is categorically unavailable as a defense to homicide under the common law (Dudley and Stephens). Duress is categorically unavailable for murder under the common law. MPC rejects both bars, but no court has upheld necessity for homicide in a reported case.
2. **Legislative preemption** — Necessity fails in any jurisdiction when the legislature has already addressed the specific conduct (e.g., Schedule I drug classifications). Available in both CL and MPC.
3. **Self-created situation bar** — If the defendant was at fault in creating the crisis, necessity is barred under the CL. Under the MPC, the defense is reduced but not eliminated: compare the defendant's fault level to the mental state required by the charge.
4. **Felony murder exception (duress)** — Several states (Michigan, Maryland, California, Ohio) hold that duress is available for felony murder if it is available for the underlying predicate felony. The traditional CL murder bar does not automatically apply.
5. **Burden of proof (duress)** — Federal courts require the defendant to prove duress by a preponderance of the evidence. Many states require the prosecution to disprove duress beyond a reasonable doubt once the defendant raises it. This allocation can be outcome-determinative.

---

## Refinements

### Justification vs. Excuse (Foundational Framework)
...
- **Practiced:** Slide 1 — title slide introducing both defenses; Slide 3 — "Justification: You made the right choice. Excuse: You had no real choice."
...
- **Practiced:** Slide 4 — CL/MPC comparison table with proportionality row highlighted
...
- **Practiced:** Slide 9 — "Necessity never justifies taking an innocent life"; Slide 10 — "Can lives be compared?" — CL vs. MPC frameworks
...
- **Jurisdiction:** split (traditional/MPC)
- **Practiced:** Slide 4 — imminence row of CL/MPC comparison table

---

### Necessity — No Reasonable Legal Alternative
...
### Necessity — Fault-Calibration Rule (MPC)
...
- **Jurisdiction:** split (traditional/MPC)
- **Practiced:** Slide 5 — duress CL/MPC table, "Threat of" row; Slide 12 — CL elements listed
...
- **Jurisdiction:** split (traditional/MPC)
- **Practiced:** Slide 5 — duress table, "Against" row

---

### Duress — Imminence and Physical Presence
...
- **Practiced:** Slide 13 — Dingwall facts; Slide 14 — "Imminence does not require physical proximity"
...
### Duress — Reasonable Firmness Standard
...
### Duress — Homicide Bar and Felony Murder Exception
...
- **Jurisdiction:** split (traditional/MPC)
- **Practiced:** Slide 5 — homicide row of duress comparison table; Slide 12 — "Never available for homicide"
...
### Duress — Duty to Protect and Role-Based Expectations
...
### Duress — Expert Testimony on Battering
...
- **Practiced:** Slide 14 — Dingwall holding on expert testimony; Slide 15 — "What is the court really deciding?" (judge vs. jury allocation)
...
- **Practiced:** Slide 19 — "Three Pathways" reform slide includes coercive control defense as third option

---

### Duress — Reform Pathways
...
- **Practiced:** Slide 19 — "Three Pathways" with Survivors' Justice Acts, Doctrinal Reform, and Coercive Control Defense

---

## Clusters

### cluster-necessity-core
- **Refinements:** necessity-proportionality-standard, necessity-imminence, mpc-fault-calibration, necessity-cannot-compare-lives
- **Why they cluster:** These are the four core analytical moves in any necessity analysis — students must work through proportionality, imminence, fault, and the homicide bar in sequence.
- **Scenario hook:** A reckless driver swerves onto a sidewalk to avoid a school bus that has lost its brakes, killing a pedestrian; a jury must decide whether necessity applies to the manslaughter charge, the trespass charge, and whether the homicide bar blocks the defense in a CL state.

### cluster-necessity-alternatives
- **Refinements:** prison-escape-threshold, civil-disobedience-no-exhaustion, legislative-preemption-absolute
- **Why they cluster:** All three are about the "no reasonable legal alternative" element — each applies it in a different real-world context with its own doctrinal gloss.
- **Scenario hook:** A federal prisoner with a documented history of futile complaints about gang violence escapes and, after reaching safety, sends a letter to a senator about prison conditions; prosecuted for escape and for possessing a prohibited substance he used to treat PTSD, he raises necessity — forcing analysis of prison-escape doctrine, legal alternatives, and preemption.

### cluster-duress-imminence
- **Refinements:** duress-imminence-proximity, duress-corrupt-authorities, bwt-admissibility-split
- **Why they cluster:** All three address whether a non-proximate, diffuse threat can satisfy duress elements — imminence without physical presence, alternatives when police are unavailable, and evidence of how the defendant reasonably perceived the threat.
- **Scenario hook:** A woman in a sustained abusive relationship commits a series of frauds while her partner is at work in a city with documented police corruption; she seeks to introduce expert battering testimony in the Tenth Circuit.

### cluster-duress-homicide
- **Refinements:** duress-murder-bar, felony-murder-duress-exception, duty-to-protect-standard
- **Why they cluster:** All three address the intersection of duress with homicide or near-homicide scenarios and the limits of the murder bar.
- **Scenario hook:** A battered woman serves as a lookout while her partner — armed with a gun she knew he had — enters a home and kills the occupant; she is charged with felony murder and with failing to seek medical care for her child who was injured in the same incident.

### cluster-duress-objective-standard
- **Refinements:** reasonable-firmness-objective, burden-of-proof-duress, duress-target-scope, duress-threat-threshold
- **Why they cluster:** All four refine what the objective standard requires and who bears the burden of establishing it, varying by jurisdiction.
- **Scenario hook:** A military contractor captured in a conflict zone cooperates with insurgents under threats of minor physical harm directed at a journalist who is a stranger; prosecuted in federal court, she argues duress.

### cluster-reform
- **Refinements:** reform-three-pathways, coercive-control-vs-bws, bwt-admissibility-split, duty-to-protect-standard
- **Why they cluster:** All four address the structural mismatch between doctrine and the reality of sustained coercion, and the tools available to bridge the gap.
- **Scenario hook:** A woman convicted of failing to protect her child from her abuser moves for resentencing under a state Survivors' Justice Act; her attorney argues that the coercive control doctrine, had it been available at trial, would have changed the jury's assessment of her "reasonable firmness."

### cluster-justification-vs-excuse
- **Refinements:** justification-vs-excuse, necessity-cannot-compare-lives, duress-murder-bar
- **Why they cluster:** The justification/excuse distinction governs both the homicide bar analysis and derivative liability; necessity and duress offer contrasting answers to the same lethal-threat scenario.
- **Scenario hook:** Two defendants face the same threat: one commits homicide to save a bus full of schoolchildren; the other commits homicide because a gunman forced her to shoot at gunpoint; analyze whether justification or excuse applies to each, whether the homicide bar applies, and whether an accomplice shares in either defense.
...
- **Holding:** Necessity does not justify the deliberate taking of an innocent life; the killing of the cabin boy was murder.
- **Reasoning:** Courts cannot safely judge the comparative value of lives; allowing necessity for homicide would make the doctrine a "legal cloak for unbridled passion," and if the law is too severe in a particular case, the remedy is executive clemency.
- **Facts:** Four men stranded at sea for twenty days; after the cabin boy fell ill from drinking sea water, two of the sailors killed and ate him; a passing vessel rescued the survivors four days later.
- **Teaches:** necessity-cannot-compare-lives, necessity-proportionality-standard, necessity-imminence
- **Source type:** main case
- **Discussion questions:** no (holding and reasoning presented as excerpts; Problems 4 and the hypotheticals generate the discussion)

### United States v. Dingwall
- **Holding:** Imminence in a duress case does not require physical proximity of the person making the threat; the case was reversed and remanded for jury consideration.
- **Reasoning:** A pattern of continuous, unpredictable abuse can cause a reasonable person in the defendant's situation to perceive imminent danger even when the abuser is not physically present; expert testimony on battering and learned helplessness is admissible to help the jury evaluate that perception.
- **Facts:** Marjory Dingwall committed three armed robberies at her abusive boyfriend's direction; he was either in the car outside or at work during each robbery; she claimed she was terrified he would kill her if she refused.
- **Teaches:** duress-imminence-proximity, bwt-admissibility-split, duress-corrupt-authorities (reasonable alternatives)
- **Source type:** main case
- **Discussion questions:** no (slide discussion prompts closely parallel what the chapter's embedded discussion questions would ask)

### People v. Unger
- **Holding:** Specific factors such as reporting to authorities and surrendering upon reaching safety are matters for the jury's assessment of weight and credibility, not strict prerequisites that a judge applies to exclude the necessity defense.
- **Reasoning:** Treating the Lovercamp factors as mandatory conditions would unduly restrict the jury's role and could defeat otherwise meritorious defenses; they bear on credibility rather than legal sufficiency.
- **Facts:** Unger escaped from a minimum-security honor farm after receiving death threats and sexual assaults from fellow inmates; he was apprehended two days later, had not reported to authorities, and never voluntarily surrendered.
- **Teaches:** prison-escape-threshold
- **Source type:** note case
- **Discussion questions:** yes (Problem 1 hypothetical)

### People v. Sarnie
- **Holding:** A prisoner who escapes to protect his unsupervised child from a dangerous environment is not entitled to a necessity defense where there was no specific, immediate threat and he made no showing that reporting to child protective services would be futile.
- **Reasoning:** The concerns were understandable but did not amount to a specific imminent threat, and the defendant demonstrated no futility of legal alternatives.
- **Facts:** Robert Sarnie walked away from a work furlough facility after learning his 13-year-old son was living unsupervised in a home with drug users; he did not contact police or child protective services before leaving.
- **Teaches:** prison-escape-threshold, necessity-imminence
- **Source type:** note case
- **Discussion questions:** yes (Problem 1 hypothetical comparing Unger and Sarnie)

### State v. Higgins
- **Holding:** A climate activist who engaged in indirect civil disobedience is not entitled to a necessity defense because legal alternatives were not exhausted; lobbying, organizing, and petitioning remain available so long as Congress has not acted.
- **Reasoning:** Legal alternatives in indirect civil disobedience are never deemed exhausted when congressional action could address the harm; the fact that previous political efforts failed does not establish exhaustion.
- **Facts:** Leonard Higgins cut a fence and turned a valve on a Canadian tar sands pipeline to protest climate change; charged with felony criminal mischief and misdemeanor trespass.
- **Teaches:** civil-disobedience-no-exhaustion
- **Source type:** note case
- **Discussion questions:** yes (Problem 2 hypothetical)

### State v. Ward
- **Holding:** Ken Ward's right to present a complete defense was violated when the trial judge barred his necessity claim; Washington became the first state to allow a climate activist to present necessity to a jury.
- **Reasoning:** Ward produced sufficient evidence on all four necessity elements, including a genuine factual dispute on exhaustion of legal alternatives, to permit jury consideration; excluding the defense denied his Sixth Amendment right to present a complete defense.
- **Facts:** Ward shut off a tar sands oil valve in the same coordinated protest as Higgins; convicted of burglary at second trial after the court barred the necessity defense; Washington Court of Appeals reversed.
- **Teaches:** civil-disobedience-no-exhaustion, prison-escape-threshold (by contrast — threshold vs. jury question)
- **Source type:** note case
- **Discussion questions:** yes (Problem 2 hypothetical)

### United States v. Oakland Cannabis Buyers' Cooperative
- **Holding:** There is no medical necessity exception to the Controlled Substances Act's Schedule I marijuana prohibition; congressional classification of marijuana forecloses the defense.
- **Reasoning:** When Congress has made a determination of values by classifying a substance, courts applying necessity cannot second-guess that legislative judgment; the balancing is already done.
- **Facts:** The cooperative distributed marijuana to patients with chronic conditions under California's Compassionate Use Act; the federal government sought an injunction.
- **Teaches:** legislative-preemption-absolute
- **Source type:** note case
- **Discussion questions:** yes (Problem 3 hypothetical on psilocybin)

### United States v. Fleming
- **Holding:** A prisoner of war who cooperated with captors for material benefits and to improve conditions for fellow prisoners was not entitled to a duress defense; the fact that other prisoners in the same conditions refused to cooperate undermined the claim.
- **Reasoning:** Absent "dire and direct physical duress," material benefits and indirect pressure are insufficient; the objective firmness standard compares the defendant to others who faced identical threats.
- **Facts:** Lt. Col. Fleming led Marxist study groups and made propaganda recordings for Chinese captors; he claimed cooperation reduced the camp death rate; other officers in the same camp refused to cooperate.
- **Teaches:** reasonable-firmness-objective
- **Source type:** note case
- **Discussion questions:** yes (Problem 6 hypothetical)

### United States v. Contento-Pachon
- **Holding:** The defendant was entitled to present a duress defense to the jury; the three-week gap between the initial threat and the criminal act did not negate imminence where the threat was continuous, and the defendant's belief that police were corrupt was a question for the trier of fact.
- **Reasoning:** Imminence does not require the threat to be contemporaneous with the crime if the threat is continuous; judicial exclusion of evidence of corrupt police usurps the jury's factfinding role.
- **Facts:** Bogota taxi driver swallowed cocaine-filled balloons after a drug trafficker threatened to kill his wife and child; he believed local police were paid informants for the traffickers; he voluntarily consented to x-ray at U.S. customs.
- **Teaches:** duress-imminence-proximity, duress-corrupt-authorities
- **Source type:** note case
- **Discussion questions:** yes (Problem 5 hypothetical)

### People v. Reichard
- **Holding:** Duress may be asserted as an affirmative defense to felony murder if the defense is available for the predicate felony; the traditional murder bar does not automatically extend to felony murder.
- **Reasoning:** The murder bar rests on the premise that a defendant chose between lives; felony murder charges a defendant with murder for participating in a lesser crime, not for intentionally choosing to kill — so the rationale for the bar does not apply.
- **Facts:** Tiffany Reichard served as a lookout during a robbery her abusive partner committed; her partner stabbed the victim 91 times; she claimed she participated under duress; she did not know her partner intended to kill.
- **Teaches:** felony-murder-duress-exception, duress-murder-bar
- **Source type:** note case
- **Discussion questions:** yes (Problem 7 hypothetical)

### People v. Romero
- **Holding:** The defendant's trial attorney provided ineffective assistance of counsel by failing to investigate or present expert testimony on battered woman syndrome to support her duress defense.
- **Reasoning:** Without BWS expert testimony, the jury had no framework for understanding why the defendant remained in the relationship or why she complied with her abuser's demands to commit crimes.
- **Facts:** Debra Romero participated in a series of robberies with her abusive partner Terrance; she claimed duress based on daily beatings and death threats; she was convicted on all five charges without BWS testimony.
- **Teaches:** bwt-admissibility-split, coercive-control-vs-bws, duty-to-protect-standard (by contrast with Webb)
- **Source type:** note case
- **Discussion questions:** yes (Problem 8 hypothetical)

### United States v. Webb
- **Holding:** June Webb's conviction for injury to a child by failing to obtain medical care was affirmed; the circuit court found no error, and the BWS question was not discussed on appeal.
- **Reasoning:** The jury's split verdict — acquitting on accessory after the fact but convicting on child injury — reflects an implicit distinction between omissions affecting strangers and failures to protect one's own child.
- **Facts:** June Webb failed to obtain medical care for her six-year-old son while he deteriorated under her abusive partner's beatings; she was acquitted of accessory after the fact to murder but convicted on two child injury counts.
- **Teaches:** duty-to-protect-standard, bwt-admissibility-split, reform-three-pathways (by illustrating the limits of existing doctrine)
- **Source type:** note case
- **Discussion questions:** yes (Problem 8 hypothetical; Slide 17–18 direct class discussion)

### Dixon v. United States
- **Holding:** Duress does not negate mens rea; the defendant therefore bears the burden of proving duress by a preponderance of the evidence in federal court.
- **Reasoning:** Because duress excuses rather than negates intent, placing the burden on the defendant does not violate due process; Congress may constitutionally allocate the burden of affirmative defenses to defendants.
- **Facts:** Gail Dixon was convicted of firearms offenses; she claimed duress based on her abusive boyfriend's threats; the Supreme Court addressed only the burden of proof, not the admissibility of battering evidence.
- **Teaches:** burden-of-proof-duress, bwt-admissibility-split (the Court declined to reach admissibility)
- **Source type:** note case
...
|-----|---------|------------|-----------|
| justification-vs-excuse | element (framework) | foundational | Slides 1, 3 |
| necessity-proportionality-standard | element | foundational | Slide 4 |
| necessity-cannot-compare-lives | limit | intermediate | Slides 9, 10 |
| necessity-imminence | element | foundational | Slide 4 |
| prison-escape-threshold | element (no-alternative) | intermediate | — |
| civil-disobedience-no-exhaustion | element (no-alternative) | advanced | — |
| legislative-preemption-absolute | limit | intermediate | — |
| mpc-fault-calibration | element (fault) | advanced | — |
| duress-threat-threshold | element | foundational | Slides 5, 12 |
| duress-target-scope | element | intermediate | Slide 5 |
| duress-imminence-proximity | element | intermediate | Slides 13, 14 |
| duress-corrupt-authorities | element (no-alternative) | intermediate | — |
| reasonable-firmness-objective | element | advanced | — |
| burden-of-proof-duress | limit | intermediate | — |
| duress-murder-bar | limit | foundational | Slides 5, 12 |
| felony-murder-duress-exception | limit | advanced | — |
| duty-to-protect-standard | element | advanced | Slides 17, 18 |
| bwt-admissibility-split | element | advanced | Slides 14, 15 |
| coercive-control-vs-bws | element | advanced | Slide 19 |
| reform-three-pathways | limit | advanced | Slide 19 |
