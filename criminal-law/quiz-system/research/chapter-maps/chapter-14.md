# Chapter Map: Felony Murder and Misdemeanor Manslaughter

## Meta
- Chapter: 14
- Title: Felony Murder and Misdemeanor Manslaughter
- Source file: criminal-law/chapters/14-felony-murder-misdemeanor-manslaughter.qmd
- Source hash: a9fcccacffed3103d4ca61dd55b42e2f
...
1. The defendant committed or attempted to commit a qualifying predicate felony.
2. A person died.
3. The death occurred during the commission or attempted commission of that felony (or, under proximate cause theory, was a foreseeable result of it).
4. The defendant (or, in some jurisdictions, any co-felon) caused the death — *no mens rea for the killing is required under the traditional rule*.

**Misdemeanor Manslaughter**

1. The defendant committed or attempted to commit a misdemeanor (or, in some states, any unlawful act).
2. A person died.
3. The death was caused by (proximately resulted from) the commission of that misdemeanor.
4. No proof of criminal negligence or recklessness regarding the death is required under the traditional rule.

### Liability Extensions

1. **Accomplice / co-felon liability** — A participant in the underlying felony who did not personally cause the death may still be convicted of felony murder as an accomplice; the extent of liability depends on the jurisdiction's theory (proximate cause vs. agency) and, after *Tison*, on whether the accomplice was a "major participant" acting with "reckless indifference to human life."

### Liability Limits

1. **Inherently dangerous felony requirement** — Many states restrict felony murder to predicate felonies that are "inherently dangerous to human life," measured either abstractly (elements of the offense) or concretely (facts as committed).
2. **Merger doctrine** — Assaultive felonies that have no independent felonious purpose beyond the killing itself cannot serve as felony murder predicates; they "merge" with the homicide.
3. **Agency theory** — Under the majority rule, felony murder applies only when a co-felon (not a police officer, victim, or bystander) does the killing.
4. **Malum in se / malum prohibitum distinction (misdemeanor manslaughter)** — Some states require that the predicate misdemeanor be malum in se; malum prohibitum offenses require independent proof of criminal negligence.
5. **Proximate cause / dangerousness (misdemeanor manslaughter)** — The unlawful aspect of the defendant's conduct must be causally connected to (and the specific danger that produced) the death.
...
- **Practiced:** Slides 2, 3, 4, 5, 6 — arson and burglary hypotheticals directly tested this substitution under both Oklahoma and MPC frameworks.
...
- **Practiced:** Slides 3, 4 — Oklahoma and MPC statutes compared side by side; students identified enumerated felonies under each.
...
- **Practiced:** Slides 4, 5, 6 — arson and burglary hypotheticals directly contrasted MPC versus traditional approaches; students asked which prosecution would prefer.
...
- **Practiced:** Slides 12, 13 — *Brown* case facts and the court's prospective abolition of constructive malice were presented in detail.
...
### Limiting Doctrines — Inherently Dangerous Felony
...
- **Practiced:** Slide 8 — inherently dangerous limitation and both approaches explicitly taught.

### Limiting Doctrines — Merger
...
- **Practiced:** Slides 9, 10 — merger doctrine and *Wilson* explicitly taught with discussion questions.
...
- **Practiced:** Slide 9 (merger) and Slide 8 (inherently dangerous) — though the "squeeze" synthesis was not explicitly named on slides.
...
- **Practiced:** Slides 11, 12, 13, 15 — judicial abolition and *Brown* extensively taught; students asked about the distinction between aggravating element and independent theory.
...
- **Practiced:** Slide 14 — legislative abolition in Hawaii and Kentucky explicitly taught.
...
- **Practiced:** Slides 19, 20, 21 — misdemeanor manslaughter introduced, *Weitbrecht* and *Todd* applied.
...
- **Practiced:** Slide 22 — *Williams* and *Walker* contrasted explicitly as "limitations."
...
- **Practiced:** Slide 24 — "The Gap" slide explicitly framed this paradox (Blankenship, Warner Lambert); Slide 23 — Station nightclub fire.

---

## Clusters

### cluster-traditional-vs-mpc
- **Refinements:** strict-liability-substitution, mpc-rebuttable-presumption, enumerated-vs-unenumerated
- **Why they cluster:** These three refinements form the baseline doctrinal contrast that all other analysis builds on — what the traditional rule does, what the MPC does instead, and how both systems tier predicate felonies.
- **Scenario hook:** David sets fire to his estranged wife's house, not knowing she is inside; she dies — analyze under Oklahoma's statute, then under MPC § 210.2(1)(b), and identify the prosecution's preferred forum.

### cluster-accomplice-liability
- **Refinements:** tison-major-participant, brown-remote-outer-fringes, sb-1437-major-participant, smith-proximate-cause-police
- **Why they cluster:** All four refinements ask how far accomplice liability extends when someone other than the principal defendant causes the death — *Tison* sets the constitutional floor, *Brown* / SB 1437 raise the state-law bar, and *Smith* adds the wrinkle of a non-felon killer.
- **Scenario hook:** Alex, who organized a robbery but stayed home, Blake, who drove the getaway car, and Casey, who entered the store with a toy gun, face felony murder after a clerk shoots and kills a bystander — analyze liability in Alabama, Pennsylvania, California (post-SB 1437), and Massachusetts (post-*Brown*).

### cluster-limiting-doctrines
- **Refinements:** elements-vs-facts-approach, merger-independent-purpose, squeeze-effect
- **Why they cluster:** These three refinements work together as the "squeeze" — dangerous felony requirement from one side, merger from the other — and must be applied sequentially to any predicate felony analysis.
- **Scenario hook:** Daniel committed aggravated assault (state-law felony) against a store owner during a robbery, and the victim's heart gave out — analyze whether the predicate qualifies under California's abstract test, whether it merges, and identify what felony would survive the squeeze.

### cluster-reform-landscape
- **Refinements:** judicial-abolition-malice, legislative-abolition-hawaii-kentucky, sb-1437-major-participant, disparate-impact-reform, deterrence-failure
- **Why they cluster:** The reform wave is driven by three converging pressures — doctrinal incoherence (no real mens rea), empirical failure (deterrence doesn't work), and equity concerns (racial and age disparities) — and courts/legislatures respond in different ways.
- **Scenario hook:** A state legislature is considering whether to judicially abolish, legislatively reform per SB 1437, or retain with limiting doctrines — brief the three options using *Aaron*, *Brown*, and California's data.

### cluster-misdemeanor-manslaughter-basics
- **Refinements:** mm-strict-liability-structure, mm-proximate-cause-limit, mm-mpc-rejection
- **Why they cluster:** These form the parallel structure to the felony murder basics cluster — the constructive approach, its proximate cause limit, and the MPC's complete rejection.
- **Scenario hook:** A driver with an expired license runs a red light (minor traffic violation), causing a crash that kills a pedestrian — analyze under Ohio's traditional rule (*Weitbrecht*), Pennsylvania's *Williams* proximate cause limitation, and then in a state that has adopted the MPC.

### cluster-mm-limiting-doctrines
- **Refinements:** mm-proximate-cause-limit, mm-malum-in-se, mm-dangerousness-ca
- **Why they cluster:** Each of these is a different limiting device courts use to restrain misdemeanor manslaughter — proximate causation, moral character of the offense, and factual dangerousness — and they often appear in tandem in harder cases.
- **Scenario hook:** A bar owner, violating a local ordinance about serving alcohol to minors, serves a visibly intoxicated minor who drives home and kills a pedestrian — analyze whether this is malum in se or prohibitum, whether the unlawful aspect is causally connected, and whether California's dangerousness test is met.

### cluster-regulatory-gap
- **Refinements:** regulatory-gap, mm-strict-liability-structure, disparate-impact-reform
- **Why they cluster:** The regulatory gap reversal — misdemeanor manslaughter punishes minor individual violators severely while corporate actors operating under federal statutory caps escape serious liability — makes full sense only against the background of the constructive liability structure and the disparate-impact patterns.
- **Scenario hook:** A landlord with expired fire code violations faces misdemeanor manslaughter for a tenant's death while a chemical company CEO whose willful OSHA violations killed a worker faces a six-month federal misdemeanor maximum — explain the doctrinal and structural reasons for this inversion.
...
- **Holding:** The court reduced Brown's conviction from first-degree to second-degree felony murder because his participation was on the "remote outer fringes" of the joint venture; Chief Justice Gants announced prospectively that Massachusetts would require proof of actual malice for all murder convictions.
- **Reasoning:** Felony murder convictions disproportionate to culpability (absent accomplice who lent a gun and sweatshirts) erode the relationship between criminal liability and moral culpability; constructive malice is a "fiction."
- **Facts:** Brown lent a gun and sweatshirts to co-conspirators planning a robbery, remained at his apartment; co-conspirators shot and killed two brothers during the robbery.
- **Teaches:** brown-remote-outer-fringes, judicial-abolition-malice, tison-major-participant
- **Source type:** main case
- **Discussion questions:** yes

### Smith v. State (Alabama, 2018)
- **Holding:** Under Alabama's proximate cause theory, LaKeith Smith — a fifteen-year-old burglar — was properly convicted of felony murder for a companion's death caused by a police officer's bullet during the burglary; sentence later reduced on resentencing.
- **Reasoning:** Alabama's proximate cause theory makes a felon liable for any death that is a foreseeable consequence of the felony, including deaths caused by law enforcement responding to the crime.
- **Facts:** Smith (age 15) and companions burglarized homes; at the second home, police arrived and shot and killed A'Donte Washington, a companion; Smith was convicted of Washington's murder.
- **Teaches:** smith-proximate-cause-police, disparate-impact-reform
- **Source type:** main case (note-format)
- **Discussion questions:** yes (Discussion Questions block after the three cases)

### Tison v. Arizona (1987)
- **Holding:** Major participation in the underlying felony, combined with reckless indifference to human life, satisfies the *Enmund* culpability requirement for the death penalty; intent to kill is not required.
- **Reasoning:** Reckless indifference to human life — torturing or brutalizing victims while leaving them to die — may be as morally culpable as an intent to kill; a narrow focus on intent to kill is an "unsatisfactory" way to identify the most dangerous offenders.
- **Facts:** Ricky and Raymond Tison helped their father and a prison companion escape; they watched without intervening as the family of four was murdered by their father and Greenawalt.
- **Teaches:** tison-major-participant, accomplice-liability
- **Source type:** main case
- **Discussion questions:** yes (Discussion Questions block after the three cases)

### State v. Weitbrecht (Ohio, 1999)
- **Holding:** Ohio's misdemeanor manslaughter statute (R.C. 2903.04(B)) — imposing felony-level punishment for deaths during minor traffic misdemeanors — does not violate the Eighth Amendment even where there is no criminal negligence.
- **Reasoning:** Lives were lost, and the gravity of the crime is not lessened by the minor nature of the underlying misdemeanor; the potential five-year penalty is not so disproportionate as to shock the community's sense of justice.
- **Facts:** Nancy Weitbrecht apparently suffered a cardiac event, crossed left of center, and killed three people; the state stipulated no criminal recklessness or negligence.
- **Teaches:** mm-strict-liability-structure, regulatory-gap
- **Source type:** main case
- **Discussion questions:** yes

### Todd v. State (Fla. 5th DCA, 1992)
- **Holding:** A petty theft conviction cannot support a misdemeanor manslaughter charge where a bystander who gave chase suffered a fatal heart attack during the pursuit, because the petty theft lacked the direct, foreseeable risk of physical harm necessary for legal causation.
- **Reasoning:** The theft itself involved no violence, touching, or threat to persons; causation must involve the kind of direct, foreseeable physical harm risk that connects the unlawful act to the death.
- **Facts:** Todd stole $110 from a church collection plate; a congregation member with a heart condition pursued him by car, suffered a cardiac event, and died.
- **Teaches:** mm-proximate-cause-limit, mm-strict-liability-structure
- **Source type:** main case
- **Discussion questions:** no (case appears in a run of illustrative cases; no explicit discussion questions attached to it directly)

### Commonwealth v. Williams (Pa. Super. 1938)
- **Holding:** A driver with an expired license cannot be convicted of misdemeanor manslaughter for a crash caused by the independent intervening act of another driver swerving into his lane, because the lack of a license bore no causal relationship to the death.
- **Reasoning:** The unlawful aspect of the defendant's conduct must be what caused the danger; without any connection between driving unlicensed and the collision, the misdemeanor did not cause the death.
- **Facts:** Wendell Williams, driving without a current operator's license (no negligence found), swerved to avoid an oncoming car and skidded on ice, killing his passenger.
- **Teaches:** mm-proximate-cause-limit
- **Source type:** main case
- **Discussion questions:** no

### United States v. Walker (D.C. 1977)
- **Holding:** Carrying a pistol without a license is inherently dangerous because it involves an armed person who has not demonstrated the competency and fitness the licensing scheme requires; death from an accidental discharge validly charges misdemeanor manslaughter.
- **Reasoning:** The licensing scheme exists to ensure that only safe, qualified individuals carry firearms; the unlicensed carrier presents exactly the danger the law seeks to prevent, connecting the unlawfulness to the harm.
- **Facts:** Walker, carrying an unlicensed pistol, dropped it in a stairwell; the gun discharged and fatally wounded a bystander.
- **Teaches:** mm-proximate-cause-limit
- **Source type:** main case
- **Discussion questions:** no

### People v. Wilson (CA)
- **Holding:** Assault with a deadly weapon merges with the homicide and cannot serve as a predicate for felony murder because it has no independent felonious purpose beyond the violence itself.
- **Reasoning:** Allowing ADW to serve as a felony murder predicate would make the doctrine swallow all intentional killings; the independent purpose test preserves the distinction between murder and felony murder.
- **Facts:** Wilson forced his way into his estranged wife's apartment with a shotgun and killed two people.
- **Teaches:** merger-independent-purpose
- **Source type:** illustrative (discussed in slides; implicit in chapter's merger discussion though not excerpted in main chapter text)
- **Discussion questions:** no (appears as teaching illustration)
...
|-----|---------|------------|-----------|
| strict-liability-substitution | element | foundational | slides 2, 3, 4, 5, 6 |
| enumerated-vs-unenumerated | element | foundational | slides 3, 4 |
| mpc-rebuttable-presumption | element | intermediate | slides 4, 5, 6 |
| tison-major-participant | extension | intermediate | — |
| brown-remote-outer-fringes | extension | intermediate | slides 12, 13 |
| smith-proximate-cause-police | limit | advanced | — |
| elements-vs-facts-approach | limit | intermediate | slide 8 |
| merger-independent-purpose | limit | intermediate | slides 9, 10 |
| squeeze-effect | limit | advanced | slides 8, 9 (implicit) |
| judicial-abolition-malice | limit | intermediate | slides 11, 12, 13, 15 |
| legislative-abolition-hawaii-kentucky | limit | foundational | slide 14 |
| sb-1437-major-participant | limit | advanced | slide 16 |
| disparate-impact-reform | extension | intermediate | slide 24 (implicit) |
| deterrence-failure | element | intermediate | — |
| mm-strict-liability-structure | element | foundational | slides 19, 20, 21 |
| mm-proximate-cause-limit | limit | intermediate | slide 22 |
| mm-malum-in-se | limit | advanced | — |
| mm-dangerousness-ca | limit | advanced | — |
| mm-mpc-rejection | limit | foundational | — |
| regulatory-gap | extension | advanced | slides 23, 24 |
