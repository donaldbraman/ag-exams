# Chapter Map: Drugs and Guns

## Meta
- Chapter: 15
- Title: Reform: Drugs and Guns
- Source file: criminal-law/chapters/15-reform-drugs-guns.qmd
- Source hash: 3e5a2eb42e4dbf9e8da5d33f2be60531ad619979
...
**Constructive Possession (drugs or firearms):**

1. The defendant knew of the contraband's presence.
2. The defendant had the power to exercise dominion and control over it (i.e., the ability to access or manage it).
3. The defendant intended to exercise dominion and control over it at the relevant time.

*Note:* Mere proximity, mere presence on the property where contraband is found, and mere association with someone who controls the contraband are each individually insufficient.

**Felon-in-Possession (18 U.S.C. § 922(g)(1)):**

1. The defendant is a prohibited person (e.g., a convicted felon).
2. The defendant possessed a firearm or ammunition.
3. The firearm or ammunition had traveled in interstate commerce.

**"Using" a Firearm During a Drug Trafficking Crime (18 U.S.C. § 924(c)):**

1. The defendant committed or attempted a drug trafficking crime.
2. The defendant used or carried a firearm during and in relation to that crime.

### Liability Extensions

- **Quantity-based mandatory minimums:** Drug weight alone, without proof of distribution intent, can trigger mandatory minimum sentences and sentencing enhancements under 21 U.S.C. § 841(b).
- **Drug-induced homicide:** A person who distributes drugs that cause a fatal overdose can face murder or manslaughter liability under drug-induced homicide statutes (majority of states).
- **§ 924(c) stacking (pre-First Step Act):** Each additional § 924(c) count within an indictment formerly triggered consecutive 25-year mandatory minimums.

### Liability Limits

- **Awareness without dominion:** Knowing that contraband is in a shared space does not establish constructive possession without evidence of the defendant's dominion and control over it.
- **Exclusive control by another:** Where contraband is found in a space within the exclusive control of a co-occupant, this defeats constructive possession for the defendant.
- **Knowledge of substance type:** For existing schedule substances, the government must prove the defendant knew the substance was a controlled substance, but not necessarily which specific substance (general nature suffices under most circuits).
- **"Using" a firearm — receipt in trade:** Receiving a firearm as payment for drugs does not constitute "using" a firearm under § 924(c) (*Watson*); only the party tendering the gun "uses" it.
- **Post-*Bruen* constitutional limits:** Firearms regulations must now be consistent with the nation's historical tradition of firearm regulation; pure public health justifications without historical analogues may not sustain gun restrictions.
...
- **Practiced:** Slides 6–8 — Jenkins facts, holding, and dissent extensively discussed in class
...
- **Practiced:** Slide 8 — holding and dissent comparison directly practiced
...
- **Jurisdiction:** universal
- **Practiced:** Slides 9–11 — White facts and holding directly practiced; awareness vs. dominion/control explicitly discussed
...
- **Jurisdiction:** universal
- **Practiced:** Slides 9–11 — White facts (wife's dresser, daughter's room, couch) practiced in detail
...
### Quantity, Intent, and Sentencing
...
- **Practiced:** Slide 17 (Angelos) and Slide 13 (§ 922(g) demographics) touch on sentencing disparities
...
- **Practiced:** Slide 20 (Iron Law of Prohibition) touches on unregulated supply chain that creates fentanyl substitutions

### Gun Regulation: Constitutional Framework
...
- **Jurisdiction:** universal
- **Practiced:** Slide 12 (§ 922(g)) and Slide 22 (gun violence evidence) connect constitutional constraint to policy evidence
...
- **Practiced:** Slide 16 — Watson holding explicitly references and contrasts Smith
...
- **Jurisdiction:** federal only
- **Practiced:** Slides 14–16 — Watson facts, holding, and Ginsburg concurrence fully practiced
...
- **Jurisdiction:** federal only
- **Practiced:** Slide 16 — Ginsburg concurrence explicitly discussed
...
- **Jurisdiction:** federal only
- **Practiced:** Slide 17 — Angelos problem directly practiced; stacking mechanism explained
...
- **Jurisdiction:** universal
- **Practiced:** Slides 4, 19 — directly practiced
...
- **Jurisdiction:** universal
- **Practiced:** Slide 20 — directly practiced
...
- **Jurisdiction:** universal
- **Practiced:** Slide 19 — directly practiced; Slide 22 (focused deterrence vs. mandatory minimums for guns)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 21 — directly practiced
...
- **Practiced:** Slide 23 — directly practiced
...
- **Practiced:** Slide 22 — directly practiced
...
- **Practiced:** Slide 13 — directly practiced (§ 922(g) demographics and Project Exile)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 13 (§ 922(g) demographics) — racial disparate enforcement discussed; Slide 24 (Ramsey County) — structural response practiced
...
- **Practiced:** Slide 24 — directly practiced

---

## Clusters

### cluster-constructive-possession-core
- **Refinements:** cp-elements, cp-snapshot-problem, cp-awareness-control, cp-exclusive-control, cp-incriminating-statement
- **Why they cluster:** These five refinements together define the boundaries of constructive possession and govern any fact pattern where contraband is found in a shared space.
- **Scenario hook:** A convicted felon lives with his wife and adult son in a three-bedroom apartment; officers executing a search warrant find cocaine on the kitchen table, a handgun in the master bedroom nightstand, and marijuana in the son's closet — the felon is seated in the living room when officers arrive and says "that's not all mine."

### cluster-household-firearm-defense
- **Refinements:** cp-awareness-control, cp-exclusive-control, cp-2a-concurrence, gun-922g-felon
- **Why they cluster:** Post-*Bruen* felon-in-possession cases in shared households require combining constructive possession analysis with the open constitutional question about nonviolent felons.
- **Scenario hook:** A man convicted a decade ago of nonviolent fraud lives with his wife who legally owns a firearm for self-defense; the gun is found in her bedside drawer during a parole check and he told authorities he knew it was there.

### cluster-quantity-sentencing-fentanyl
- **Refinements:** qty-pwid, qty-mandatory-minimums, qty-fentanyl-homicide, mens-rea-type, mens-rea-fentanyl-asymmetry
- **Why they cluster:** The fentanyl crisis illustrates how quantity thresholds, the general-nature mens rea standard, strict liability on substance identity, and drug-induced homicide statutes stack on top of each other in a single transaction.
- **Scenario hook:** Two friends buy what they believe is heroin; the seller delivers fentanyl without disclosing the substitution; one friend shares the supply with the other, who dies of an overdose — the surviving friend possessed 3 grams.

### cluster-924c-use
- **Refinements:** use-924c-trading-gun-for-drugs, use-924c-trading-drugs-for-gun, use-ginsburg-weapon-only, use-924c-stacking
- **Why they cluster:** These four refinements trace the full arc of § 924(c) "use" doctrine — its asymmetry, the stacking problem, and the unresolved interpretive question Ginsburg raised.
- **Scenario hook:** A person convicted twice of drug trafficking — once for trading a gun for cocaine, once for trading cocaine for a gun — is now charged under § 924(c) for both transactions.

### cluster-pc-gap-plea
- **Refinements:** pc-gap, cp-legislative-inference, qty-pwid
- **Why they cluster:** The gap between probable cause and proof beyond reasonable doubt is exploited in plea bargaining and addressed differently by permissive-inference statutes and quantity-based charges.
- **Scenario hook:** Police arrest four people in a car where a bag of drugs is found under the passenger seat; the driver and all passengers are charged with constructive possession; three plead guilty without trial.

### cluster-constitutional-gun-doctrine
- **Refinements:** gun-heller-mcdonald, gun-bruen-test, gun-rahimi-soften, gun-922g-felon, gun-commerce-clause
- **Why they cluster:** These refinements build the full constitutional framework for gun regulation that now governs every firearms restriction and must be mastered together.
- **Scenario hook:** A state enacts a law disarming persons convicted of any felony from possessing firearms; a person convicted of a 20-year-old nonviolent financial fraud challenges the law as applied to him.

### cluster-policy-enforcement-failure
- **Refinements:** policy-enforcement-failure, policy-iron-law, policy-certainty-not-severity, policy-sentencing-ratchet, policy-project-exile
- **Why they cluster:** These refinements build the empirical case against the dominant enforcement model and force students to think about what law is for.
- **Scenario hook:** A legislature is considering doubling mandatory minimums for fentanyl distribution in response to rising overdose deaths; a public health advocate testifies with the data from this chapter.

### cluster-reform-alternatives
- **Refinements:** policy-mat-treatment, policy-decriminalization-infrastructure, policy-permit-to-purchase, policy-ramsey-county
- **Why they cluster:** These refinements catalog what the evidence shows actually works, contrasting enforcement-dominant with health-infrastructure approaches.
- **Scenario hook:** A newly elected district attorney with a fixed budget must decide whether to prosecute drug possession cases aggressively or redirect resources to homicide investigation and harm reduction referral.

### cluster-crack-powder-racial-politics
- **Refinements:** qty-crack-powder, qty-state-variation, policy-sentencing-ratchet, policy-enforcement-failure
- **Why they cluster:** The crack-powder disparity is the clearest case study of how quantity thresholds encode racial politics, and the state-variation comparison shows the contingency of these choices.
- **Scenario hook:** A defendant is charged federally with possession of 30 grams of crack cocaine, a quantity that would be legal in one state and carry a 5-year mandatory minimum in federal court.
...
- **Holding:** Mere proximity to contraband — no matter how close — does not establish constructive possession; the government must show the defendant had dominion and control, not just that he was near the drugs.
- **Reasoning:** The court found the government had only a "snapshot" showing Jenkins near contraband in another person's apartment, with no evidence he associated himself with the drug operation, handled the drugs, or took any action consistent with control.
- **Facts:** Police chased a gunman into an apartment and found Jenkins seated on a couch in boxer shorts next to a coffee table bearing 55 grams of cocaine, scales, loaded firearms, and packaging materials; Jenkins had no residue on his hands, made no attempt to flee or destroy evidence, and was described as someone who came "in and out" with the tenant.
- **Teaches:** cp-elements, cp-snapshot-problem
- **Source type:** main case
- **Discussion questions:** yes

### State of Louisiana v. Gerald Manchip White
- **Holding:** A defendant's awareness that firearms are in a shared household is insufficient to establish constructive possession; the state must prove the defendant had the requisite intent to exercise dominion and control over each specific firearm.
- **Reasoning:** The court found that the gun in the wife's dresser was within her exclusive control (her belongings, no evidence defendant accessed the drawer), and the defendant's statement that "the gun" was still in the house proved only awareness, not dominion over Jordan's gun in the couch.
- **Facts:** A convicted felon living with his wife, daughter, and son had parole officers discover three guns in the home; his wife owned the bedroom gun, his daughter's boyfriend brought another hours before the check, and his son owned the third; defendant had told his parole officer days earlier that "the gun" was still in the house.
- **Teaches:** cp-awareness-control, cp-exclusive-control, cp-incriminating-statement, cp-2a-concurrence
- **Source type:** main case
- **Discussion questions:** yes

### County Court of Ulster County v. Allen
- **Holding:** New York's permissive inference statute — allowing the jury to infer that all vehicle occupants possessed any firearm found in the car — does not violate due process, because the inference is permissive (the jury may but need not draw it) and the prosecution retains the full burden of proof.
- **Reasoning:** A permissive inference, unlike a mandatory presumption, does not shift the burden of proof and leaves the jury free to reject the inference in light of all the evidence.
- **Facts:** Multiple occupants of a car challenged New York Penal Law § 265.15, which creates an inference of possession for all occupants of a vehicle where a firearm is found.
- **Teaches:** cp-legislative-inference
- **Source type:** note case
- **Discussion questions:** no

### Conley v. United States
- **Holding:** D.C.'s statute making it a felony to be voluntarily present in a vehicle knowing it contained a firearm violated due process by criminalizing "entirely innocent behavior" without requiring any proof of the defendant's dominion or control.
- **Reasoning:** The statute punished proximity as a standalone offense rather than as evidence of possession, and the defendant had been acquitted of all possession charges — yet was convicted for sitting near the gun he was found not to possess.
- **Facts:** A jury acquitted Conley of all possession charges but convicted him under D.C. Code § 22-2511 for being voluntarily present in a vehicle where a gun was found between the front seats.
- **Teaches:** cp-legislative-inference
- **Source type:** note case
- **Discussion questions:** no

### McFadden v. United States
- **Holding:** For controlled substance analogues, the government must prove the defendant knew the substance had properties of a controlled substance — either its specific identity or that it had psychoactive properties similar to a controlled substance.
- **Reasoning:** Congress intended scienter requirements to apply to the knowledge element; but for analogues the defendant need not know the substance was specifically an analogue, only that it had controlled-substance-like properties.
- **Facts:** McFadden sold bath salts (controlled substance analogues) without knowing they were subject to the Controlled Substances Act's analogue provisions.
- **Teaches:** mens-rea-type, mens-rea-fentanyl-asymmetry
- **Source type:** note case
- **Discussion questions:** no

### District of Columbia v. Heller
- **Holding:** The Second Amendment protects an individual right to possess and use firearms for traditionally lawful purposes, especially self-defense in the home, independent of militia service.
- **Reasoning:** The Court's textual and historical analysis concluded that "the right of the people to keep and bear Arms" is an individual right, not a collective right tied to organized militia service.
- **Facts:** Dick Heller challenged D.C.'s handgun ban and requirement that all firearms in the home be kept unloaded and disassembled or bound by a trigger lock.
- **Teaches:** gun-heller-mcdonald, gun-commerce-clause
- **Source type:** note case
- **Discussion questions:** no

### McDonald v. City of Chicago
- **Holding:** The Second Amendment individual right recognized in *Heller* is incorporated against the states through the Fourteenth Amendment's Due Process Clause.
- **Reasoning:** The right to keep and bear arms for self-defense is "deeply rooted in this Nation's history and tradition" and essential to the concept of ordered liberty.
- **Facts:** Otis McDonald challenged Chicago's handgun ban under the Fourteenth Amendment after *Heller* invalidated D.C.'s similar ban.
- **Teaches:** gun-heller-mcdonald
- **Source type:** illustrative
- **Discussion questions:** no

### New York State Rifle & Pistol Association v. Bruen
- **Holding:** When the Second Amendment's text covers an individual's conduct, the government must justify a firearms regulation by demonstrating it is consistent with the nation's historical tradition of firearm regulation; the pre-*Bruen* means-end balancing test is rejected.
- **Reasoning:** The Court held that the Second Amendment's meaning was fixed at ratification and Reconstruction; modern public health justifications cannot save regulations without historical analogues.
- **Facts:** New York required individuals to show "proper cause" to obtain a license to carry a handgun in public; the plaintiffs were denied licenses because they had no special need beyond general self-defense.
- **Teaches:** gun-bruen-test, gun-commerce-clause
- **Source type:** illustrative
- **Discussion questions:** yes

### United States v. Rahimi
- **Holding:** A federal statute prohibiting persons subject to domestic violence restraining orders from possessing firearms does not violate the Second Amendment, because the historical tradition of disarming persons who pose a credible threat to others provides a sufficient analogue.
- **Reasoning:** The government need not find a historical twin; consistency with the general principle of disarming dangerous persons suffices under *Bruen*'s framework.
- **Facts:** Zackey Rahimi, subject to a domestic violence restraining order after assaulting his girlfriend, was found with a firearm and challenged his conviction under 18 U.S.C. § 922(g)(8).
- **Teaches:** gun-rahimi-soften, gun-922g-felon
- **Source type:** illustrative
- **Discussion questions:** no

### Range v. Attorney General (3d Cir. 2023)
- **Holding:** Section 922(g)(1) is unconstitutional as applied to a person convicted of making a false statement to obtain food stamps, a nonviolent offense, because the government could not identify a historical tradition of disarming such persons.
- **Reasoning:** Bryan Range was not "dangerous" in the historical sense that justified disarmament; the founding-era tradition targeted violent, not merely felonious, persons.
- **Facts:** Bryan Range, convicted decades earlier of making a false statement on a food stamps application (a state misdemeanor treated as a federal felony equivalent), challenged his permanent disarmament under § 922(g)(1).
- **Teaches:** gun-922g-felon, gun-bruen-test, gun-rahimi-soften
- **Source type:** note case
- **Discussion questions:** no

### Smith v. United States
- **Holding:** Trading a gun in exchange for drugs constitutes "using" a firearm during and in relation to a drug trafficking crime under 18 U.S.C. § 924(c).
- **Reasoning:** The Court held that "use" in § 924(c) encompasses any active employment of the firearm, including as an item of barter or commerce, not only deployment as a weapon.
- **Facts:** John Angus Smith offered an undercover officer a firearm in exchange for cocaine; he was charged with "using" a firearm in connection with a drug trafficking offense.
- **Teaches:** use-924c-trading-gun-for-drugs, use-924c-trading-drugs-for-gun, use-ginsburg-weapon-only
- **Source type:** illustrative
- **Discussion questions:** no

### Watson v. United States
- **Holding:** A defendant who receives a firearm in exchange for drugs does not "use" a firearm during a drug trafficking crime under § 924(c); only the party tendering the gun "uses" it.
- **Reasoning:** Ordinary language does not describe the party receiving goods in a transaction as "using" the goods they receive as consideration; a "seller does not 'use' a buyer's consideration."
- **Facts:** Michael Watson told a government informant he wanted a gun; the informant suggested Watson pay in narcotics; Watson traded 24 doses of OxyContin for a .50 caliber pistol and was charged with "using" the firearm under § 924(c).
- **Teaches:** use-924c-trading-drugs-for-gun, use-924c-trading-gun-for-drugs, use-ginsburg-weapon-only
- **Source type:** main case
- **Discussion questions:** yes

### United States v. Jones (Project Exile)
- **Holding:** *[District court context, not a contested legal ruling]* Both parties acknowledged that approximately 90% of Project Exile defendants were African American.
- **Reasoning:** The case is cited for its factual record on the racial demographics of Project Exile enforcement, not for a contested legal holding.
- **Facts:** Federal prosecution of Richmond gun cases under Project Exile's model of routing gun offenses to federal court for mandatory minimum sentences.
- **Teaches:** policy-project-exile, policy-sentencing-ratchet
- **Source type:** illustrative
- **Discussion questions:** no

### Maryland v. Pringle
- **Holding:** Probable cause existed to arrest all three occupants of a car where drugs and cash were found, because it was reasonable to infer that any or all of them possessed the contraband.
- **Reasoning:** "Probable cause" is a "practical, nontechnical conception" requiring only a reasonable ground for belief of guilt — a far lower standard than proof beyond a reasonable doubt.
- **Facts:** Officers found rolled-up money and cocaine in a car with three occupants; all three were arrested; Pringle (front passenger) later confessed.
- **Teaches:** pc-gap
- **Source type:** illustrative
- **Discussion questions:** no

### Gonzales v. Raich
- **Holding:** Congress has authority under the Commerce Clause to prohibit local cultivation and use of marijuana even where state law permits it, because homegrown marijuana substantially affects interstate drug markets.
- **Reasoning:** The regulation of local marijuana production is an essential part of a broader regulatory scheme — the CSA — that falls within Congress's commerce power.
- **Facts:** California patients who grew marijuana for personal medical use under state law challenged the federal CSA's application to their conduct.
- **Teaches:** gun-commerce-clause
- **Source type:** illustrative
- **Discussion questions:** no
...
|-----|---------|------------|-----------|
| cp-elements | element | foundational | slides 6–8 |
| cp-snapshot-problem | element | intermediate | slide 8 |
| cp-awareness-control | element | foundational | slides 9–11 |
| cp-exclusive-control | element | intermediate | slides 9–11 |
| cp-incriminating-statement | element | intermediate | slides 9–11 |
| cp-2a-concurrence | limit | advanced | slide 11 |
| pc-gap | element | advanced | — |
| cp-legislative-inference | limit | advanced | — |
| qty-pwid | element | foundational | — |
| qty-mandatory-minimums | extension | intermediate | slide 17 |
| qty-crack-powder | extension | intermediate | slides 13, 17 |
| qty-state-variation | element | intermediate | — |
| qty-fentanyl-homicide | extension | advanced | — |
| mens-rea-type | element | intermediate | — |
| mens-rea-fentanyl-asymmetry | element | advanced | slide 20 |
| gun-commerce-clause | element | intermediate | slides 12, 22 |
| gun-heller-mcdonald | element | foundational | — |
| gun-bruen-test | limit | intermediate | slides 12, 22 |
| gun-rahimi-soften | limit | intermediate | — |
| gun-922g-felon | limit | advanced | — |
| use-924c-trading-gun-for-drugs | extension | intermediate | slide 16 |
| use-924c-trading-drugs-for-gun | limit | intermediate | slides 14–16 |
| use-ginsburg-weapon-only | limit | advanced | slide 16 |
| use-924c-stacking | extension | intermediate | slide 17 |
| policy-enforcement-failure | element | foundational | slides 4, 19 |
| policy-iron-law | element | intermediate | slide 20 |
| policy-certainty-not-severity | element | intermediate | slides 19, 22 |
| policy-mat-treatment | element | foundational | slide 21 |
| policy-decriminalization-infrastructure | element | intermediate | slide 23 |
| policy-permit-to-purchase | element | intermediate | slide 22 |
| policy-project-exile | element | intermediate | slide 13 |
| policy-sentencing-ratchet | extension | advanced | slides 13, 24 |
| policy-ramsey-county | element | intermediate | slide 24 |
