# Chapter Map: Unintentional Homicide

## Meta
- Chapter: 13
- Title: Homicide: Unintentional Killing
- Source file: criminal-law/chapters/13-unintentional-homicide.qmd
- Source hash: 7d4ce23d80776e8bb41925ee1a0feaa7
...
1. **Unlawful killing of a human being** — the defendant caused the death of another person without legal justification. (Same as intentional homicide — the unintentional nature is reflected in the mental state element, not the act element.)
2. **Causation** — the defendant's conduct was the proximate and actual cause of death. For omissions, the critical question is whether the defendant's failure to act during the window when intervention could have saved the victim caused the death.
3. **Mental state sufficient for the charged grade** — the required mental state varies by grade and jurisdiction:
   - *Ordinary negligence* (historic minority; Washington pre-reform): failure to exercise ordinary caution a reasonable person would exercise
   - *Gross/criminal negligence* (majority involuntary manslaughter standard): a gross deviation from the standard of care a reasonable person would exercise — more than ordinary negligence
   - *Recklessness* (MPC manslaughter; also many common law "wanton or reckless" standards): conscious disregard of a substantial and unjustifiable risk
   - *Extreme recklessness / depraved heart* (second-degree murder): recklessness manifesting extreme indifference to the value of human life

### Liability Extensions

*(None in this chapter. Felony murder, which extends murder liability to unintentional killings in felony contexts, is a separate doctrine addressed elsewhere.)*

### Liability Limits

1. **Gradation floor — ordinary negligence insufficient** (in most jurisdictions): A defendant cannot be convicted of involuntary manslaughter unless the negligence is at least "gross" or "criminal." Mere failure to exercise ordinary care is a civil wrong, not a crime. (Washington's former ordinary-negligence standard was an outlier; no state retains it today.)
2. **Gradation ceiling — conduct not likely to cause death** (depraved heart murder): Even reprehensible recklessness does not rise to depraved heart murder unless the conduct was objectively likely, if not certain, to cause death. A defendant whose conduct satisfies gross negligence manslaughter is not automatically a depraved heart murderer. (*Beckwitt*)
3. **MPC intoxication rule — voluntary intoxication does not negate recklessness** (MPC § 2.08(2)): In MPC jurisdictions, a drunk actor's unawareness of risk is treated as if the actor were sober for purposes of determining recklessness. The intoxication defense cannot eliminate the recklessness element.

---

## Refinements

### Mental State Threshold for Involuntary Manslaughter
...
- **Practiced:** slide 4 — MPC vs. traditional comparison table; slide 5 — Williams timeline; slide 6 — criminal negligence definition
...
- **Practiced:** slide 4 — direct comparison table; slide 3 — common law homicide diagram showing the spectrum

---

### The Negligence-Recklessness Divide in Practice
...
- **Practiced:** slide 9 — Coconut Grove fire photograph; slide 10 — direct Welansky quote on constructive recklessness
...
- **Practiced:** slide 8 — Native American child removal historical context; slide 5 — Williams timeline showing critical period
...
- **Practiced:** slide 7 — Thomas and Huigens photographs; slide 11 — application to Welansky
...
- **Practiced:** slide 12 — Vaught case summary and comparison to Williams

---

### Depraved Heart Murder — The Manslaughter/Murder Line
...
- **Practiced:** slide 14 — MPC § 210.2 text and commentary; slide 13 — Manslaughter v. Murder transition
...
- **Practiced:** slide 19 — Beckwitt holding summary and line-drawing
...
- **Practiced:** slide 15 — why delegate to the finder of fact; slide 16 — judicial gatekeeping vs. jury authority; *Warner-Lambert* comparison

---

### Drunk Driving Homicide — Legislative Design Approaches
...
- **Practiced:** slides 21–24 — overview of the scale of the problem and all four approaches
...
- **Practiced:** slide 22 — Approach 1: Murder; Watson advisement details
...
- **Practiced:** slide 23 — Approach 2 details including strict liability vs. recklessness spectrum
...
- **Practiced:** slide 25 — MPC Intoxication Rule text and implications
...
### cluster-negligence-recklessness-foundations
- **Refinements:** ordinary-negligence-threshold, gross-criminal-negligence, mpc-manslaughter-negligent-homicide-split, constructive-recklessness-welansky
- **Why they cluster:** These refinements collectively map the spectrum from ordinary negligence to recklessness and establish the key doctrinal dividing lines that every unintentional homicide analysis must traverse.
- **Scenario hook:** A landlord who has received multiple complaints about dangerous wiring in his rental property dies on a business trip while tenants die in a fire caused by the faulty wiring — the scenario forces students to locate the landlord's omission on the negligence-to-recklessness spectrum under both common law and MPC frameworks.

### cluster-williams-context-culpability
- **Refinements:** ordinary-negligence-threshold, reasonable-person-standard-social-context, criminal-negligence-philosophical-rationale
- **Why they cluster:** *Williams* raises simultaneously the doctrinal question (what standard applies) and the normative question (should background and social context affect culpability assessment) — engaging both Thomas's and Huigens's theoretical frameworks.
- **Scenario hook:** A low-income single mother with documented distrust of child protective services delays taking her sick child to the hospital because of prior negative experiences with the welfare system, and the child dies of a treatable illness.

### cluster-welansky-beckwitt-manslaughter-murder-line
- **Refinements:** constructive-recklessness-welansky, omission-duty-recklessness, extreme-indifference-standard, likely-if-not-certain-standard
- **Why they cluster:** *Welansky* and *Beckwitt* both involve employers who created dangerous conditions leading to death by fire — but produce different outcomes (manslaughter affirmed vs. murder reversed in *Beckwitt*), requiring students to identify precisely where the manslaughter/murder line falls.
- **Scenario hook:** A warehouse owner who stores flammable materials in violation of fire code, and has received citations he ignored, has an employee who dies when a fire breaks out — the question is whether the conditions support gross negligence manslaughter, depraved heart murder, or both.

### cluster-jury-delegation-institutional-design
- **Refinements:** jury-delegation-rationale, extreme-indifference-standard, likely-if-not-certain-standard
- **Why they cluster:** These refinements raise the institutional design question that cuts across the chapter: when judges screen on sufficiency vs. when juries decide gradation, and what that means for accountability in cases involving powerful actors.
- **Scenario hook:** A pharmaceutical company that continues distributing a drug after internal studies show a 5% fatal adverse reaction rate — presenting the question whether this is gross negligence manslaughter, depraved heart murder, or neither, and who decides.

### cluster-dui-homicide-legislative-design
- **Refinements:** four-approaches-overview, watson-advisement-implied-malice, vehicular-homicide-strict-liability, prior-convictions-as-mental-state-vs-enhancer, mpc-intoxication-recklessness, per-victim-stacking
- **Why they cluster:** DUI homicide is the chapter's case study in legislative design — how different jurisdictions have made different doctrinal choices about the same recurring fact pattern, producing dramatically different outcomes.
- **Scenario hook:** A driver with two prior DUI convictions (one resulting in a Watson advisement in California) kills two pedestrians while driving with a BAC of .18 in three different jurisdictions — students must analyze the applicable theory and potential sentence in each.

### cluster-professional-negligence
- **Refinements:** medical-negligence-criminalization, gross-criminal-negligence, mpc-manslaughter-negligent-homicide-split, criminal-negligence-philosophical-rationale
- **Why they cluster:** The Vaught case tests whether and how criminal negligence applies to professional contexts, raising the same fundamental questions about the objective reasonable-person standard, the policy costs of criminalization, and the competing rationales for punishing negligent conduct.
- **Scenario hook:** A hospital pharmacist who works a 36-hour shift due to staff shortage and fills the wrong prescription, killing a patient — the question is whether exhaustion-induced error constitutes criminal negligence and whether the institutional context should affect the analysis.
...
### State v. Williams
- **Holding:** Parents who failed to seek timely medical attention for their infant, who died of an untreated infected tooth, were guilty of statutory manslaughter under Washington's then-applicable ordinary negligence standard.
- **Reasoning:** The court held that regardless of the defendants' subjective ignorance and good intentions, an objective reasonable person in their circumstances would have sought medical care during the critical window before the infection became fatal (September 1–5).
- **Facts:** A 17-month-old child died after parents delayed seeking medical care for what turned out to be a gangrenous tooth infection; parents feared the welfare system would remove their child based on the history of Native American child removal.
- **Teaches:** ordinary-negligence-threshold, reasonable-person-standard-social-context, criminal-negligence-philosophical-rationale, gross-criminal-negligence
- **Source type:** main case
- **Discussion questions:** yes

### Commonwealth v. Welansky
- **Holding:** Nightclub owner convicted of involuntary manslaughter through wanton or reckless conduct for maintaining locked and blocked emergency exits that prevented escape when a fire killed hundreds of patrons.
- **Reasoning:** The court held that recklessness under Massachusetts common law is a "constructive" standard — a defendant who knew facts that would have caused a reasonable person to perceive grave danger is treated as reckless, even if the defendant himself believed conditions were safe.
- **Facts:** Barnett Welansky operated the Coconut Grove nightclub in Boston; on November 28, 1942, a fire broke out and hundreds died because the emergency exits were locked, barred, or obscured; Welansky was hospitalized at the time but had created the dangerous conditions through years of intentional neglect.
- **Teaches:** constructive-recklessness-welansky, omission-duty-recklessness, criminal-negligence-philosophical-rationale, extreme-indifference-standard
- **Source type:** main case
- **Discussion questions:** yes

### Beckwitt v. State
- **Holding:** The Maryland Court of Appeals affirmed Beckwitt's conviction for gross negligence involuntary manslaughter but reversed his depraved heart murder conviction because his conduct, though reprehensible, was not the type "reasonably likely, if not certain, to cause death."
- **Reasoning:** The court held that Maryland's depraved heart murder standard requires conduct that an objectively reasonable person would see as virtually certain to cause death, considering both the inherent dangerousness of the act and environmental risk factors cumulatively — a threshold higher than gross recklessness alone.
- **Facts:** Beckwitt employed Askia Khafra to dig tunnels beneath his home; Khafra was kept blindfolded, confined, unable to shower, in an electrical-hazard environment; when a fire broke out at 2:32 a.m. and Khafra messaged Beckwitt, Beckwitt did not see the messages until 9 a.m., and took no effective action; Khafra died in the fire, and firefighters needed nearly two minutes to navigate the hoarder-filled home.
- **Teaches:** likely-if-not-certain-standard, extreme-indifference-standard, omission-duty-recklessness, constructive-recklessness-welansky, jury-delegation-rationale
- **Source type:** main case
- **Discussion questions:** yes

### People v. Watson (California)
- **Holding:** A drunk driver who killed two people while driving 84 mph with a BAC of .23 can be charged with second-degree murder based on "implied malice" — conscious disregard for human life — rather than merely manslaughter.
- **Reasoning:** The court held that implied malice (the subjective mental state of conscious disregard for human life) can be inferred from a drunk driver's conduct when the driver was aware of the risks of drunk driving (e.g., from prior DUI experience or general public knowledge) and chose to drive drunk anyway.
- **Facts:** Defendant drove drunk at high speed, causing a crash that killed two people; prior DUI history established awareness of the risk of drunk driving.
- **Teaches:** watson-advisement-implied-malice, four-approaches-overview, extreme-indifference-standard
- **Source type:** note case
- **Discussion questions:** no

### People v. Heidgen (New York)
- **Holding:** A drunk driver who drove the wrong way on a parkway with a BAC over three times the legal limit, killing a limousine driver and a seven-year-old girl, was properly convicted of depraved indifference murder.
- **Reasoning:** The extreme conduct — knowingly driving at highway speeds in the wrong direction on a divided highway — combined with extreme intoxication demonstrated depraved indifference to human life sufficient to support murder.
- **Facts:** Defendant drove drunk in the wrong direction on a parkway, killing two people.
- **Teaches:** watson-advisement-implied-malice, four-approaches-overview, extreme-indifference-standard
- **Source type:** note case
- **Discussion questions:** no

### People v. Warner-Lambert Co. (referenced from Chapter 8)
- **Holding:** The New York Court of Appeals dismissed the indictment because the specific ignition mechanism that caused the factory explosion was neither foreseen nor foreseeable, making the causal chain too speculative.
- **Reasoning:** The court held that criminal causation requires that the specific manner of harm (not just harm generally) be reasonably foreseeable, and applied this as a threshold question for the judge, not the jury.
- **Facts:** Six workers died in a factory explosion caused by ambient magnesium stearate dust; the manufacturer knew of explosion risk in general but not the specific ignition mechanism that triggered this particular explosion.
- **Teaches:** jury-delegation-rationale, extreme-indifference-standard
- **Source type:** illustrative
- **Discussion questions:** no

### RaDonda Vaught Case
- **Holding:** Vaught was convicted of criminally negligent homicide (not manslaughter) for a fatal drug error; the court granted judicial diversion (expungement after probation).
- **Reasoning:** Vaught's systematic bypassing of safety protocols by switching the medication cabinet into "override" mode — enabling withdrawal of a drug not prescribed to the patient — constituted a gross deviation from the standard of care a reasonable nurse would exercise, satisfying criminal negligence even though she did not consciously perceive the specific risk.
- **Facts:** Vaught, a nurse, accidentally administered vecuronium (a powerful paralyzer) instead of the prescribed Versed (sedative) to a 75-year-old patient by using override mode on the medication cabinet; the patient died.
- **Teaches:** medical-negligence-criminalization, gross-criminal-negligence, mpc-manslaughter-negligent-homicide-split, criminal-negligence-philosophical-rationale
- **Source type:** note case
- **Discussion questions:** yes
...
|-----|---------|------------|-----------|
| ordinary-negligence-threshold | element (mental state) | foundational | slide 4, slide 5, slide 6 |
| gross-criminal-negligence | element (mental state) | foundational | slide 4, slide 6 |
| mpc-manslaughter-negligent-homicide-split | element (mental state) | foundational | slide 4, slide 3 |
| constructive-recklessness-welansky | element (mental state) | intermediate | slide 9, slide 10 |
| omission-duty-recklessness | element (mental state) | intermediate | — |
| reasonable-person-standard-social-context | element (mental state) | intermediate | slide 8, slide 5 |
| criminal-negligence-philosophical-rationale | element (mental state) | advanced | slide 7, slide 11 |
| medical-negligence-criminalization | element (mental state) | intermediate | slide 12 |
| extreme-indifference-standard | element (mental state — murder) | foundational | slide 14, slide 13 |
| likely-if-not-certain-standard | limit (depraved heart ceiling) | intermediate | slide 19 |
| jury-delegation-rationale | element (mental state — murder) | advanced | slide 15, slide 16 |
| four-approaches-overview | element (mental state — DUI) | foundational | slides 21–24 |
| watson-advisement-implied-malice | element (mental state — DUI) | intermediate | slide 22 |
| vehicular-homicide-strict-liability | element (mental state — DUI) | intermediate | slide 23 |
| prior-convictions-as-mental-state-vs-enhancer | element (mental state — DUI) | advanced | — |
| mpc-intoxication-recklessness | limit (intoxication) | intermediate | slide 25 |
| per-victim-stacking | element (sentencing) | intermediate | — |
