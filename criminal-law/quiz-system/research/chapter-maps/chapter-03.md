# Chapter Map: What We Punish

## Meta
- Chapter: 3
- Title: What We Punish
- Source file: criminal-law/chapters/03-what-we-punish.qmd
- Source hash: 1c9c0d3c33454f9a5960e907d74d74d74de3cb7728addbdce70397e3eae6a583
...
This chapter does not teach traditional criminal law elements (actus reus, mens rea). It teaches a framework for analyzing *what* the criminal law punishes and why. The core analytical moves a student must make:

1. **Identify the offense category** — Is the conduct in the core of criminal law (violence, theft, fraud), a system-involvement offense (FTA, license suspension, technical violations, homelessness), or a contested domain (abortion, firearms, gambling, drugs)?
2. **Apply evidence-based analysis** — What does the best available evidence say about whether criminalization achieves its stated goal (deterrence, public safety, compliance)?
3. **Assess the evidence-practice gap** — Does current practice align with the evidence? If not, identify which explanatory factors apply (revenue incentives, political symbolism, institutional inertia, asymmetric burdens, lack of political power).
4. **Recognize motivated cognition** — When a factual dispute tracks a moral divide, ask whether the dispute is genuinely empirical or whether prior moral commitments are shaping factual beliefs.

### Liability Extensions

1. **Motivated cognition as an analytical tool** — Once you identify a contested domain, apply the motivated cognition framework: do the two sides cite different evidence, or do they interpret the same evidence differently? Does greater expertise/numeracy *increase* rather than decrease polarization?
2. **Human-Centered Design (HCD) logic** — For any contested intervention, ask whether the jurisdiction has applied HCD methodology: consulted affected communities, tested interventions, iterated based on results, and focused on measurable outcomes rather than moral symbolism.

### Liability Limits

1. **Irreducible moral disagreement** — Some disputes (e.g., the moral status of fetal life in abortion debates) may not be resolvable through evidence. Students should recognize when an evidence-based approach hits a genuine value limit.
2. **Implementation failure** — Decriminalization or diversion without adequate service infrastructure can fail even when the underlying evidence is strong (Oregon Measure 110). Evidence-based policy requires attending to implementation evidence, not just efficacy evidence.

---

## Refinements

### Offense Category Identification
...
- **Jurisdiction:** universal
- **Practiced:** Slides 5, 6, 7, 8, 9, 10, 12, 25
...
- **Jurisdiction:** universal
- **Practiced:** Slides 9, 10, 11, 13, 24, 25, 34, 43
...
- **Jurisdiction:** universal
- **Practiced:** Slides 7, 15, 16

### System-Involvement Offenses: FTA
...
### System-Involvement Offenses: License Suspension
...
### System-Involvement Offenses: Technical Violations
...
### System-Involvement Offenses: Homelessness
...
- **Jurisdiction:** universal
- **Practiced:** Slides 26, 27, 30, 31, 32, 33, 40, 42
...
- **Practiced:** Slides 31, 32, 34, 35, 36, 37
...
### cluster-ferguson-system-involvement
- **Refinements:** system-involvement-scale, ferguson-revenue-machine, ferguson-racial-disparities, keilee-fant-story, debt-suspension-racial-disparity
- **Why they cluster:** Ferguson illustrates the mechanics and human consequences of all system-involvement offense patterns — scale, revenue incentives, racial disparities, and individual harm — in a single case study.
- **Scenario hook:** A city with a budget shortfall issues thousands of tickets to a low-income, predominantly minority neighborhood for minor infractions, uses failure-to-appear warrants to generate additional revenue, and jails residents unable to pay — apply the Ferguson framework to evaluate the system's legitimacy and consequences.

### cluster-evidence-policy-gap
- **Refinements:** bayesian-policy-standard, evidence-grade-hierarchy, fta-reminders-evidence, cash-bail-fta-failure, debt-suspension-ineffective, technical-violations-incarceration, hope-program-failure, supervision-violations-scale
- **Why they cluster:** These refinements together teach the evidence-based analysis framework: how to evaluate evidence quality, apply the Bayesian standard, identify evidence-practice gaps, and distinguish a promising initial study from a failed replication.
- **Scenario hook:** A state legislature is debating whether to maintain cash bail, criminalize FTA, suspend licenses for unpaid fines, incarcerate technical violators, and expand a HOPE-style swift-certain consequences program — evaluate each policy against the available evidence using the Bayesian standard, distinguishing evidence quality levels.

### cluster-motivated-cognition-contested-domains
- **Refinements:** motivated-cognition-mechanism, numeracy-paradox, science-curiosity-remedy, cultural-cognition-guns, contested-domains-hollowed-common-ground
- **Why they cluster:** These refinements together teach the motivated cognition framework — mechanism, paradox, partial remedy — applied to a concrete contested domain (guns), with a policy consequence (hollowed-out common ground).
- **Scenario hook:** A legal scholar reviews the RAND evidence on gun policy and concludes that both sides misread the evidence to support their priors — apply the motivated cognition framework to explain why, predict which populations are most susceptible, and identify whether the scholar's own framing escapes the trap.

### cluster-drug-policy-evidence
- **Refinements:** criminalization-drug-use-weak, mat-evidence-gap, lead-deflection, oregon-implementation-failure, fta-reminders-evidence
- **Why they cluster:** Drug policy is the chapter's central case study for applying evidence-based analysis: what works (MAT, LEAD), what doesn't work (criminalization as deterrent), implementation requirements (Oregon), and the structural barriers that maintain evidence-practice gaps.
- **Scenario hook:** A jurisdiction is considering whether to decriminalize personal drug possession and redirect enforcement resources to MAT and deflection programs like LEAD — evaluate the evidence for and against, identify implementation requirements, and assess whether the Oregon experience counsels caution or simply underscores the importance of treatment infrastructure.

### cluster-homelessness-criminalization
- **Refinements:** criminalization-homelessness-ineffective, housing-first-evidence, grants-pass-context
- **Why they cluster:** These three refinements present the complete picture on homelessness criminalization: what doesn't work (criminalization), what does work (Housing First), and the current constitutional framework (Grants Pass permits criminalization even absent shelter alternatives).
- **Scenario hook:** After *Grants Pass*, a city imposes a camping ban, cites hundreds of homeless residents, and records a 500% increase in citations — but homelessness continues to rise; apply the evidence framework to evaluate the city's approach and identify what the evidence supports instead.

### cluster-core-offense-limits
- **Refinements:** core-offense-consensus, three-offense-families, bayesian-policy-standard
- **Why they cluster:** These refinements teach the foundational structure: what the core of criminal law looks like and why consensus at the label level obscures disagreement at the boundary — with the Bayesian standard providing a tool for adjudicating those boundary disputes.
- **Scenario hook:** A prosecutor must decide whether to charge a corporation that knowingly marketed an opioid with homicide, or whether to treat it as a civil matter — the offense appears to be "homicide-shaped" but falls outside traditional enforcement patterns; apply the three-family taxonomy and Bayesian analysis to evaluate the charging decision.

---

## Cases

### Fishbane, Ouss & Shah (*Science* 2020)
- **Holding:** Text reminders reduced failure-to-appear rates by 36% in New York City, preventing approximately 30,000 arrest warrants over three years at less than $1 per person.
- **Reasoning:** Most FTA results from logistical failure (forgetting, work conflict, no transportation), not defiance; text reminders address the logistical cause at minimal cost.
- **Facts:** Randomized controlled trial in NYC court system; participants randomized to receive or not receive court date reminder texts.
- **Teaches:** fta-reminders-evidence, cash-bail-fta-failure
- **Source type:** note case (discussed in policy review)
- **Discussion questions:** no

### Crozier & Garrett (*Duke Law Journal* 2020)
- **Holding:** Debt-based license suspension in North Carolina — covering 1.225 million active suspensions — showed no correlation with fine collection rates.
- **Reasoning:** Populations subject to debt-based suspension are those least able to pay fines; suspension cannot compel payment from people who lack the funds; instead it creates the separate crime of driving while suspended.
- **Facts:** Analysis of North Carolina DMV records covering all active suspensions for unpaid fines; North Carolina Black drivers 54% of DWS charges, 21% of population.
- **Teaches:** debt-suspension-ineffective, debt-suspension-racial-disparity
- **Source type:** note case
- **Discussion questions:** no

### Petrich et al. (*Crime & Justice* 2021)
- **Holding:** Custodial sanctions for probation/parole violations produce null effects or slight increases in reoffending compared to community-based alternatives (meta-analysis of 116 studies).
- **Reasoning:** Incarceration disrupts employment, housing, and family relationships without addressing the underlying causes (addiction, poverty, mental illness) that drive technical violations.
- **Facts:** Systematic review and meta-analysis of 116 studies comparing custodial to non-custodial responses to supervision violations.
- **Teaches:** technical-violations-incarceration, supervision-violations-scale
- **Source type:** note case
- **Discussion questions:** no

### Lattimore et al., HOPE Demonstration Field Experiment (NIJ 2016)
- **Holding:** The HOPE program (swift, certain, fair consequences for probation violations) showed no effect on recidivism and actually produced more probation violations than control groups in NIJ's four-site randomized trial.
- **Reasoning:** The original single-site Hawaii results reflected local implementation factors that did not generalize; the underlying theory — that swift certain punishment deters violation — was not supported when tested rigorously.
- **Facts:** NIJ-funded four-site RCT replication of Hawaii HOPE program; CrimeSolutions rating: "No Effects."
- **Teaches:** hope-program-failure, technical-violations-incarceration
- **Source type:** note case
- **Discussion questions:** no

### Lebovits & Sullivan (*Policy Studies Journal* 2025)
- **Holding:** Criminalization ordinances targeting homelessness (camping bans, loitering laws, encampment sweeps) produce no statistically significant reduction in homelessness.
- **Reasoning:** Deterrence logic fails when homelessness is not a choice — people cannot "decide not to be homeless" to avoid citation.
- **Facts:** Nationwide empirical study of homelessness criminalization ordinances across U.S. jurisdictions; measured homelessness rates before and after passage.
- **Teaches:** criminalization-homelessness-ineffective
- **Source type:** note case
- **Discussion questions:** no

### At Home/Chez Soi 6-Year Follow-Up (*Lancet Psychiatry* 2019)
- **Holding:** Housing First participants with high support needs spent 85.5% of their time in stable housing vs. 60.3% for treatment as usual at 6-year follow-up; Housing First does not improve psychiatric symptoms or reduce substance use.
- **Reasoning:** Stable housing is achievable through Housing First without requiring psychiatric or substance use treatment as a precondition, but Housing First does not itself treat these conditions.
- **Facts:** Canadian RCT; participants randomized to Housing First or treatment as usual; 6-year follow-up tracking housing stability, mental health, and substance use outcomes.
- **Teaches:** housing-first-evidence
- **Source type:** note case
- **Discussion questions:** no

### *City of Grants Pass v. Johnson*, 603 U.S. ___ (2024)
- **Holding:** Cities may criminally punish homeless individuals for sleeping outdoors even when no shelter alternatives are available; no Eighth Amendment bar applies.
- **Reasoning:** The Eighth Amendment's prohibition on cruel and unusual punishment does not categorically bar criminalizing involuntary status-related conduct like outdoor sleeping when the city has not criminalized the status of homelessness itself.
- **Facts:** City of Grants Pass, Oregon ordinances imposing fines and criminal penalties for camping or sleeping in public spaces; class action challenge by homeless residents.
- **Teaches:** grants-pass-context, criminalization-homelessness-ineffective
- **Source type:** main case
- **Discussion questions:** no

### U.S. DOJ, *Investigation of the Ferguson Police Department* (2015)
- **Holding:** Ferguson's municipal court operated as a revenue-extraction machine, generating racially disparate enforcement against Black residents to fund city operations.
- **Reasoning:** Revenue incentives (explicit Finance Director pressure for increased court revenue) created structural pressure to enforce minor offenses aggressively, generating a debt cascade for those least able to pay.
- **Facts:** 32,975 arrest warrants issued in 2013 for population of 21,000; Black residents 67% of population, 93% of arrests; explicit internal communications about revenue targets.
- **Teaches:** ferguson-revenue-machine, ferguson-racial-disparities, keilee-fant-story
- **Source type:** main case
- **Discussion questions:** yes

### Kahan et al., *Motivated Numeracy* (*Behavioral Public Policy* 2017)
- **Holding:** Higher numeracy (ability to reason with numbers) predicts greater political polarization on contested empirical questions, not less; more numerate partisans are better at selectively interpreting data to support prior beliefs.
- **Reasoning:** Numeracy provides tools for selective evidence evaluation; when moral commitments are engaged, these tools are deployed in service of prior beliefs rather than truth-seeking.
- **Facts:** Experimental study; participants given identical policy outcome data framed as either gun control or unrelated issue; measured effect of numeracy on accuracy of interpretation across partisan groups.
- **Teaches:** numeracy-paradox, motivated-cognition-mechanism
- **Source type:** note case
- **Discussion questions:** no

### Hughes & Stevens (*British Journal of Criminology* 2010) — Portugal Decriminalization
- **Holding:** Portugal's 2001 decriminalization of personal possession of all drugs did not increase drug use and was associated with substantial reductions in overdose deaths, HIV infections, and incarceration.
- **Reasoning:** Most drug use is driven by factors other than fear of criminal penalties; decriminalization redirects resources from enforcement to treatment, addressing use more effectively.
- **Facts:** Before/after comparison of Portuguese drug use, overdose, and HIV rates following 2001 decriminalization; comparison with surrounding countries that retained criminalization.
- **Teaches:** criminalization-drug-use-weak
- **Source type:** note case
- **Discussion questions:** no

### Collins et al. (*Journal of Substance Abuse Treatment* 2017) — LEAD Evaluation
- **Holding:** LEAD participants were 58% less likely to be arrested after enrollment compared to similar individuals processed through traditional prosecution.
- **Reasoning:** Addressing the underlying causes of low-level drug offending (housing instability, untreated addiction, poverty) through case management reduces reoffending more effectively than arrest and prosecution.
- **Facts:** Controlled evaluation of Seattle LEAD program; compared arrest outcomes for LEAD participants vs. matched comparison group processed through traditional system.
- **Teaches:** lead-deflection
- **Source type:** note case
- **Discussion questions:** no
...
|-----|---------|------------|-----------|
| core-offense-consensus | element | foundational | Slides 1, 2, 3, 4 |
| system-involvement-scale | element | foundational | Slides 5, 6, 7, 8, 9, 10, 12, 25 |
| three-offense-families | element | foundational | Slides 1, 3, 8 |
| bayesian-policy-standard | element | intermediate | Slides 9, 10, 11, 13, 24, 25, 34, 43 |
| evidence-grade-hierarchy | element | intermediate | Slides 7, 15, 16 |
| fta-reminders-evidence | element | foundational | Slides 11, 12, 24 |
| cash-bail-fta-failure | element | intermediate | Slide 11 |
| debt-suspension-ineffective | element | intermediate | Slides 13, 24 |
| debt-suspension-racial-disparity | element | intermediate | Slide 14 |
| technical-violations-incarceration | element | intermediate | Slides 15, 24 |
| hope-program-failure | element | advanced | Slides 15, 16 |
| supervision-violations-scale | element | foundational | Slide 15 |
| criminalization-homelessness-ineffective | element | foundational | Slides 17, 18, 24 |
| housing-first-evidence | element | intermediate | Slide 17 |
| grants-pass-context | element | intermediate | Slides 17, 18 |
| ferguson-revenue-machine | element | foundational | Slides 19, 20, 23 |
| ferguson-racial-disparities | element | intermediate | Slides 22, 23 |
| keilee-fant-story | element | foundational | Slide 21 |
| motivated-cognition-mechanism | extension | foundational | Slides 26, 27, 30, 31, 32, 33, 40, 42 |
| numeracy-paradox | extension | advanced | Slides 28, 33, 44 |
| science-curiosity-remedy | extension | advanced | Slide 29 |
| cultural-cognition-guns | extension | intermediate | Slides 32, 36, 37 |
| contested-domains-hollowed-common-ground | extension | intermediate | Slides 31, 32, 34, 35, 36, 37 |
| criminalization-drug-use-weak | element | intermediate | Slides 38, 39 |
| mat-evidence-gap | element | intermediate | Slides 39, 41 |
| lead-deflection | element | intermediate | Slide 41 |
| oregon-implementation-failure | limit | advanced | Slide 40 |
