# Chapter Map: Omissions

## Meta
- Chapter: 9
- Title: Omissions
- Source file: criminal-law/chapters/09-omissions.qmd
- Source hash: 9a1eb4dc883a2d9e87ee2e45cb2e819d1c7b444004b1df4de2a019fa231d886b
...
1. **Legal duty to act** — The defendant must have had a legal obligation to act, not merely a moral one. A duty can arise from statute, status relationship, contract, voluntary assumption of care (plus seclusion), or creation of peril. Without a legal duty, no crime can be committed by inaction.
2. **Omission (failure to perform the required act)** — The defendant must have failed to perform the act the duty required, and must have been physically capable of performing it at the time.
3. **Causation** — The omission must have caused the forbidden result. The omission must be at least a proximate cause of the harm.
4. **Mens rea** — The required mental state depends on the charge (e.g., recklessness for manslaughter, willfulness for federal § 242 liability). The duty establishes the actus reus; the mental state for the underlying offense still applies.

### Liability Extensions

1. **Creation of peril (fifth Jones duty)** — A person who creates a dangerous situation through prior conduct — even non-criminal conduct — acquires a duty to mitigate the resulting harm. This extends omission liability to defendants who "started" the danger.
2. **Custodial duty (institutional)** — When the state takes a person into custody, it assumes constitutional obligations to provide for basic needs. This extends to corrections officers, jail medical staff, and private custodial health corporations.
3. **Responsible Corporate Officer (Park) Doctrine** — A corporate officer with authority and responsibility to prevent or remedy a statutory violation has a legal duty to act, enforceable as a strict liability offense even without personal knowledge of the violation.

### Liability Limits

1. **No general duty to rescue** — Anglo-American law does not impose a general obligation to help strangers. Absent one of the recognized duty categories, even a bystander who could easily prevent serious harm commits no crime.
2. **Seclusion requirement for voluntary assumption** — Assuming care for another does not alone create a duty. The defendant must also have secluded the victim from other sources of aid, making the defendant the victim's only realistic protector.
3. **Mother's presence defeats voluntary assumption (Pope)** — Where the person who holds primary legal custody or responsibility is present and capable, a third party who helps does not assume a duty simply by performing acts of care.
4. **Duty is a question of law (Jones)** — The existence of a legal duty is a legal question for the court, not a factual question for the jury. A conviction for omission-based homicide cannot stand without jury instruction on the duty element.
5. **Farmer subjective recklessness limit** — In custodial omission cases, the breach standard requires that the official *actually knew* of a substantial risk. Objective awareness (should have known) is insufficient. This protects officials who willfully avoided learning of risk.
...
- **Practiced:** Slide 7 — "When is doing nothing like doing something?" framed the core question; Slide 8 — MPC § 2.01 text presented and analyzed.
...
- **Practiced:** Slide 8 — MPC § 2.01 text, conditions for omission liability analyzed.
...
- **Practiced:** Slide 14 — Vermont statute, European comparison, and the "untested implication" homicide argument practiced.

### Legal Duty — The Jones Categories
...
- **Practiced:** Slide 9 — Five duty categories listed and associated with specific cases; Slide 13 — road map of cases-to-categories.
...
- **Jurisdiction:** universal
- **Practiced:** Slide 5 — Institutional choice discussion (who decides — judge or jury?) applies here.
...
- **Practiced:** Slides 10–12 — Beardsley facts, court reasoning, and contemporary question about marriage equality covered; slide 13 — Beardsley mapped to "status relationship" category.
...
- **Practiced:** Slide 11 — Court's "repugnant to our moral sense" reasoning analyzed; Slide 12 — contemporary relationship categories discussed.
...
- **Practiced:** Slide 12 — Wedding cake toppers illustrating different recognized relationships; question about whether omission duties should extend to recognized partnerships.
...
- **Jurisdiction:** universal
- **Practiced:** Slide 13 — Pestinikas mapped to "contractual" duty category.
...
- **Jurisdiction:** universal
- **Practiced:** Slide 13 — Pope mapped to "voluntary assumption of care" category.
...
- **Practiced:** (Slide 13 — Pope mapped to category; no independent slide practice identified for the paradox itself)
...
- **Practiced:** Slide 13 — Voss mapped to "creation of peril" category.
...
- **Practiced:** Slide 15 — All three cases summarized; Slide 5 — Institutional choice regarding who decides (judge/jury) also relates to the constitutional framework.
...
- **Practiced:** Slide 15 — *Farmer* "deliberate indifference" and "actual awareness" standard practiced; Slide 19 — *Farmer* standard applied to Kueng/Thao/Lane omissions.
...
- **Practiced:** Slide 15 — *DeShaney* principle taught alongside *Estelle* and *Farmer*.
...
- **Practiced:** Slide 16 — Custodial neglect categories (failure to provide medical aid, dangerous restraints, corporate neglect) practiced.
...
- **Practiced:** Slides 17–19 — Chauvin conviction summarized; Thao/Kueng/Lane defenses and jury findings detailed; *Farmer* standard applied to their awareness.
...
- **Practiced:** Slide 20 — *New York Central* principle taught.
...
- **Practiced:** Slide 20 — *Dotterweich* and *Park* taught; Slide 21 — *DeCoster* as example of Park Doctrine application; Slide 22 — Purdue as Park Doctrine paradox.
...
- **Practiced:** Slide 22 — Purdue Park Doctrine paradox practiced.
...
- **Practiced:** Slide 21 — *Gree Electric*, *PCA*, and *DeCoster* compared across knowledge levels.
...
- **Practiced:** Slide 22 — Misbranding cases (Purdue, GSK, Boeing) as examples of misbranding by silence.
...
- **Practiced:** Slide 23 — Andersen Effect and DPA rise practiced.
...
### cluster-core-duty-analysis
- **Refinements:** no-duty-baseline, jones-five-categories, duty-question-of-law, mpc-omission-baseline
- **Why they cluster:** Any omission-based exam question requires first establishing that a legal duty exists, which Jones category it falls under, and that the duty was a question of law for the court.
- **Scenario hook:** A neighbor watches an elderly man collapse in his driveway but does not call 911, having spoken with him several times over the past year — determine whether any legal duty existed and what the trial court must instruct the jury.

### cluster-beardsley-and-status
- **Refinements:** status-relationship-category, beardsley-moral-vs-legal, status-relationship-evolution, voluntary-assumption-plus-seclusion
- **Why they cluster:** *Beardsley* sits at the intersection of status-relationship limits, the moral-vs-legal distinction, and the possibility that an alternative duty (voluntary assumption + seclusion) existed all along.
- **Scenario hook:** A man caring for his long-term cohabiting partner over the weekend fails to call 911 after she overdoses — analyze the status-relationship and voluntary-assumption theories, and whether the couple's legal recognition in their jurisdiction matters.

### cluster-voluntary-assumption-and-seclusion
- **Refinements:** voluntary-assumption-plus-seclusion, pope-good-samaritan-paradox, misprision-desuetude, good-samaritan-statutes
- **Why they cluster:** *Pope* and the Good Samaritan paradox both involve people who helped and then faced (or could face) criminal liability — the seclusion requirement and Good Samaritan statutes both try to resolve that paradox.
- **Scenario hook:** A tenant takes in a homeless woman and her infant for three days, feeds them, and witnesses the mother injure the baby — determine whether the tenant assumed a duty, whether the mother's presence matters, and whether the state's Good Samaritan statute affects the analysis.

### cluster-creation-of-peril-and-perverse-incentives
- **Refinements:** creation-of-peril-category, voss-full-course-of-conduct, oliver-blend-categories, creation-of-peril-perverse-incentive
- **Why they cluster:** *Voss* and *Oliver* both involve drug-related peril creation, and the perverse-incentive problem (the duty to call 911 conflicts with the risk of drug charges) runs through both cases.
- **Scenario hook:** A host at a party supplies MDMA to a guest, recognizes overdose symptoms, leaves the party to "get help," and three hours later texts a friend to "maybe check on" the guest — analyze the full course of conduct, the duty to mitigate, and whether a 911 immunity statute would change the outcome.

### cluster-custodial-duty-and-enforcement
- **Refinements:** custodial-duty-constitutional-basis, deshaney-custody-threshold, farmer-subjective-standard, custodial-neglect-omission-cases, duty-to-intervene-kueng-thao-lane, custodial-enforcement-gap
- **Why they cluster:** These refinements build from the constitutional foundation of the custodial duty through its breach standard to the structural barriers that prevent enforcement.
- **Scenario hook:** A jail nurse receives an intake report flagging a detainee's opioid dependence, sets a low-priority status without examining the detainee, and the detainee dies of withdrawal overnight — analyze the constitutional duty, Farmer's subjective standard, causation, and whether the nurse or the intake-screening system design bears the criminal responsibility.

### cluster-corporate-omission-liability
- **Refinements:** respondeat-superior-corporations, park-doctrine-rco, statutory-reporting-duties-corporate, misbranding-by-silence, park-doctrine-paradox
- **Why they cluster:** These refinements trace the doctrinal arc from basic corporate liability through the Park Doctrine's strict-liability mechanism to its paradoxical use in Purdue.
- **Scenario hook:** A pharmaceutical company's CEO and compliance officer learn of post-market safety signals suggesting a drug causes cardiac events but delay filing required FDA safety reports for eight months to avoid a market impact — analyze respondeat superior, Park Doctrine applicability, whether a Park misdemeanor or knowing-misbranding felony is appropriate, and what the Purdue paradox suggests about prosecutorial strategy.

### cluster-enforcement-gap-and-reform
- **Refinements:** andersen-effect-dpa, corporate-enforcement-asymmetry, custodial-enforcement-gap, public-benefit-restructuring
- **Why they cluster:** Both enforcement gaps (custodial and corporate) reflect structural failures to translate clear doctrine into actual prosecution, and both suggest the need for institutional reform beyond doctrine alone.
- **Scenario hook:** A private prison healthcare company is notified by three nurses that a diabetic detainee has been denied insulin for four days; the company takes no action and the detainee dies — analyze the custodial duty, the Farmer standard as applied to a corporate actor, whether a corporate conviction is viable, and what penalty (fine, DPA, PBC restructuring) would actually deter future conduct.

### cluster-failure-to-protect-and-crumbley
- **Refinements:** failure-to-protect, crumbley-third-party-victims, status-relationship-category, beardsley-moral-vs-legal
- **Why they cluster:** These refinements explore the outer boundaries of status-relationship duties — both when the duty bearer is themselves a victim (failure-to-protect) and when the duty extends to third parties (Crumbley).
- **Scenario hook:** A mother who has been physically abused by her boyfriend fails to remove her ten-year-old son from the home, and the son subsequently brings a gun to school and injures two classmates — analyze the failure-to-protect claim (including duress) and the Crumbley third-party extension theory.
...
### People v. Beardsley
- **Holding:** A man who spent the weekend with a woman in an extramarital relationship had no legal duty to summon medical aid when she overdosed, because no recognized status relationship (marriage, contract, statutory duty) existed between them.
- **Reasoning:** The court drew a bright line between moral obligation and legal duty, refusing to extend marital-like duties to intimate companions outside recognized legal relationships.
- **Facts:** Beardsley and Blanche Burns spent a weekend drinking together; Burns took morphine, lapsed into a stupor, and Beardsley had her moved to a basement room where she died.
- **Teaches:** status-relationship-category, beardsley-moral-vs-legal, voluntary-assumption-plus-seclusion (as counterexample)
- **Source type:** main case
- **Discussion questions:** yes

### Jones v. United States
- **Holding:** A conviction for omission-based homicide requires jury instruction on the duty element; the trial court's failure to instruct constituted plain error requiring reversal.
- **Reasoning:** The existence of a legal duty is a question of law for the court, and without instruction the jury has no basis for finding the element; the court also catalogued the four recognized duty categories.
- **Facts:** Jones, a family friend caring for an infant, was convicted of involuntary manslaughter after the infant died of malnutrition; conviction reversed for failure to instruct on duty.
- **Teaches:** jones-five-categories, duty-question-of-law
- **Source type:** note case
- **Discussion questions:** no

### Commonwealth v. Pestinikas
- **Holding:** A contractual duty to provide care can serve as the actus reus of homicide; defendants who orally agreed to care for an elderly man and then abandoned him to starve were properly convicted of third-degree murder.
- **Reasoning:** Criminal liability can rest on an omission where a legal duty exists; the oral contract created that duty, and the defendants were physically capable of fulfilling it.
- **Facts:** The Pestinikas defendants orally contracted to house and care for 92-year-old Kly, moved him to an unheated outbuilding, and he died of starvation weighing 53 pounds.
- **Teaches:** contractual-duty-category, contractual-duty-mens-rea
- **Source type:** main case
- **Discussion questions:** no

### Pope v. State
- **Holding:** A woman who took in a mother and infant, fed and cared for the baby overnight, but watched without intervening as the mother severely beat the infant, had not assumed "responsibility for the supervision" of the child and could not be convicted of child abuse.
- **Reasoning:** Acts of hospitality and kindness do not transform a Good Samaritan into a legal supervisor; the mother's continued presence meant Pope had neither assumed exclusive responsibility nor secluded the child from other sources of care.
- **Facts:** Pope took in Melissa Norris and her infant Demiko; over a Sunday morning, Norris beat the infant fatally in Pope's presence while Pope watched without intervening.
- **Teaches:** voluntary-assumption-plus-seclusion, pope-good-samaritan-paradox, misprision-desuetude
- **Source type:** main case
- **Discussion questions:** yes

### State v. Voss
- **Holding:** A defendant who sold heroin, suggested dosage, prepared the syringe, recognized overdose signs, and then left without calling for help had a duty to mitigate harm arising from having created the peril, supporting a manslaughter conviction.
- **Reasoning:** The defendant's acts and omissions are assessed together as a full course of conduct; by creating and increasing the risk of harm and then recognizing but failing to address it, a legal duty arose.
- **Facts:** Voss sold heroin to Geiger, helped him prepare and inject it, recognized overdose signs, left to get ice, then left the hotel entirely; Geiger was found dead the next morning.
- **Teaches:** creation-of-peril-category, voss-full-course-of-conduct, creation-of-peril-perverse-incentive
- **Source type:** main case
- **Discussion questions:** yes

### People v. Oliver
- **Holding:** A woman who brought a man home, gave him a spoon to inject heroin, and then had him dragged behind a shed after he collapsed was properly convicted of involuntary manslaughter based on creation of peril and voluntary assumption of care.
- **Reasoning:** Oliver both created the dangerous condition (providing means of injection) and secluded the victim from other aid (moving him behind the shed).
- **Facts:** Oliver met Cornejo at a bar, brought him home, gave him a spoon to inject heroin, and after he collapsed had her daughter drag him behind a shed where he was found dead.
- **Teaches:** creation-of-peril-category, oliver-blend-categories
- **Source type:** note case
- **Discussion questions:** no

### Estelle v. Gamble
- **Holding:** Deliberate indifference to the serious medical needs of a prisoner violates the Eighth Amendment's prohibition on cruel and unusual punishment.
- **Reasoning:** When the state deprives a person of the ability to provide for their own medical needs by incarcerating them, it assumes responsibility for those needs.
- **Facts:** Estelle sued Texas prison officials for failing to adequately treat his back injury sustained while doing prison work.
- **Teaches:** custodial-duty-constitutional-basis
- **Source type:** note case
- **Discussion questions:** no

### DeShaney v. Winnebago County
- **Holding:** The Due Process Clause does not impose on the state an affirmative duty to protect individuals from private violence; the constitutional duty arises only when the state takes a person into custody.
- **Reasoning:** The Clause's purpose is to protect individuals from the state, not to require the state to protect individuals from each other; custody changes this analysis because it deprives people of self-help.
- **Facts:** Social services received repeated reports of Joshua DeShaney's abuse by his father but took no action; Joshua was permanently brain-damaged by his father.
- **Teaches:** deshaney-custody-threshold, custodial-duty-constitutional-basis
- **Source type:** note case
- **Discussion questions:** no

### Farmer v. Brennan
- **Holding:** "Deliberate indifference" to a known serious risk of harm to a prisoner requires that the official have *subjectively known* of the substantial risk — objective awareness is insufficient.
- **Reasoning:** The Eighth Amendment's subjective recklessness standard requires actual awareness, not mere negligence or constructive knowledge; officials who genuinely do not know of a risk do not violate it.
- **Facts:** Dee Farmer, a transgender prisoner, sued after being sexually assaulted; prison officials knew of but disregarded a serious risk of harm.
- **Teaches:** farmer-subjective-standard, duty-to-intervene-kueng-thao-lane, custodial-duty-constitutional-basis
- **Source type:** note case
- **Discussion questions:** no

### United States v. Kueng, Thao, and Lane
- **Holding:** Bystander officers who failed to intervene while Chauvin restrained Floyd were convicted of willfully depriving Floyd of his civil rights; the custodial duty supersedes departmental hierarchy, and verbal suggestions do not discharge the duty to act.
- **Reasoning:** The officers had actual awareness of a substantial risk (bystanders were shouting Chauvin was killing Floyd); their failure to intervene despite that awareness satisfied *Farmer*'s subjective recklessness standard.
- **Facts:** Officers Kueng, Lane, and Thao stood by as Chauvin knelt on George Floyd's neck for more than nine minutes; none intervened despite visible signs of distress and bystander warnings.
- **Teaches:** duty-to-intervene-kueng-thao-lane, farmer-subjective-standard, custodial-duty-constitutional-basis
- **Source type:** main case
- **Discussion questions:** yes

### People v. Crumbley
- **Holding:** Sufficient evidence supported sending involuntary manslaughter charges to the jury; parents who failed to secure their son's firearm or remove him from school despite knowing of his dangerous state could be held liable for a school shooting he carried out.
- **Reasoning:** The parental duty to supervise and control a minor child extends to protecting foreseeable third-party victims from the consequences of the parents' failure to exercise that control.
- **Facts:** The Crumbleys gave their son a gun, were called to school the morning of the shooting to discuss disturbing drawings, took no action, and he killed four students.
- **Teaches:** crumbley-third-party-victims, status-relationship-category
- **Source type:** note case
- **Discussion questions:** no

### United States v. Dotterweich
- **Holding:** Corporate officers could be personally liable under the FDCA for regulatory violations even without personal knowledge of the violation.
- **Reasoning:** The FDCA was designed to protect consumers from potentially dangerous products; placing responsibility on those in positions to prevent violations, regardless of personal knowledge, advances this purpose.
- **Facts:** Dotterweich, the president of a pharmaceutical company, was charged after the company shipped adulterated drugs; he had no personal knowledge of the specific violations.
- **Teaches:** park-doctrine-rco, respondeat-superior-corporations
- **Source type:** note case
- **Discussion questions:** no

### United States v. Park
- **Holding:** A corporate officer with "responsibility and authority either to prevent in the first instance, or promptly to correct" a regulatory violation has an affirmative duty to act, enforceable without proof of personal knowledge.
- **Reasoning:** The FDCA creates a strict liability offense for those in positions of corporate authority; their position defines both their duty and their accountability.
- **Facts:** Park, CEO of Acme Markets, was convicted of FDCA violations after FDA inspectors found unsanitary conditions in warehouses he had authority to correct.
- **Teaches:** park-doctrine-rco, misbranding-by-silence
- **Source type:** note case
- **Discussion questions:** no
...
|-----|---------|------------|-----------|
| no-duty-baseline | element (legal duty) | foundational | Slides 7–8 |
| mpc-omission-baseline | element (legal duty) | foundational | Slide 8 |
| good-samaritan-statutes | element (legal duty) | intermediate | Slide 14 |
| jones-five-categories | element (legal duty) | foundational | Slides 9, 13 |
| duty-question-of-law | element (legal duty) | intermediate | Slide 5 |
| statutory-duty-category | element (legal duty) | foundational | — |
| status-relationship-category | element (legal duty) | foundational | Slides 10–13 |
| beardsley-moral-vs-legal | element (legal duty) | intermediate | Slides 10–11 |
| status-relationship-evolution | element (legal duty) | advanced | Slide 12 |
| failure-to-protect | element (legal duty) | advanced | — |
| crumbley-third-party-victims | element (legal duty) | advanced | — |
| contractual-duty-category | element (legal duty) | foundational | Slide 13 |
| contractual-duty-mens-rea | element (legal duty) | intermediate | — |
| voluntary-assumption-plus-seclusion | element (legal duty) | foundational | Slide 13 |
| pope-good-samaritan-paradox | element (legal duty) | intermediate | Slide 13 |
| misprision-desuetude | limit | advanced | — |
| creation-of-peril-category | extension | intermediate | Slide 13 |
| voss-full-course-of-conduct | extension | intermediate | Slide 13 |
| oliver-blend-categories | extension | intermediate | — |
| creation-of-peril-perverse-incentive | extension | advanced | — |
| custodial-duty-constitutional-basis | extension | foundational | Slide 15 |
| farmer-subjective-standard | limit | advanced | Slides 15, 19 |
| deshaney-custody-threshold | limit | intermediate | Slide 15 |
| custodial-neglect-omission-cases | extension | intermediate | Slide 16 |
| duty-to-intervene-kueng-thao-lane | extension | intermediate | Slides 17–19 |
| custodial-enforcement-gap | limit | advanced | — |
| respondeat-superior-corporations | extension | foundational | Slide 20 |
| park-doctrine-rco | extension | intermediate | Slides 20–22 |
| park-doctrine-paradox | limit | advanced | Slide 22 |
| statutory-reporting-duties-corporate | extension | intermediate | Slide 21 |
| misbranding-by-silence | extension | intermediate | Slide 22 |
| andersen-effect-dpa | limit | advanced | Slide 23 |
| corporate-enforcement-asymmetry | limit | advanced | — |
| public-benefit-restructuring | limit | advanced | — |
