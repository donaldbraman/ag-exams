# Chapter Map: An Introduction to Criminal Law

## Meta
- Chapter: 1
- Title: An Introduction to Criminal Law
- Source file: criminal-law/index.qmd
- Source hash: 31eb1df5d9af68638ae0e0a93f3ef9bc0fa1be8569b0eac421c4b85869489fd0
...
This is an introductory chapter with no single doctrine being fully developed for examination. It introduces the foundational concepts and framing that will organize the rest of the course. The chapter does not set out a crime's elements for proof but establishes the analytical vocabulary and evaluative framework students will apply throughout. For exam purposes, the testable material here concerns:

1. The distinction between criminal law (rules about public harms) and the criminal legal system (people and practices that enforce those rules)
2. The four principles of procedural justice (voice, neutrality, respect, trustworthiness) as a diagnostic metric
3. The four mens rea levels (purpose, knowledge, recklessness, negligence) and their basic distinctions
4. The structural asymmetry of enforcement: over-enforcement of minor offenses, under-enforcement of serious corporate harms
5. The concept of actus reus as a prerequisite for criminal liability

### Liability Extensions

None applicable — this chapter does not develop a specific criminal doctrine. It introduces terminology (mens rea, actus reus) that will be extended in later chapters.

### Liability Limits

None applicable — this chapter introduces the idea that structural features of the system (Park Doctrine, strict liability misdemeanors) can limit prosecutorial reach, but does not develop these limits as doctrines.
...
- **Practiced:** Slide 9 (definition presented with reveal structure)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 10 (reveal: "Over 95% of convictions come from plea bargains"); Slide 23 (Key Takeaways)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 12 (four principles defined); Slide 13 (operationalized as diagnostic tool); Slide 22 Discussion Question 3 (applied to Garcia, Fant, and Purdue); Slide 21 (consolidated); Slide 23 (Key Takeaways)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 11 (examples: drugs, abortion, guns; reveal "proxy battles over whose values govern"); Slide 21 (civic identity framing); Slide 23 (Key Takeaways)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 15 (Fant case introduction); Slide 21 (civic identity reveal); Slide 22 Discussion Question 1 (how criminal justice "educates" citizens about their relationship to the state)
...
- **Practiced:** Slide 14 (Garcia photo); Slide 18 (Mental States table); Slide 22 Discussion Question 2 (Garcia as application anchor)
...
- **Jurisdiction:** split (traditional/MPC)
- **Practiced:** Slide 16 (Purdue photo); Slide 18 (Mental States table); Slide 22 Discussion Question 2 (Purdue case discussion)
...
- **Jurisdiction:** split (traditional/MPC)
- **Practiced:** Slide 18 (Mental States table — listed in descending order with simplified glosses)
...
- **Jurisdiction:** split (traditional/MPC)
- **Practiced:** Slide 18 (Mental States table in descending order); Slide 22 Discussion Question 2 (Garcia vs. Purdue differential treatment)

### Actus Reus and Structural Concepts
...
- **Jurisdiction:** universal
- **Practiced:** Slide 17 (Conduct Preview table — conduct offenses vs. result offenses)
...
- **Practiced:** Slide 16 (Purdue photo); Slide 22 Discussion Question 2 (explaining differential treatment of Fant vs. Purdue executives)

### Structural Asymmetry of Enforcement
...
- **Jurisdiction:** universal
- **Practiced:** Slide 15 (Fant photo); Slide 19 (Case Method Blind Spot — "cycle of invisibility"); Slide 22 Discussion Question 2 (Fant vs. Purdue differential treatment); Slide 23 (Key Takeaways — "architectural asymmetry")
...
- **Jurisdiction:** universal
- **Practiced:** Slide 16 (Purdue photo); Slide 19 (Case Method Blind Spot — "cycle of invisibility"); Slide 22 Discussion Question 2 (Purdue vs. Fant differential treatment); Slide 23 (Key Takeaways — "architectural asymmetry")
...
- **Jurisdiction:** universal
- **Practiced:** Slide 15 (Fant case introduction); Slide 22 Discussion Question 2 (Fant case discussion)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 19 (directly taught with "cycle of invisibility" reveal)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 7 (instructor affiliations foreshadow); Slide 20 (five-step cycle directly taught); Slide 23 (Key Takeaways — "lawyers can be architects of reform")

## Clusters

### foundational-vocabulary
- **Refinements:** criminal-law-vs-system, classical-model-exception, actus-reus-prerequisite, mens-rea-hierarchy
- **Why they cluster:** These four refinements establish the foundational vocabulary and structure that organizes all subsequent chapters; a student who cannot distinguish the criminal law from its enforcement system, or who cannot name the mens rea hierarchy, lacks the basic tools for any further analysis.
- **Scenario hook:** A student is asked to explain to a legislative staffer why the same harmful corporate conduct can result in either a felony charge or a strict liability misdemeanor — tracing the answer requires understanding the actus reus requirement, the mens rea hierarchy, and how prosecutorial design choices shape outcomes.

### mens-rea-four-levels
- **Refinements:** purpose-defined, knowledge-defined, recklessness-defined, negligence-defined
- **Why they cluster:** The four mens rea levels are introduced together via the three cases and must be distinguished from each other on an exam; a fact pattern typically requires identifying which level applies and why the defendant did or did not satisfy it.
- **Scenario hook:** Three corporate executives face investigation after their product kills 50 people: one executive wrote a memo targeting a specific population he expected to overdose, one knew the death toll would rise but focused only on revenue, and one never read the internal risk reports — identify each executive's culpability level.

### enforcement-asymmetry
- **Refinements:** over-enforcement-minor-offenses, under-enforcement-corporate-harm, pretextual-stops-logic-and-reality, park-doctrine-strict-liability
- **Why they cluster:** These refinements together trace the structural asymmetry of enforcement that the chapter identifies as its central analytical contribution; they explain why Keilee Fant spent 50 days in jail for parking tickets while Purdue executives received probation for 800,000 deaths.
- **Scenario hook:** A legislator asks whether the criminal justice system should be reformed to address both a neighborhood rife with pretextual stops for minor violations and a pharmaceutical company whose executives have avoided felony charges despite internal documents showing they knew their product would cause widespread death.

### legitimacy-and-democracy
- **Refinements:** procedural-justice-four-principles, status-competition-and-criminal-law, anticitizenship-and-trust, case-method-blind-spot
- **Why they cluster:** These refinements develop the chapter's argument about how criminal enforcement shapes democratic legitimacy; they connect the micro-level (how individual encounters produce trust or distrust) to the macro-level (how the structure of legal education shapes future enforcement patterns).
- **Scenario hook:** A defense attorney asks whether her client's experience — arrested 12 times for minor violations, never brought before a judge within 48 hours, and denied basic hygiene products in jail — has any bearing on broader democratic concerns beyond the individual case.

### reform-architecture
- **Refinements:** classical-model-exception, human-centered-design-reform, case-method-blind-spot, enforcement-asymmetry
- **Why they cluster:** These refinements support the chapter's closing argument that the problems of the criminal legal system are design choices, not inevitable features, and that reform requires both a moral framework (procedural justice) and a technical methodology (HCD).
- **Scenario hook:** A prosecutor designing a new diversion program for low-level drug offenses needs to explain why the existing system fails, what principles should guide the new program, and how to evaluate whether the reform is working.

## Cases

### State of Florida v. Sigfredo Garcia
- **Holding:** Garcia was convicted of first-degree murder and conspiracy to commit first-degree murder; sentenced to life without parole.
- **Reasoning:** Electronic evidence (SunPass, cell site data), cooperating witness testimony from Rivera, and phone records connecting Garcia to Magbanua and the Adelson family established that Garcia acted with purpose — his conscious object was Markel's death.
- **Facts:** Garcia and Rivera drove from Miami to Tallahassee, stalked Markel from his children's daycare to his home, and shot him twice in the head. Garcia was linked to the murder-for-hire plot through Magbanua (mother of his children, former girlfriend of Wendi Adelson's brother) and financial records showing payments laundered through the Adelson family business.
- **Teaches:** purpose-defined, mens-rea-hierarchy
- **Source type:** illustrative
- **Discussion questions:** no

### City of Ferguson v. Keilee Fant
- **Holding:** No criminal conviction is described. Fant became the lead plaintiff in a federal class-action lawsuit that secured a $4.5 million settlement for over 15,000 victims.
- **Reasoning:** Ferguson used its municipal court and jail as a profit center, issuing warrants automatically (without human review of financial status or intent) for missed fine payments, trapping low-income residents in a cycle of escalating debt and incarceration.
- **Facts:** Fant, a single mother of nine, spent nearly 50 days in Ferguson's jail without being brought before a judge, denied hygiene products, and transferred through six jurisdictions for parking violations and minor traffic citations. Ferguson issued 32,000 warrants for a population of 21,000.
- **Teaches:** over-enforcement-minor-offenses, pretextual-stops-logic-and-reality, procedural-justice-four-principles, anticitizenship-and-trust
- **Source type:** illustrative
- **Discussion questions:** no

### United States v. Purdue Pharma
- **Holding:** Purdue Frederick (a corporate affiliate, not the main operating entity) pleaded guilty to felony misbranding; the three top executives pleaded guilty to misdemeanor misbranding under the Park Doctrine and received 400 hours of community service and probation.
- **Reasoning:** The plea structure was designed to protect Purdue Pharma L.P. from automatic exclusion from federal health programs (which a felony conviction would have triggered), allowing the company to continue selling OxyContin. The misdemeanor charges under the Park Doctrine required no proof of mental state, allowing executives to resolve the case without admitting knowledge of or recklessness toward the harms they caused.
- **Facts:** Purdue executives conducted off-site meetings with the FDA medical officer evaluating OxyContin, co-wrote label text claiming reduced abuse liability, funded campaigns declaring pain a "Fifth Vital Sign," and targeted general practitioners for a drug with known addiction risk. By the time of the 2007 plea, the opioid crisis had claimed an estimated 200,000 lives. The $600 million fine was a fraction of the company's revenue.
- **Teaches:** park-doctrine-strict-liability, mens-rea-hierarchy, under-enforcement-corporate-harm, knowledge-defined, recklessness-defined
- **Source type:** illustrative
- **Discussion questions:** no
...
|-----|---------|------------|-----------|
| criminal-law-vs-system | element | foundational | Slide 9 |
| classical-model-exception | element | foundational | Slides 10, 23 |
| procedural-justice-four-principles | element | foundational | Slides 12, 13, 21, 22 (DQ3), 23 |
| status-competition-and-criminal-law | element | intermediate | Slides 11, 21, 23 |
| anticitizenship-and-trust | element | intermediate | Slides 15, 21, 22 (DQ1) |
| purpose-defined | element | foundational | Slides 14, 18, 22 (DQ2) |
| knowledge-defined | element | foundational | Slides 16, 18, 22 (DQ2) |
| recklessness-defined | element | foundational | Slides 16, 18, 22 (DQ2) |
| negligence-defined | element | foundational | Slide 18 |
| mens-rea-hierarchy | element | intermediate | Slides 18, 22 (DQ2) |
| actus-reus-prerequisite | element | foundational | Slide 17 |
| park-doctrine-strict-liability | limit | intermediate | Slides 16, 22 (DQ2) |
| over-enforcement-minor-offenses | element | intermediate | Slides 15, 19, 22 (DQ2), 23 |
| under-enforcement-corporate-harm | element | intermediate | Slides 16, 19, 22 (DQ2), 23 |
| pretextual-stops-logic-and-reality | element | intermediate | Slides 15, 22 (DQ2) |
| case-method-blind-spot | element | advanced | Slide 19 |
| human-centered-design-reform | element | advanced | Slides 7, 20, 23 |
