# Chapter Map: Conspiracy

## Meta
- Chapter: 19
- Title: Conspiracy
- Source file: criminal-law/chapters/19-conspiracy.qmd
- Source hash: 76580aa4
...
1. **Agreement** — Two or more persons must reach a mutual understanding to commit a crime. Courts rarely have direct evidence; they almost always infer agreement from coordinated conduct.
2. **Intent to agree** — The defendant must knowingly and voluntarily enter into the conspiratorial relationship.
3. **Purpose to commit the object crime** — The defendant must act with the *purpose* that the target offense be committed, not merely know that it might occur.
4. **Intent as to every element of the target offense** — The conspirator must specifically intend that every element of the planned offense be accomplished, even elements that carry no specific intent requirement for the principal.
5. **Overt act** — At least one conspirator must commit some act in furtherance of the conspiracy. This act can be entirely legal and seemingly trivial (a phone call, a plane ticket, a library book).

### Liability Extensions

1. **Pinkerton vicarious liability** — Each conspirator is liable for the foreseeable crimes of all coconspirators committed in furtherance of the conspiracy, without proof of the traditional elements of accomplice liability. This applies as long as the conspiracy continues and the defendant has not withdrawn.

### Liability Limits

1. **Withdrawal** — A conspirator may terminate ongoing liability by taking affirmative steps to disavow or defeat the conspiracy's objectives and communicating those steps to coconspirators or disclosing the scheme to law enforcement. Withdrawal is demanding and does not erase liability for crimes already committed.
2. **Wharton's Rule** — An agreement to commit a crime that by definition requires two participants cannot be prosecuted as a separate conspiracy. Applies to dueling, bigamy, adultery, incest, and bribery. Not absolute: if more persons participate than are logically necessary, conspiracy may lie. Legislatures can override it.
3. **Gebardi / legislative exemption** — When the legislature deliberately excludes one class of participants from liability under a criminal statute, that class cannot be prosecuted for conspiring to commit the offense.
4. **Buyer-seller exception** — A mere agreement to buy and sell drugs does not, standing alone, constitute a drug conspiracy. A conspiracy exists where the parties share a purpose to further distribution, evidenced by prolonged dealing, coded language, or fronting arrangements.
...
- **Practiced:** Slides 12, 15, 16, 17 — Coleridge Instruction; Slides 19, 20 — Dan Markel inference from phone records, financial flows, cell tower data
...
- **Practiced:** Slide 28 — movie theater image as hint for *Interstate Circuit*
...
- **Practiced:** Slide 30 — Alvarez truck ad, "a nod and a smile"
...
- **Practiced:** Slide 31 — One-Sided Agreements, undercover agent problem

### Intent to Agree and Purpose to Commit the Object Crime
...
- **Jurisdiction:** universal
- **Practiced:** Slides 8, 21 — Mens Rea: purpose requirement, even when underlying crime requires less
...
- **Practiced:** Slide 22 — *State v. Pond* summary
...
- **Jurisdiction:** universal
- **Practiced:** Slides 23, 24 — *Lauria*, Knowledge vs. Purpose; Slide 25 — Silk Road vs. Social Media application
...
- **Practiced:** Slides 24, 25 — three inferences; Silk Road vs. Social Media application
...
- **Practiced:** Slides 6, 7, 8 — overt act as element (Janet buys book as example)

### Pinkerton Vicarious Liability (Extension)
...
- **Practiced:** Slides 33, 34, 35, 36, 37 — Pinkerton doctrine, bank robbery hypothetical, accomplice vs. Pinkerton comparison
...
- **Practiced:** Slide 37 — table comparing Accomplice vs. Pinkerton liability
...
- **Practiced:** Slides 9, 10, 11 — Brad/Janet withdrawal hypothetical; two-prong requirements

### Scope: Single vs. Multiple Conspiracies (Structural)
...
- **Jurisdiction:** universal
- **Practiced:** Slide 29 — Kotteakos wheel diagram with no rim
...
- **Jurisdiction:** universal
- **Practiced:** Slide 27 — scope of conspiracy; slide 29 — Kotteakos

### Wharton's Rule (Limit)
...
### Conspiracy as System Architecture (Policy/Advanced)
...
- **Practiced:** Slides 38, 39, 40 — policy, "the machine," empirical evidence
...
- **Practiced:** Slide 35 — benefits to prosecution
...
- **Practiced:** Slide 39 — mandatory minimums as system feature

---

## Clusters

### cluster-agreement-proof
- **Refinements:** agreement-inference, interstate-circuit-adherence, alvarez-minimal-inference, bilateral-unilateral, overt-act-minimal
- **Why they cluster:** All address what the prosecution must show to establish a conspiracy has formed—what counts as agreement, how agreement is proved, and what act is required to complete the prima facie case.
- **Scenario hook:** A day laborer at an airport nods and smiles to an undercover DEA agent who mentions that the "team" needs someone at the unloading site, and then unloads his own truck—but no one else at the site is a real coconspirator.

### cluster-mens-rea
- **Refinements:** mens-rea-purpose, pond-specific-intent-elements, lauria-knowledge-vs-purpose, lauria-three-inferences
- **Why they cluster:** All address different facets of conspiracy's mens rea: the baseline purpose requirement, how it applies to each element of the target offense, and how purpose is inferred for suppliers.
- **Scenario hook:** A warehouse employee knows that shipments she processes include illegal firearms but she does not know the specific quantities; she receives a small bonus for each "clean" delivery.

### cluster-pinkerton-scope
- **Refinements:** pinkerton-doctrine, pinkerton-mpc-rejection, kotteakos-wheel, scope-procedural-stakes
- **Why they cluster:** Together these determine who is liable for what in a multi-defendant scenario and what evidentiary and procedural consequences follow from the structure of the conspiracy.
- **Scenario hook:** A and B plan a series of bank robberies; C steals a getaway car; D, who only learned about the plan from B, drives the car on one robbery—determine liability under both traditional and MPC approaches.

### cluster-structural-limits
- **Refinements:** whartons-rule, gebardi-legislative-exemption, buyer-seller-exception, withdrawal-requirements
- **Why they cluster:** All are categorical bars or reductions to conspiracy liability—structural escape routes a well-prepared exam answer should check after analyzing prima facie elements.
- **Scenario hook:** A woman voluntarily travels across state lines with a man who later charges her co-conspirator with violating the Mann Act, even though the statute was written only to protect transported women.

### cluster-system-architecture
- **Refinements:** system-architecture-interactions, prosecution-advantages, girlfriend-problem, bilateral-unilateral
- **Why they cluster:** All concern the structural and policy dimensions of conspiracy doctrine—how design choices interact and distribute punishment across defendants.
- **Scenario hook:** An undercover DEA agent proposes a $500,000 drug deal to a low-level associate who agrees by text; police seize $80,000 in cash at arrest; the associate faces a 10-year mandatory minimum while the organizer cooperates for 3 years.

---

## Cases

### Dan Markel Murder (Case Study)
- **Holding:** Not a litigated holding; used as extended case study to illustrate all conspiracy elements.
- **Reasoning:** The chapter uses the case to show how agreement is inferred from phone records, financial flows, and cell tower data when conspirators never gathered as a single group.
- **Facts:** Charlie Adelson allegedly hired Katherine Magbanua, who recruited Sigfredo Garcia and Luis Rivera to murder Dan Markel in a custody dispute; no direct evidence of agreement between all parties; prosecutors relied on circumstantial inference.
- **Teaches:** agreement-inference, scope-procedural-stakes, pinkerton-doctrine
- **Source type:** illustrative (used as extended example without formal case excerpt)
- **Discussion questions:** no (discussion questions appear under *Pond*, *Lauria*, *Pinkerton*, and *Kotteakos*)

### *Interstate Circuit v. United States*
- **Holding:** Film distributors who each knew the others were being asked to join a coordinated pricing scheme and who each adhered to it formed a conspiracy, even without direct communication among themselves.
- **Reasoning:** When parties know concerted action is contemplated and invited and each knows cooperation is essential, knowing adherence and participation constitutes agreement.
- **Facts:** O'Donnell sent a letter naming all eight distributor representatives as addressees, demanding pricing restrictions; distributors imposed the restrictions with substantial unanimity.
- **Teaches:** interstate-circuit-adherence, agreement-inference
- **Source type:** main case
- **Discussion questions:** no (no callout-tip block follows)

### *Kotteakos v. United States*
- **Holding:** Trying defendants charged with multiple separate conspiracies as if they were members of a single conspiracy was reversible error where the variance caused substantial prejudice.
- **Reasoning:** The gist of conspiracy is agreement; borrowers who each dealt separately with Brown but had no knowledge of each other and no common purpose were parties to separate conspiracies, not one.
- **Facts:** Brown assisted numerous borrowers in obtaining fraudulent FHA loans; borrowers did not know each other; indictment charged a single conspiracy; Government conceded at least eight separate conspiracies existed.
- **Teaches:** kotteakos-wheel, scope-procedural-stakes
- **Source type:** main case
- **Discussion questions:** yes (discussion question follows)

### *United States v. Alvarez*
- **Holding:** A nod, a smile, and a promise to be present at the unloading site, combined with surrounding circumstances, was sufficient for a jury to infer conspiratorial agreement to participate in an importation conspiracy.
- **Reasoning:** The totality of circumstances—not any single act—supported the inference of knowing agreement; promise to assist at unloading demonstrated agreement to further the venture.
- **Facts:** Alvarez drove a truck to an airport where others were arranging a marijuana importation flight; when asked by an undercover DEA agent if he would be at the unloading site, he nodded, smiled, and asked if the agent was going on the plane; nine-judge dissent protested the conviction.
- **Teaches:** alvarez-minimal-inference, agreement-inference
- **Source type:** note case
- **Discussion questions:** no

### *State v. Pond*
- **Holding:** To be convicted of conspiracy to commit robbery in the second degree, a defendant must specifically intend every element of the planned offense, including that a weapon would be displayed or threatened.
- **Reasoning:** Conspiracy is a specific intent crime; the intent to commit the object crime requires intent to bring about every element, including aggravating factors, even if those factors carry no specific intent requirement for the principal.
- **Facts:** Pond was the lookout in a store robbery; no weapon was discussed in planning; inside, J gestured as if armed; Pond was convicted of conspiracy to commit armed robbery but acquitted as an accessory.
- **Teaches:** pond-specific-intent-elements, mens-rea-purpose
- **Source type:** main case
- **Discussion questions:** yes

### *People v. Lauria*
- **Holding:** A telephone answering service operator who knew his customers were prostitutes was not guilty of conspiracy to commit prostitution where there was no direct evidence of intent, no special interest in the criminal enterprise, and the crime was a misdemeanor.
- **Reasoning:** Knowledge of a customer's criminal use is not equivalent to purpose to promote it; purpose may be inferred only from a stake in the venture, absence of legitimate use, or the gravity of the crime—none of which were present.
- **Facts:** Lauria ran a legitimate answering service; police monitoring revealed he knew several customers were prostitutes; he had no inflated prices, no financial interest in their earnings, and a mixed legitimate customer base.
- **Teaches:** lauria-knowledge-vs-purpose, lauria-three-inferences
- **Source type:** main case
- **Discussion questions:** yes (extended multi-part discussion including Purdue Pharma and social media platforms)

### *Pinkerton v. United States*
- **Holding:** Each member of a continuing conspiracy is liable for the substantive offenses committed by a coconspirator in furtherance of the conspiracy, even if the defendant did not directly participate.
- **Reasoning:** So long as the partnership in crime continues and the defendant has not affirmatively withdrawn, each partner acts for the other in carrying the conspiracy forward; the criminal intent is established by the formation of the conspiracy.
- **Facts:** Daniel and Walter Pinkerton were brothers engaged in a continuing conspiracy to violate the Internal Revenue Code; Daniel was in the penitentiary when Walter committed several substantive offenses; no evidence Daniel participated directly in those specific crimes.
- **Teaches:** pinkerton-doctrine, pinkerton-mpc-rejection, withdrawal-requirements
- **Source type:** main case
- **Discussion questions:** yes

### *State v. Pacheco*
- **Holding:** Under the bilateral approach, a conspiracy conviction cannot stand where the defendant's only alleged coconspirator was a government agent who never genuinely intended to commit the crime.
- **Reasoning:** Conspiracy exists to address the special danger of group criminal activity; when only one person genuinely agrees, there is no group and no group danger.
- **Facts:** Pacheco entered into an apparent agreement with a government agent; cited as the leading bilateral approach case.
- **Teaches:** bilateral-unilateral
- **Source type:** note case (cited in discussion of bilateral/unilateral split)
- **Discussion questions:** no

### *Garcia v. State*
- **Holding:** Under the unilateral approach, a conspiracy conviction stands where the defendant genuinely believed she was entering an agreement to commit a crime, even though her only "coconspirator" was an undercover police officer.
- **Reasoning:** The defendant's culpability does not depend on facts unknown to her; the unequivocal evidence of her firm purpose to commit the crime is the basis for liability.
- **Facts:** A woman asked a police informant to kill her husband, then paid an undercover detective $200 and provided a photograph and her husband's daily habits.
- **Teaches:** bilateral-unilateral
- **Source type:** note case
- **Discussion questions:** no

### *Iannelli v. United States*
- **Holding:** Wharton's Rule is a judicial presumption, not a constitutional command; legislatures can override it.
- **Reasoning:** The Rule reflects a presumption about legislative intent that can be rebutted by express statutory language or clear congressional intent.
- **Facts:** Federal gambling statute; question whether participants could also be charged with conspiracy.
- **Teaches:** whartons-rule
- **Source type:** note case (cited in structural limits discussion)
- **Discussion questions:** no

### *Gebardi v. United States*
- **Holding:** A woman voluntarily transported across state lines for "immoral purposes" in violation of the Mann Act could not be convicted of conspiracy to violate the Act.
- **Reasoning:** Congress implicitly excluded the transported woman from liability under the Act; that same participation cannot be made punishable through the conspiracy statute, which would circumvent the legislative policy choice.
- **Facts:** A man and woman voluntarily traveled together across state lines; government charged both with conspiring to violate the Mann Act.
- **Teaches:** gebardi-legislative-exemption
- **Source type:** note case
- **Discussion questions:** no

### *United States v. Pauling*
- **Holding:** A mere buyer-seller agreement does not establish a drug conspiracy; conspiracy requires a shared purpose to further distribution.
- **Reasoning:** The essential element of conspiracy—shared criminal purpose—is absent from a simple purchase transaction; extended arrangements like fronting reflect mutual investment in distribution.
- **Facts:** Federal drug prosecution; question of when a recurring buyer-seller relationship becomes a distribution conspiracy.
- **Teaches:** buyer-seller-exception
- **Source type:** note case
- **Discussion questions:** no

### *People v. Koenig*
- **Holding:** A defendant can conspire to commit a general intent crime; what conspiracy cannot reach is a crime of negligence, because a person cannot agree and specifically intend to accomplish an unintended result.
- **Reasoning:** The conspirator's specific intent to agree and commit the offense is satisfied when parties agree to engage in the prohibited conduct; negligence is incompatible with the required specific intent.
- **Facts:** Securities fraud conspiracy; question whether general intent offenses can be the object of conspiracy.
- **Teaches:** mens-rea-purpose, pond-specific-intent-elements
- **Source type:** note case
- **Discussion questions:** no
...
|-----|---------|------------|-----------|
| agreement-inference | element | foundational | slides 12, 15–17, 19–20 |
| interstate-circuit-adherence | element | intermediate | slide 28 |
| alvarez-minimal-inference | element | advanced | slide 30 |
| bilateral-unilateral | element | intermediate | slide 31 |
| mens-rea-purpose | element | foundational | slides 8, 21 |
| pond-specific-intent-elements | element | intermediate | slide 22 |
| lauria-knowledge-vs-purpose | element | foundational | slides 23–24 |
| lauria-three-inferences | element | intermediate | slides 24–25 |
| overt-act-minimal | element | foundational | slides 6–8 |
| pinkerton-doctrine | extension | intermediate | slides 33–37 |
| pinkerton-mpc-rejection | extension | intermediate | slide 37 |
| withdrawal-requirements | limit | foundational | slides 9–11 |
| kotteakos-wheel | element | intermediate | slide 29 |
| scope-procedural-stakes | element | advanced | slides 27, 29 |
| whartons-rule | limit | intermediate | — |
| gebardi-legislative-exemption | limit | advanced | — |
| buyer-seller-exception | limit | intermediate | — |
| system-architecture-interactions | policy | advanced | slides 38–40 |
| prosecution-advantages | policy | intermediate | slide 35 |
| girlfriend-problem | policy | advanced | slide 39 |
