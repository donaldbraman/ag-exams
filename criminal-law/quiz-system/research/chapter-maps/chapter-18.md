# Chapter Map: Accomplice Liability

## Meta
- Chapter: 18
- Title: Accomplice Liability
- Source file: criminal-law/chapters/18-accomplice.qmd
- Source hash: 299cb9d8cf359add9b627d3cf293591d
...
1. **Actus reus** — The defendant solicited, aided, or attempted to aid another person in planning or committing the offense. The threshold is low: mere presence combined with encouragement suffices; failed assistance counts. But-for causation is not required — facilitating a result that would have occurred anyway is enough.
2. **Mens rea (purpose)** — The defendant acted with the *purpose* of promoting or facilitating the commission of the offense. Knowledge alone is insufficient. The defendant must have wanted the crime to succeed — must have "associated himself with the venture and participated in it as something he wished to bring about" (the *Peoni* stake-in-the-venture test).
3. **Mens rea (underlying offense)** — The defendant possessed the mental state required by the underlying crime. If the offense requires specific intent, the accomplice must share that intent.
4. **Principal's crime** — The principal actually committed the underlying offense (or, under MPC § 2.06(7), may be convicted even if the principal is acquitted or has immunity, so long as the principal's criminal act occurred).

### Liability Extensions

1. **Natural and probable consequences (NPC) doctrine (traditional)** — Under the traditional rule (now reformed in several states), an accomplice was liable not only for the crime intended but for any other crime that was a "natural and probable consequence" of the agreed-upon criminal activity. Liability extended beyond intent to foreseeability.
2. **Derivative liability through personal defense** — Where the principal commits the actus reus of the crime but holds a personal defense (justification by public authority, excuse of insanity or duress), the accomplice's liability remains intact because the underlying criminal act still occurred.

### Liability Limits

1. **Derivative liability floor** — Accomplice liability is derivative: if the principal commits no crime (lacks the necessary mens rea or commits no prohibited act), there is nothing to derive liability from. The accomplice cannot be convicted of the substantive offense.
2. **Purpose requirement (no purpose = no liability)** — Providing information or assistance with mere knowledge that it will facilitate a crime, without purpose to promote the crime, is insufficient.
3. **Inevitably incident exception** — A person whose participation is inevitably incident to the definition of the offense (i.e., a "necessary victim" or party the legislature intended to exclude) is not an accomplice. When a legislature punishes only one party to a transaction, the other necessary participant is excluded.
4. **Withdrawal** — Not explicitly analyzed in this chapter but referenced structurally through *Rosemond*'s "meaningful opportunity to walk away" requirement.
5. **Accessory after the fact** — Helping someone escape capture after the crime is complete is a separate, lower-grade offense in most jurisdictions, not accomplice liability to the underlying crime.
6. **NPC doctrine reform** — California SB 1437 (and similar reforms) eliminated second-degree murder liability under the NPC doctrine. Murder now requires personal malice or major participation plus reckless indifference to human life; imputed malice from group participation alone is insufficient.
...
- **Practiced:** Slide 6 — actus reus spectrum (facilitation vs. but-for); Slide 8 — *Tally* case study; Slide 23 — key takeaways
...
- **Jurisdiction:** universal
- **Practiced:** Slide 7 — *Wilcox* case study with "presence + encouragement" analysis; Slide 23 — key takeaways
...
- **Practiced:** Slide 9 — purpose vs. knowledge; Slide 11 — *Gladstone* case study; Slide 23 — key takeaways
...
- **Jurisdiction:** universal
- **Practiced:** Slide 10 — *Wilson* case study; felonious intent element
...
- **Practiced:** Slide 12 — *Rosemond* federal standard; Slide 23 — key takeaways
...
- **Practiced:** Slide 13 — NPC doctrine and reform; *Luparello* before reform
...
- **Practiced:** Slide 13 — NPC reform, SB 1437, recidivism data; Slide 23 — key takeaways
...
- **Jurisdiction:** universal
- **Practiced:** Slide 15 — *Hayes* case study; Slide 17 — symmetry diagram; Slide 18 — modern doctrine table
...
- **Jurisdiction:** universal
- **Practiced:** Slide 16 — *Vaden* case study; Slide 17 — symmetry; Slide 18 — modern doctrine table
...
- **Practiced:** Slide 18 — justification/excuse table with Hayes, Vaden, self-defense, insanity scenarios
...
- **Practiced:** Slide 19 — *Gebardi*, inevitably incident exception; Slide 23 — key takeaways
...
- **Practiced:** Slide 19 — Pino-Perez problem

### Grading Problem and Institutional Responses
...
- **Practiced:** Slides 3–4 — Markel opening case; grading problem framing; Slide 21 — synthesis
...
- **Practiced:** Slide 21 — sentencing strategy
...
- **Jurisdiction:** universal
- **Practiced:** Slide 21 — synthesis (referenced implicitly)

### Technology and Modern Doctrine
...
- **Practiced:** Slide 20 — platforms and complicity; Slide 22 — discussion questions; Slide 23 — key takeaways
...
- **Practiced:** Slide 20 — platforms and complicity; Slide 22 — discussion questions

### Racial Disparities and Structural Limits
...
- **Practiced:** Slide 14 — racial disparity data; Slide 22 — discussion questions

---

## Clusters

### cluster-ar-mens-rea-threshold
- **Refinements:** ar-low-threshold, ar-presence-plus, ar-attempt-to-aid, mr-purpose-not-knowledge, mr-underlying-offense
- **Why they cluster:** The foundational actus reus / mens rea architecture is taught together — low bar for the act, high bar for the intent — and these five refinements define the basic liability test, including the MPC's attempt-to-aid extension.
- **Scenario hook:** A music fan attends an underground concert, pays at the door, and posts a favorable online review without knowing the venue is operating illegally and without any relationship to the organizers — is this aiding and abetting?

### cluster-mens-rea-purpose-line
- **Refinements:** mr-purpose-not-knowledge, mr-temporal-advance-knowledge, mr-underlying-offense
- **Why they cluster:** All three address the depth of mental state needed: purpose vs. knowledge, temporal dimension of purpose, and the double mens rea requirement (purpose + underlying offense intent).
- **Scenario hook:** A getaway driver for a planned robbery first hears a gun mentioned as he pulls up to the bank — does he have the purpose and knowledge needed for accomplice liability to robbery and any resulting shooting?

### cluster-derivative-liability
- **Refinements:** dl-no-crime-principal, dl-personal-defense-no-transfer, dl-justification-vs-excuse, dl-mpc-independent-conviction
- **Why they cluster:** All four turn on the same underlying question: did the principal's conduct constitute a crime that the accomplice can derive liability from?
- **Scenario hook:** An undercover officer posing as a buyer encourages a dealer to sell narcotics, then claims public authority — can the person who arranged the introduction be convicted as an accomplice?

### cluster-npc-reform
- **Refinements:** npc-traditional-rule, npc-reform-sb1437, rd-racial-amplification
- **Why they cluster:** NPC reform is both doctrinal and normative — the chapter explicitly links the doctrine to racial disparity, and the reform movement is motivated by both the culpability problem and the disparate-impact evidence.
- **Scenario hook:** A getaway driver waits outside a store while a partner, acting on unexpectedly violent impulse, kills a clerk — under NPC, under SB 1437, and considering racial disparity evidence, what is the strongest argument for and against murder liability?

### cluster-inevitably-incident
- **Refinements:** ii-gebardi, ii-pino-perez-circumvention, gp-equal-punishment
- **Why they cluster:** The Gebardi exception is a limit on the equal-punishment rule for necessary parties, and Pino-Perez shows how that limit can be circumvented through chain charging.
- **Scenario hook:** A street-level drug buyer, who is a "necessary" party to any sale, is charged as an accomplice to a kingpin's distribution network through charges alleging he aided an independent supplier — can the Gebardi shield protect him?

### cluster-grading-management
- **Refinements:** gp-equal-punishment, gp-sentencing-adjustments, gp-accessory-after-fact, ii-gebardi
- **Why they cluster:** These are the three institutional mechanisms for managing the grading problem (sentencing, judicial narrowing, legislative specification) plus the historical grading distinction that survived (accessory after the fact).
- **Scenario hook:** A law student who drove a getaway car for her roommate and then helped him dispose of evidence challenges her conviction and sentence — walk through each institutional mechanism that might reduce her punishment.

### cluster-technology-complicity
- **Refinements:** tech-concrete-nexus, tech-deliberate-noncooperation, ar-presence-plus, mr-purpose-not-knowledge
- **Why they cluster:** The technology cases revisit the actus reus and purpose questions in a modern context — whether digital intermediation can satisfy the "presence + purpose" standard established in Wilcox and Gladstone.
- **Scenario hook:** A social media platform's AI moderation system flags a user's posts as terrorism-related, generates an automated report, but company executives deliberately shelve the report to avoid regulatory scrutiny — accomplice liability under Taamneh?
...
### Wilcox v. Jeffery
- **Holding:** A journalist who attended and reported on an illegal concert was guilty of aiding and abetting the performer's illegal act.
- **Reasoning:** The journalist's paid attendance and anticipated use of the performance for publication constituted encouragement and approval of the illegal act, satisfying the "presence + encouragement" threshold.
- **Facts:** American saxophonist performed illegally in England; a jazz magazine journalist paid to attend, enjoyed the show, and published a laudatory review.
- **Teaches:** ar-presence-plus, mr-purpose-not-knowledge (contrast — journalist had purpose to benefit)
- **Source type:** main case
- **Discussion questions:** yes

### State v. Tally
- **Holding:** A judge who intercepted a warning telegram to prevent a murder victim from escaping was liable as an accomplice, even though the killers were unaware of his assistance.
- **Reasoning:** Assistance need not be causally necessary — it is sufficient that it deprived the victim of any chance of survival, even a chance he might not have availed himself of.
- **Facts:** Judge Tally wired a telegraph operator to suppress a warning to Ed Ross, who was then killed by the Skelton family.
- **Teaches:** ar-low-threshold, ar-attempt-to-aid
- **Source type:** note case
- **Discussion questions:** yes

### Wilson v. People
- **Holding:** Wilson's conviction for aiding and abetting burglary was reversed because the jury was not permitted to determine whether Wilson had the felonious intent required for the offense.
- **Reasoning:** Acting as a decoy to catch a criminal does not supply the felonious intent required for burglary; the accomplice must share the principal's criminal purpose.
- **Facts:** Wilson boosted Pierce through a drugstore transom to catch him stealing, then immediately called police.
- **Teaches:** mr-underlying-offense, gp-equal-punishment
- **Source type:** main case
- **Discussion questions:** yes

### State v. Gladstone
- **Holding:** Gladstone's conviction for aiding and abetting Kent's marijuana sale was reversed because there was no nexus between Gladstone and Kent — Gladstone never communicated with Kent or encouraged the sale.
- **Reasoning:** Accomplice liability requires association with the principal's venture; merely providing information about a potential seller to a buyer, without any contact with or encouragement to the seller, does not establish the required nexus.
- **Facts:** College student drew a map to a marijuana dealer's house for an undercover officer; never contacted the dealer.
- **Teaches:** mr-purpose-not-knowledge
- **Source type:** main case
- **Discussion questions:** yes

### Rosemond v. United States
- **Holding:** Aiding and abetting an § 924(c) firearm-plus-drug offense requires advance knowledge that a confederate would carry a gun, at a time when the defendant had a meaningful opportunity to walk away.
- **Reasoning:** The temporal requirement ensures the accomplice had a genuine choice whether to continue participating with knowledge of the full scope of the crime.
- **Facts:** Rosemond participated in a drug deal in which a confederate fired on a buyer; unclear which participant was the shooter.
- **Teaches:** mr-temporal-advance-knowledge
- **Source type:** note case
- **Discussion questions:** yes

### State v. Hayes
- **Holding:** Hayes could not be convicted of burglary as an accomplice because the person he assisted (Hill) never had the felonious intent required for the offense — and therefore committed no burglary.
- **Reasoning:** Accomplice liability is derivative; an innocent act by the principal cannot become criminal merely by imputation of the accomplice's intent, unless the principal was a passive agent under the accomplice's control.
- **Facts:** Hayes proposed a store robbery; Hill agreed to participate but secretly planned to entrap Hayes; Hill entered the store without intent to steal.
- **Teaches:** dl-no-crime-principal, mr-underlying-offense
- **Source type:** main case
- **Discussion questions:** yes

### Vaden v. State
- **Holding:** Vaden was properly convicted as an accomplice even though the undercover agent who committed the underlying offense had a public authority defense.
- **Reasoning:** A personal justification defense held by the principal does not transfer to the accomplice; the crime still occurred, giving rise to derivative liability.
- **Facts:** Undercover fish & game agent contracted with hunting guide Vaden, then killed four foxes illegally during the guided hunt.
- **Teaches:** dl-personal-defense-no-transfer, dl-justification-vs-excuse
- **Source type:** note case
- **Discussion questions:** yes

### Gebardi v. United States
- **Holding:** The woman who willingly traveled across state lines for "immoral purposes" could not be convicted as an accomplice to the Mann Act violation.
- **Reasoning:** When a legislature punishes only one party to a transaction and the other party's participation is inevitably incident to the offense, the legislature implicitly excluded that party from accomplice liability.
- **Facts:** Man and woman traveled across state lines for immoral purposes; only the transporter was explicitly punished by statute.
- **Teaches:** ii-gebardi
- **Source type:** note case
- **Discussion questions:** no

### United States v. Pino-Perez
- **Holding:** An outside drug supplier could be convicted as an accomplice to a kingpin offense even though the kingpin's own underlings were shielded by the inevitably-incident rule.
- **Reasoning:** The inevitably-incident protection applies only to those whose participation is a necessary element of the specific offense; an outside supplier's participation is not so defined.
- **Facts:** Independent drug supplier convicted as accomplice under kingpin statute; kingpin's underlings shielded by Gebardi rule.
- **Teaches:** ii-pino-perez-circumvention, ii-gebardi
- **Source type:** note case
- **Discussion questions:** no

### Twitter, Inc. v. Taamneh
- **Holding:** Twitter, Google, and Facebook did not aid and abet an ISIS terrorist attack by hosting ISIS content on their platforms.
- **Reasoning:** The platforms' relationship with ISIS was arm's-length, passive, and largely indifferent — indistinguishable from their relationship with billions of lawful users — which did not satisfy the "concrete nexus" requirement for aiding and abetting.
- **Facts:** Family of victim killed in 2017 Istanbul nightclub attack sued social media platforms under JASTA, alleging they aided ISIS by hosting its content.
- **Teaches:** tech-concrete-nexus, mr-purpose-not-knowledge
- **Source type:** note case
- **Discussion questions:** yes

### People v. Luparello
- **Holding:** Luparello was properly convicted of first-degree murder under the natural and probable consequences doctrine even though he had authorized only an "interrogation."
- **Reasoning:** A killing by accomplices acting "at any cost" was a natural and probable consequence of the agreement, making the killing foreseeable and imputing murder liability to Luparello.
- **Facts:** Luparello directed armed associates to extract information from a reluctant witness "at any cost"; they shot and killed the witness; Luparello was absent.
- **Teaches:** npc-traditional-rule
- **Source type:** note case
- **Discussion questions:** no

### People v. Gentile
- **Holding:** California's SB 1437 eliminated second-degree murder liability under the natural and probable consequences doctrine, requiring personal malice or major participation plus reckless indifference.
- **Reasoning:** The statutory amendment prohibited imputing malice "based solely on participation in a crime," which was exactly what the NPC doctrine did.
- **Facts:** Defendant sought resentencing under SB 1437 after conviction based on NPC murder liability.
- **Teaches:** npc-reform-sb1437
- **Source type:** note case
- **Discussion questions:** no
...
|-----|---------|------------|-----------|
| ar-low-threshold | element | foundational | slide 6, 8, 23 |
| ar-presence-plus | element | intermediate | slide 7, 23 |
| ar-attempt-to-aid | element | intermediate | slide 5 |
| mr-purpose-not-knowledge | element | foundational | slide 9, 11, 23 |
| mr-underlying-offense | element | foundational | slide 10 |
| mr-temporal-advance-knowledge | element | intermediate | slide 12, 23 |
| npc-traditional-rule | extension | intermediate | slide 13 |
| npc-reform-sb1437 | limit | advanced | slide 13, 23 |
| dl-no-crime-principal | limit | foundational | slide 15, 17, 18 |
| dl-personal-defense-no-transfer | limit | intermediate | slide 16, 17, 18 |
| dl-justification-vs-excuse | limit | advanced | slide 18 |
| dl-mpc-independent-conviction | limit | intermediate | slide 18 |
| ii-gebardi | limit | intermediate | slide 19, 23 |
| ii-pino-perez-circumvention | limit | advanced | slide 19 |
| gp-equal-punishment | element | foundational | slide 3, 4, 21 |
| gp-sentencing-adjustments | limit | intermediate | slide 21 |
| gp-accessory-after-fact | limit | foundational | — |
| tech-concrete-nexus | limit | advanced | slide 20, 22, 23 |
| tech-deliberate-noncooperation | extension | advanced | slide 20, 22 |
| rd-racial-amplification | limit | advanced | slide 14, 22 |
