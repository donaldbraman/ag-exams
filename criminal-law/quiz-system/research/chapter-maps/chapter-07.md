# Chapter Map: Actus Reus — The Voluntary Act Requirement

## Meta
- Chapter: 7
- Title: Actus Reus: The Voluntary Act Requirement
- Source file: criminal-law/chapters/07-voluntary-act.qmd
- Source hash: 7d68c340806ca75c6191f42899ebe807e5ad83f6e01320b8a9a75dacf989e477
...
1. **Conduct** — The defendant must have engaged in some conduct: an act or an omission to perform an act they were physically capable of performing.
2. **Voluntariness** — That conduct must include at least one voluntary act. A bodily movement is voluntary if it is a product of the actor's conscious or habitual effort or determination.

### Liability Extensions

*(None for this chapter — the chapter focuses on the core voluntary act requirement and its limits.)*

### Liability Limits

1. **Unconsciousness** — If the defendant was literally unconscious at the moment of harmful conduct (due to trauma, sleep, seizure, hypnosis, or similar state), they lack a voluntary act and must be acquitted.
2. **External physical compulsion** — A bodily movement caused entirely by external physical forces (being pushed, thrown, physically moved by police) is not a voluntary act.
3. **Status versus conduct** — The government may not punish a person for a pure status; it must identify a voluntary act the defendant performed.

---

## Refinements

### Voluntariness — Core Doctrine
...
- **Practiced:** Slides 5, 6 — The professor introduced actus reus and walked through MPC 2.01(2)(a)–(d) in detail, asking students to generate examples of each exclusion.
...
- **Practiced:** Slides 11, 12 — Newton case introduced with historical photo; Slide 12 states the jury instruction rule as the "easy case."
...
- **Practiced:** Slide 12 — Stated as the outcome of Newton: "If a defendant can present evidence of unconsciousness that would negate the charge, then they are entitled to an instruction to that effect."
...
- **Practiced:** Slides 15, 16, 17 — Slides frame the psychotic break as the "harder case," walk through James's procedural history, and explicitly contrast unconsciousness (acquittal) with NGI (commitment). Slide 18 uses a Newton hypothetical to reinforce strategic distinction between defenses.
...
- **Practiced:** Slides 17, 18 — Explicitly states the distinction and uses Newton hypothetical to prompt strategic thinking.
...
### Conscious but Involuntary — The Jacobs Rule
...
- **Practiced:** Slides 19, 20 — Case introduced with portrait; Slide 20 quotes the "phlegmatic man" passage and asks students to analyze the court's policy reasoning on deterrence, desert, and self-governance.
...
- **Practiced:** Slide 21 — Presents all three cases (Powell, Manning, Grants Pass) side by side on a single "Status or Conduct?" slide with brief summaries.
...
- **Practiced:** Slide 21 — White's suggestion is noted for *Powell* entry; Slide 22 uses a hypothetical about a collapsed-from-exhaustion homeless person to connect status/conduct to unconsciousness.

---

### Which Act Must Be Voluntary — Martin/Beltz
...
- **Practiced:** Slide 23 — Case introduced with humorous intoxication image. Slide 24 immediately poses the *Beltz* contrast.
...
- **Practiced:** Slides 24, 25 — Two slides devoted to the *Martin/Beltz* contrast, the second explicitly naming this "Time Shifting The Voluntary Act."
...
- **Practiced:** Slides 27, 31 — Slide 27 states that time-shifting "makes a lot of sense" for DUI/vehicular homicide and that many jurisdictions have codified it. Slide 31 previews causation concepts (but-for and proximate cause) that directly map to the time-framing analysis.
...
- **Practiced:** Slides 28, 29 — Slide 28 states both rules; Slide 29 defines negative vs. affirmative defenses. Both slides explicitly set up *State v. Ireland*.
...
- **Practiced:** Slide 30 — States the Ohio holding and its effect of "shifting ... from reasonable doubt to preponderance of the evidence."
...
- **Practiced:** Slide 29 — Explicitly defines both defense types as a setup for the *Ireland* analysis.

---

## Clusters

### cluster-unconsciousness-defense-mechanics
- **Refinements:** unconsciousness-complete-defense, unconsciousness-instruction-threshold, psychotic-break-unconsciousness, unconsciousness-insanity-distinction
- **Why they cluster:** These refinements together define when a defendant can claim unconsciousness, what evidence suffices, how psychosis fits, and why the defense matters strategically vs. insanity.
- **Scenario hook:** A defendant with a history of PTSD-induced dissociation commits assault during what witnesses describe as a trance-like state, then claims total amnesia — should the judge instruct on unconsciousness, and would the defendant prefer acquittal via unconsciousness or NGI?

### cluster-conscious-involuntary-limits
- **Refinements:** jacobs-rule-impulse-no-defense, voluntary-intoxication-unconsciousness, sleepwalking-automatism
- **Why they cluster:** These refinements define the outer boundary of the defense — what counts as genuinely unconscious versus what is merely strong impulse, self-induced state, or ambiguous automation.
- **Scenario hook:** A defendant claims he was "blacked out with rage" after being provoked; he was aware at some points but says passion overtook him — does any version of this narrative support an unconsciousness instruction, or does *Jacobs* bar all of it?

### cluster-status-conduct-voluntary-appearance
- **Refinements:** status-conduct-distinction, powell-white-concurrence, martin-principle-state-created-actus-reus, beltz-continuing-possession-voluntary-act
- **Why they cluster:** These refinements address situations where a person ends up in a legally compromised position through forces beyond their immediate control — addicted, homeless, or physically moved by police — and the court must identify whether any voluntary act supports liability.
- **Scenario hook:** A homeless chronic alcoholic is arrested in front of a liquor store, transported to a detox center, and officers find an open container in his bag during intake — which voluntary acts (if any) support prosecution for either public intoxication or possession on the premises?

### cluster-time-framing-prior-choice
- **Refinements:** time-framing-seizure-driving, spejcher-voluntary-intoxication-time-framing, autopilot-time-framing, beltz-continuing-possession-voluntary-act
- **Why they cluster:** All involve a defendant who was not in full voluntary control at the moment of harm but had made an earlier voluntary choice that foreseeably led to the harmful situation.
- **Scenario hook:** A driver with a documented seizure disorder who lied on his license renewal about his condition suffers a seizure while using Tesla Autopilot and crashes into pedestrians — which prior voluntary acts support liability, and does using automation change the analysis?

### cluster-burden-of-proof-voluntariness
- **Refinements:** burden-majority-prosecution, burden-minority-defendant, negative-vs-affirmative-defense, unconsciousness-instruction-threshold
- **Why they cluster:** These refinements address who bears the burden when the evidence on unconsciousness is ambiguous — the answer determines the outcome in close cases.
- **Scenario hook:** A defendant charged with aggravated assault presents a single psychiatric expert who says he was dissociating during the attack; the prosecution offers no evidence on his mental state — who wins under California rules? Under Ohio rules?
...
### People v. Newton
- **Holding:** The trial court committed prejudicial error by refusing to instruct the jury on unconsciousness as a complete defense when substantial evidence — defendant's testimony plus medical expert testimony — supported the inference that Newton was unconscious from a gunshot wound when Officer Frey was shot.
- **Reasoning:** Unconsciousness need not reach the level of coma; where involuntary unconsciousness is evidenced, the defendant is entitled to an instruction and the prosecution must disprove it beyond a reasonable doubt.
- **Facts:** Newton was shot in the abdomen during a confrontation with Officer Frey in 1967; he claimed to have no memory of the shooting that killed Frey; a forensic physician testified that abdominal gunshot wounds commonly cause reflex shock and loss of consciousness.
- **Teaches:** unconsciousness-complete-defense, unconsciousness-instruction-threshold, burden-majority-prosecution
- **Source type:** main case
- **Discussion questions:** no

### People v. James
- **Holding:** The trial court erred by refusing to instruct the jury on unconsciousness during the guilt phase of a bifurcated trial; a defendant suffering a severe psychotic episode who had no awareness of or recollection of their actions may raise an unconsciousness defense even while also pleading insanity.
- **Reasoning:** Unconsciousness and insanity are not mutually exclusive defenses; "unconsciousness from whatever cause" — including mental illness — can negate the voluntary act, and the instruction threshold is met by substantial evidence of lack of awareness.
- **Facts:** James attacked a woman at a senior housing complex during what experts described as a severe psychotic episode in 2012; he was found guilty of mayhem in the guilt phase and NGI in the sanity phase; he appealed seeking an unconsciousness instruction that would have produced outright acquittal.
- **Teaches:** psychotic-break-unconsciousness, unconsciousness-insanity-distinction, unconsciousness-instruction-threshold
- **Source type:** main case
- **Discussion questions:** yes

### Jacobs v. Commonwealth
- **Holding:** Evidence of an "excitable temperament" that renders a conscious defendant temporarily unable to control his impulses is not a defense to criminal homicide; conscious emotional states, no matter how overwhelming, do not negate the voluntary act.
- **Reasoning:** The law presumes conscious individuals retain capacity for self-governance; permitting impulse as a defense would eliminate accountability based on the intensity of individual temperament, which varies arbitrarily among persons.
- **Facts:** Jacobs, after being confronted about his treatment of his children, went inside, retrieved a knife, returned, and fatally stabbed the victim; defense sought to introduce evidence that his "excitable temperament" made deliberation impossible.
- **Teaches:** jacobs-rule-impulse-no-defense
- **Source type:** note case
- **Discussion questions:** yes (discussion questions appear in chapter text referencing the Jacobs section)

### People v. Cogsdill
- **Holding:** A defendant's claim that his actions were involuntary due to psychotropic medications and mental health issues does not constitute a valid unconsciousness defense where he was aware of his actions and exercised some degree of control over them.
- **Reasoning:** The court distinguished between true unconsciousness (which excuses) and conscious action influenced by medication or mental health conditions (which does not); the Jacobs principle applies equally to pharmaceutical and emotional impairments that do not eliminate awareness.
- **Facts:** Cogsdill sought to extend the unconsciousness defense to cover conduct he argued was affected by psychotropic medications and mental illness, while remaining aware of his actions.
- **Teaches:** jacobs-rule-impulse-no-defense
- **Source type:** note case
- **Discussion questions:** no

### Powell v. Texas
- **Holding:** A chronic alcoholic may be convicted for the conduct of being drunk in public; the Eighth Amendment bars punishing *status* but not *conduct*, and public intoxication statutes target conduct.
- **Reasoning:** Powell was convicted for an act — appearing drunk in public — not for the status of being an alcoholic; the plurality distinguished *Robinson v. California* (which struck down a pure status crime) on that basis.
- **Facts:** Leroy Powell, a chronic alcoholic arrested approximately 100 times for public intoxication, argued his alcoholism compelled his drinking and that punishment was cruel and unusual.
- **Teaches:** status-conduct-distinction, powell-white-concurrence
- **Source type:** note case (problem format)
- **Discussion questions:** yes (embedded in problem)

### City of Grants Pass v. Johnson
- **Holding:** Ordinances prohibiting camping and sleeping in public parks target conduct, not the status of homelessness, and do not violate the Eighth Amendment.
- **Reasoning:** The Court limited *Robinson* to pure status crimes; even conduct that is an unavoidable consequence of homelessness remains "conduct" for Eighth Amendment purposes.
- **Facts:** Grants Pass prohibited camping and overnight sleeping in public; homeless residents challenged the ordinances as effectively criminalizing their status; Justice Sotomayor dissented on grounds that sleep is a biological necessity.
- **Teaches:** status-conduct-distinction, powell-white-concurrence
- **Source type:** note case (problem format)
- **Discussion questions:** yes (embedded in problem)

### Manning v. Caldwell
- **Holding:** Virginia's "habitual drunkard" interdiction statute violated the Eighth Amendment as applied to a homeless alcoholic, because for such a defendant the status of addiction and the conduct of drinking collapse into one another; the statute was also unconstitutionally vague.
- **Reasoning:** When a person is addicted to alcohol and has no private space in which to consume it, punishing the conduct is effectively punishing the status; *Robinson* applies when the conduct/status distinction is illusory.
- **Facts:** Bryan Manning, a homeless alcoholic in Roanoke, was designated a "habitual drunkard" and repeatedly prosecuted for possessing or consuming alcohol, including once for merely smelling like alcohol.
- **Teaches:** status-conduct-distinction, powell-white-concurrence
- **Source type:** note case (problem format)
- **Discussion questions:** yes (embedded in problem)

### Martin v. State
- **Holding:** A defendant cannot be convicted of appearing drunk in public when officers forcibly transported him to the public location; a voluntary appearance in public is presupposed by the offense.
- **Reasoning:** The plain terms of the statute require voluntary conduct; the government cannot manufacture the actus reus by physically moving the defendant to the location where the offense elements are satisfied.
- **Facts:** Officers arrested Martin at his home and took him onto a public highway, where he manifested a drunken condition; he was convicted under a public intoxication statute.
- **Teaches:** martin-principle-state-created-actus-reus
- **Source type:** note case (problem format)
- **Discussion questions:** yes (embedded in problem)

### Beltz v. State
- **Holding:** A defendant transported involuntarily to a correctional facility may still be convicted for possessing contraband if the voluntary act was *continuing to possess* after receiving notice that such possession constitutes a separate offense; however, the indictment here was reversed because no notice was given.
- **Reasoning:** The relevant voluntary act is not entry into the facility (involuntary) but knowing retention of contraband (voluntary after notice); the *Martin* principle does not bar all prosecution where a later voluntary act can be identified.
- **Facts:** Beltz was arrested and transported to jail; drugs were found during booking; he argued his presence was involuntary under *Martin*.
- **Teaches:** beltz-continuing-possession-voluntary-act, time-framing-seizure-driving
- **Source type:** note case (problem format)
- **Discussion questions:** yes (embedded in problem)

### People v. Decina
- **Holding:** An indictment charging an epileptic defendant with criminal negligence for deaths caused when he suffered a seizure while driving was legally sufficient because the voluntary act was the conscious decision to drive despite a known seizure disorder.
- **Reasoning:** Where a defendant knows they are subject to seizures that might strike at any time, the decision to drive creates the foreseeable risk; criminal liability may attach even though the defendant was unconscious at the moment of harm.
- **Facts:** Decina, a known epileptic, suffered a grand mal seizure while driving in Buffalo, lost control of his car, and killed four schoolchildren.
- **Teaches:** time-framing-seizure-driving
- **Source type:** note case
- **Discussion questions:** yes

### State v. Ireland
- **Holding:** Blackout/unconsciousness is an affirmative defense in Ohio; the defendant bears the burden of proving unconsciousness by a preponderance of the evidence, and this allocation does not violate due process.
- **Reasoning:** Unconscious mental states are "peculiarly within the knowledge of the accused"; classifying the defense as affirmative and requiring defendant to carry the burden is a permissible legislative choice.
- **Facts:** Ireland was charged with felonious assault; a psychologist diagnosed him with PTSD and testified he experienced a dissociative episode during the assault; he sought a California-style instruction requiring the prosecution to prove consciousness.
- **Teaches:** burden-minority-defendant, negative-vs-affirmative-defense
- **Source type:** note case (callout format)
- **Discussion questions:** yes
...
|-----|---------|------------|-----------|
| mpc-voluntary-act-definition | element | foundational | slides 5, 6 |
| unconsciousness-complete-defense | limit | foundational | slides 11, 12 |
| unconsciousness-instruction-threshold | limit | intermediate | slide 12 |
| psychotic-break-unconsciousness | limit | intermediate | slides 15, 16, 17 |
| unconsciousness-insanity-distinction | limit | intermediate | slides 17, 18 |
| sleepwalking-automatism | limit | intermediate | — |
| voluntary-intoxication-unconsciousness | limit | intermediate | — |
| jacobs-rule-impulse-no-defense | limit | foundational | slides 19, 20 |
| status-conduct-distinction | limit | intermediate | slide 21 |
| powell-white-concurrence | limit | advanced | slide 21 |
| martin-principle-state-created-actus-reus | element | foundational | slides 23, 24 |
| beltz-continuing-possession-voluntary-act | element | intermediate | slides 24, 25 |
| time-framing-seizure-driving | element | intermediate | slides 27, 31 |
| spejcher-voluntary-intoxication-time-framing | element | advanced | — |
| autopilot-time-framing | element | advanced | — |
| burden-majority-prosecution | limit | intermediate | slides 28, 29 |
| burden-minority-defendant | limit | intermediate | slide 30 |
| negative-vs-affirmative-defense | limit | advanced | slide 29 |
